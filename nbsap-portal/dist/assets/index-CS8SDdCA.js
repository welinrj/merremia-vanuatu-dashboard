const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-B2WcC-RY.js","./turf-CntlabHM.js","./index-CRXLxDts.js"])))=>i.map(i=>d[i]);
import{i as Io,a as Go,p as Ro,b as Bo,g as Do,c as ri,d as ue,e as te,f as qt,h as Jr,s as gs,w as Zr,o as Xr}from"./firebase-BrFGRS8q.js";import{a as ts,f as Vi,u as Wi,b as Ki,s as Oo,d as Fo,e as zo,h as jo,p as qo,i as As}from"./turf-CntlabHM.js";import{L as D}from"./leaflet-CASSoK7o.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function a(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(i){if(i.ep)return;i.ep=!0;const r=a(i);fetch(i.href,r)}})();const Ho={apiKey:"AIzaSyB2OGgiXUUhyt1aKdHsqIaMS3NDN-tZOdU",authDomain:"vanuatu-nbsap-dashboard-9909a.firebaseapp.com",projectId:"vanuatu-nbsap-dashboard-9909a",storageBucket:"vanuatu-nbsap-dashboard-9909a.firebasestorage.app",messagingSenderId:"778670993904",appId:"1:778670993904:web:219c671804326d953aed35"},Yi=Io(Ho,"nbsap-portal");let ht;try{ht=Go(Yi,{localCache:Ro({tabManager:Bo()})})}catch(t){console.warn("Firestore persistence not available, using default:",t.message),ht=Do(Yi)}const Tt="nbsap_layers",Uo="nbsap_metrics",Qr="nbsap_audit",ni="nbsap_settings",oi="chunks",Ua=8e5,Vo=9e6,Wo=Math.floor(Vo/Ua);async function Ko(t,e){await li(t);const a=JSON.stringify(e),s=Math.ceil(a.length/Ua),i=Math.min(499,Wo);for(let r=0;r<s;r+=i){const o=Zr(ht),n=Math.min(r+i,s);for(let l=r;l<n;l++){const c=ue(ht,Tt,t,oi,String(l));o.set(c,{d:a.slice(l*Ua,(l+1)*Ua)})}await o.commit()}return s}async function tn(t){const e=await te(qt(ht,Tt,t,oi));if(e.empty)return null;const a=e.docs.map(r=>({idx:parseInt(r.id,10),data:r.data().d})).sort((r,o)=>r.idx-o.idx);let s="";for(const r of a)s+=r.data,r.data=null;const i=JSON.parse(s);return s=null,i}async function li(t){const e=await te(qt(ht,Tt,t,oi));if(!e.empty)for(let a=0;a<e.docs.length;a+=499){const s=Zr(ht),i=e.docs.slice(a,a+499);for(const r of i)s.delete(r.ref);await s.commit()}}async function en(){const t=await te(qt(ht,Tt));if(t.empty)return[];const a=(await Promise.allSettled(t.docs.map(async s=>{const i=s.data(),r=await tn(s.id);return r?{id:s.id,metadata:i.metadata,geojson:r}:(console.warn(`Layer ${s.id}: no GeoJSON chunks found`),null)}))).filter(s=>s.status==="fulfilled"&&s.value!==null).map(s=>s.value);return a.sort((s,i)=>{var n,l;const r=((n=s.metadata)==null?void 0:n.uploadTimestamp)||"";return(((l=i.metadata)==null?void 0:l.uploadTimestamp)||"").localeCompare(r)}),a}async function Yo(){const t=await te(qt(ht,Tt));if(t.empty)return[];const e=t.docs.map(a=>{const s=a.data();return{id:a.id,metadata:s.metadata,geojson:null}});return e.sort((a,s)=>{var o,n;const i=((o=a.metadata)==null?void 0:o.uploadTimestamp)||"";return(((n=s.metadata)==null?void 0:n.uploadTimestamp)||"").localeCompare(i)}),e}async function Jo(){return(await te(qt(ht,Tt))).size}async function Zo(t){const e=ue(ht,Tt,t),a=await ri(e);if(!a.exists())return null;const s=a.data(),i=await tn(t);return{id:t,metadata:s.metadata,geojson:i}}async function ci(t){const{id:e,metadata:a,geojson:s}=t,i=ue(ht,Tt,e),r=await Ko(e,s);return await gs(i,{metadata:a,_chunkCount:r}),t}async function Xo(t,e){const a=ue(ht,Tt,t),s=await ri(a);if(!s.exists())throw new Error(`Layer ${t} not found`);const i=s.data();await gs(a,{...i,metadata:e})}async function Qo(t){await li(t),await Jr(ue(ht,Tt,t))}async function an(){return(await te(qt(ht,Uo))).docs.map(e=>({id:e.id,...e.data()}))}async function sn(t){const e=`a_${Date.now()}_${Math.random().toString(36).slice(2,7)}`,a={...t,timestamp:new Date().toISOString()};await gs(ue(ht,Qr,e),a)}async function di(){const e=(await te(qt(ht,Qr))).docs.map(a=>({id:a.id,...a.data()}));return e.sort((a,s)=>(s.timestamp||"").localeCompare(a.timestamp||"")),e}async function tl(t){const e=await ri(ue(ht,ni,t));return e.exists()?e.data().value:null}async function el(t,e){await gs(ue(ht,ni,t),{key:t,value:e})}async function al(){const t=await en(),e=await di(),a=await an();return{version:1,exportTimestamp:new Date().toISOString(),layers:t,auditLog:e,metrics:a}}async function sl(t){if(!t||t.version!==1)throw new Error("Invalid backup format");const e=await te(qt(ht,Tt));for(const a of e.docs)await li(a.id),await Jr(a.ref);for(const a of t.layers||[])await ci(a);return{layersImported:(t.layers||[]).length}}async function il(t){if(!t||t.version!==1)throw new Error("Invalid backup format");let e=0,a=0;const s=await te(qt(ht,Tt)),i=new Set(s.docs.map(l=>l.id));for(const l of t.layers||[])l.id&&(i.has(l.id)?a++:e++,await ci(l));const r=await di(),o=new Set(r.map(l=>`${l.timestamp}|${l.action}|${l.layer_id||""}`));let n=0;for(const l of t.auditLog||[]){const c=`${l.timestamp}|${l.action}|${l.layer_id||""}`;if(o.has(c)){n++;continue}await sn(l),o.add(c)}return{added:e,updated:a,skippedAudit:n}}function rl(t){return Xr(qt(ht,Tt),e=>{const a={added:[],modified:[],removed:[]};e.docChanges().forEach(s=>{s.type==="added"&&a.added.push(s.doc.id),s.type==="modified"&&a.modified.push(s.doc.id),s.type==="removed"&&a.removed.push(s.doc.id)}),t(a)})}function nl(t){return Xr(qt(ht,ni),e=>{const a={};e.docs.forEach(s=>{a[s.id]=s.data().value}),t(a)})}const ol=Object.freeze(Object.defineProperty({__proto__:null,addAuditEntry:sn,countLayers:Jo,deleteLayer:Qo,exportBackup:al,getAuditLog:di,getLayer:Zo,getMetrics:an,getSetting:tl,importBackup:sl,listLayers:en,listLayersMeta:Yo,onLayersChanged:rl,onSettingsChanged:nl,saveLayer:ci,saveLayerMetadata:Xo,setSetting:el,syncImport:il},Symbol.toStringTag,{value:"Module"})),{listLayers:rn,listLayersMeta:ll,countLayers:cl,getLayer:hi,saveLayer:nn,saveLayerMetadata:on,deleteLayer:ms,addAuditEntry:je,getAuditLog:Ji,getSetting:Zi,setSetting:xe,exportBackup:dl,importBackup:hl,syncImport:ul,onLayersChanged:pl,onSettingsChanged:fl}=ol,lt={basePath:"./",apiBaseUrl:"",storageBackend:"firestore",authProvider:"local-passphrase",tileSources:{osm:{name:"OpenStreetMap",url:"https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",attribution:'&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors',maxZoom:19},esriSatellite:{name:"Esri Satellite",url:"https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}",attribution:"&copy; Esri &mdash; Source: Esri, Maxar, Earthstar Geographics",maxZoom:18},cartoLight:{name:"CartoDB Light",url:"https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}{r}.png",attribution:'&copy; <a href="https://carto.com/">CARTO</a>',maxZoom:19}},maxUploadSizeMB:1024,maxFeaturesPerLayer:5e4,sliverThresholdM2:5,simplifyTolerance:1e-4,nationalBaselines:{terrestrial_ha:1219e3,marine_ha:663e5},mapCenter:[-16.5,168],mapZoom:7},Y={EEZ:{label:"Exclusive Economic Zone",defaultRealm:"marine",color:"#FF0000"},ADMIN_BOUNDARY:{label:"National Boundary (Admin0)",defaultRealm:"terrestrial",color:"#37474F"},CCA:{label:"Community Conserved Area",defaultRealm:"terrestrial",color:"#2E7D32"},MPA:{label:"Marine Protected Area",defaultRealm:"marine",color:"#1565C0"},PA:{label:"Protected Area",defaultRealm:"terrestrial",color:"#1B5E20"},OECM:{label:"Other Effective Conservation Measure",defaultRealm:"terrestrial",color:"#7E57C2"},KBA:{label:"Key Biodiversity Area",defaultRealm:"terrestrial",color:"#EF6C00"},LMMA:{label:"Locally Managed Marine Area",defaultRealm:"marine",color:"#00796B"},INLAND_WATER:{label:"Inland Water",defaultRealm:"terrestrial",color:"#4FC3F7"},SPATIAL_PLAN:{label:"Biodiversity Spatial Plan",defaultRealm:"terrestrial",color:"#78909C"},DEGRADED:{label:"Degraded Area",defaultRealm:"terrestrial",color:"#D84315"},RESTORATION:{label:"Restoration Site",defaultRealm:"terrestrial",color:"#F9A825"},SPECIES_DIST:{label:"Species Distribution",defaultRealm:"terrestrial",color:"#26A69A"},MEGAPODE:{label:"Vanuatu Megapode",defaultRealm:"terrestrial",color:"#E65100"},STARLING:{label:"Mountain Starling",defaultRealm:"terrestrial",color:"#5C6BC0"},FANTAIL:{label:"Streaked Fantail",defaultRealm:"terrestrial",color:"#FFB300"},KINGFISHER:{label:"Vanuatu Kingfisher",defaultRealm:"terrestrial",color:"#00ACC1"},FLYING_FOX:{label:"Vanuatu Flying Fox",defaultRealm:"terrestrial",color:"#6D4C41"},PLERANDRA:{label:"Plerandra vanuatuensis",defaultRealm:"terrestrial",color:"#66BB6A"},INVASIVE:{label:"Invasive Alien Species",defaultRealm:"terrestrial",color:"#C62828"},MERREMIA:{label:"Merremia peltata (Big Leaf)",defaultRealm:"terrestrial",color:"#BF360C"},CROWN_OF_THORNS:{label:"Crown of Thorns Starfish",defaultRealm:"marine",color:"#FF6F00"},MILE_A_MINUTE:{label:"Mile a Minute Vine",defaultRealm:"terrestrial",color:"#AD1457"},SOLANUM_TORVUM:{label:"Solanum torvum (Devil Fig)",defaultRealm:"terrestrial",color:"#6A1B9A"},PESTICIDE:{label:"Pesticide / Herbicide Area",defaultRealm:"terrestrial",color:"#8E24AA"},EUTROPHICATION:{label:"Coastal Eutrophication Zone",defaultRealm:"marine",color:"#D81B60"},LAND_COVER:{label:"Land Cover / Land Use",defaultRealm:"terrestrial",color:"#795548"},GREEN_SPACE:{label:"Blue & Green Space",defaultRealm:"terrestrial",color:"#388E3C"},OTHER:{label:"Other",defaultRealm:"terrestrial",color:"#78909C"}},Xi=Object.keys(Y);function we(t,e){if(t.realm)return t.realm;if(e.realm&&e.realm!=="terrestrial")return e.realm;const a=e.category?Y[e.category]:null;return a&&a.defaultRealm?a.defaultRealm:e.realm||"terrestrial"}const vs=new Set(["Torba","Sanma","Penama","Malampa","Shefa","Tafea"]);let ln=0;const zt=new Map;function Kt(){ln++,zt.clear()}function Pa(t,e,a){return`${ln}:${t}:${e||""}:${JSON.stringify(a||{})}`}const Va=100,ui=500;function pt(t){if(!t||!t.geometry||!t.geometry.type.includes("Polygon"))return 0;try{return ts(t)/1e4}catch{return 0}}function cn(t){return{type:"FeatureCollection",features:(t.features||[]).map(e=>({...e,properties:{...e.properties,area_ha:Math.round(pt(e)*100)/100}}))}}function dt(t){const e=t.filter(a=>a&&a.geometry&&(a.geometry.type==="Polygon"||a.geometry.type==="MultiPolygon"));return e.length===0?null:e.length===1?e[0]:e.length>ui?null:e.length>Va?dn(e):zs(e)}function zs(t){try{const a=Vi(t),s=Wi(a);if(s)return s}catch{}let e=null;for(const a of t){if(!e){e=a;continue}try{const s=Wi(Vi([e,a]));s&&(e=s)}catch{}}return e}function dn(t){const e=[];for(let s=0;s<t.length;s+=Va)e.push(t.slice(s,s+Va));const a=e.map(s=>zs(s)).filter(Boolean);return a.length===0?null:a.length===1?a[0]:a.length>Va?dn(a):zs(a)}function We(t,e={}){var _;const a=Pa("30x30",null,e),s=zt.get(a);if(s)return s;const i=lt.nationalBaselines,r=[],o=[];let n=0,l=0,c=0;const h={};for(const x of t){const w=x.metadata;if(w.isReference||!w.countsToward30x30||!w.targets||!w.targets.includes("T3"))continue;const k=(((_=x.geojson)==null?void 0:_.features)||[]).filter(P=>!(e.province&&e.province!=="All"&&P.properties.province!==e.province));for(const P of k){const C=P.properties.area_ha||0,M=we(P.properties,w);M==="marine"?(o.push(P),l+=C):(r.push(P),n+=C),c++;const E=P.properties.province||"Unassigned";h[E]||(h[E]={terrestrial:[],marine:[]}),M==="marine"?h[E].marine.push(P):h[E].terrestrial.push(P)}}const d=c>ui,u=dt(r),f=dt(o),p=u?pt(u):n,m=f?pt(f):l,g=i.terrestrial_ha>0?p/i.terrestrial_ha*100:0,v=i.marine_ha>0?m/i.marine_ha*100:0,y=Object.entries(h).filter(([x])=>vs.has(x)).map(([x,w])=>{let k,P;if(d)k=w.terrestrial.reduce((C,M)=>C+(M.properties.area_ha||0),0),P=w.marine.reduce((C,M)=>C+(M.properties.area_ha||0),0);else{const C=dt(w.terrestrial),M=dt(w.marine);k=C?pt(C):0,P=M?pt(M):0}return{province:x,terrestrial_ha:U(k),marine_ha:U(P),total_ha:U(k+P),features:w.terrestrial.length+w.marine.length}}).sort((x,w)=>w.total_ha-x.total_ha),b={terrestrial_ha:U(p),marine_ha:U(m),terrestrial_pct:Xt(g),marine_pct:Xt(v),terrestrial_remaining_pct:Xt(Math.max(0,30-g)),marine_remaining_pct:Xt(Math.max(0,30-v)),gross_terrestrial_ha:U(n),gross_marine_ha:U(l),total_features:c,provinceBreakdown:y,baselines:i,dissolvedTerrestrial:u,dissolvedMarine:f};return zt.set(a,b),b}const Qi=new Set(["CCA","INLAND_WATER"]);function ys(t,e={}){var M,E;const a=Pa("t1",null,e),s=zt.get(a);if(s)return s;const i=lt.nationalBaselines;let r=0,o=0;for(const S of t){const A=S.metadata;if(!A.isReference)continue;const $=((M=S.geojson)==null?void 0:M.features)||[];if(A.category==="EEZ")for(const R of $)r+=R.properties.area_ha||pt(R);else if(A.category==="ADMIN_BOUNDARY")for(const R of $)o+=R.properties.area_ha||pt(R)}r===0&&(r=i.marine_ha),o===0&&(o=i.terrestrial_ha);const n=Math.max(0,r-o),l=r>0?n/r*100:0,c=[];let h=0,d=0,u=0;const f={},p={},m={},g={};for(const S of t){const A=S.metadata;if(A.isReference||!Qi.has(A.category))continue;const $=A.targets&&A.targets.includes("T1"),R=Qi.has(A.category);if(!$&&!R||e.category&&e.category!=="All"&&A.category!==e.category)continue;u++;const T=A.category||"OTHER",N=(((E=S.geojson)==null?void 0:E.features)||[]).filter(I=>!(e.province&&e.province!=="All"&&I.properties.province!==e.province));for(const I of N){const O=I.properties.area_ha||0;d++,c.push(I),h+=O;const F=I.properties.province||"Unassigned";f[F]||(f[F]={terrestrial:0,tCount:0}),f[F].terrestrial+=O,f[F].tCount++,p[F]||(p[F]=[]),p[F].push(I),m[T]||(m[T]={area:0,count:0}),m[T].area+=O,m[T].count++,g[T]||(g[T]=[]),g[T].push(I)}}const v=dt(c),y=v?pt(v):h,b=i.terrestrial_ha>0?y/i.terrestrial_ha*100:0,_=Object.entries(f).filter(([S])=>vs.has(S)).map(([S,A])=>{const $=p[S],R=$?dt($):null,T=R?pt(R):A.terrestrial;return{province:S,terrestrial_ha:U(T),marine_ha:U(n),total_ha:U(T+n),features:A.tCount}}).sort((S,A)=>A.total_ha-S.total_ha),x=Object.entries(m).map(([S,A])=>{const $=dt(g[S]||[]),R=$?pt($):A.area;return{category:S,area_ha:U(R),gross_area_ha:U(A.area),features:A.count}}).sort((S,A)=>A.area_ha-S.area_ha),w=i.terrestrial_ha+r,k=y+n,P=w>0?k/w*100:0,C={targetCode:"T1",terrestrial_ha:U(y),terrestrial_pct:Xt(b),gross_terrestrial_ha:U(h),marine_ha:U(n),marine_pct:Xt(l),eez_ha:U(r),boundary_ha:U(o),total_covered_ha:U(k),total_area_ha:U(w),total_pct:Xt(P),totalFeatures:d,layerCount:u,provinceBreakdown:_,categoryBreakdown:x,baselines:i,dissolvedTerrestrial:v};return zt.set(a,C),C}const gl=new Set(["DEGRADED"]),ml=new Set(["RESTORATION"]);function pi(t,e={}){var M;const a=Pa("t2",null,e),s=zt.get(a);if(s)return s;const i=[],r=[];let o=0,n=0,l=0,c=0;const h={},d={},u={},f={};let p=0,m=0,g=0,v=0;for(const E of t){const S=E.metadata;if(S.isReference||!S.targets||!S.targets.includes("T2")||e.category&&e.category!=="All"&&S.category!==e.category)continue;const A=we({},S);if(e.realm&&e.realm!=="All"&&A!==e.realm)continue;c++;const $=S.category||"OTHER",R=gl.has($),T=ml.has($),N=(((M=E.geojson)==null?void 0:M.features)||[]).filter(I=>!(e.province&&e.province!=="All"&&I.properties.province!==e.province));for(const I of N){const O=I.properties.area_ha||0,F=we(I.properties,S);l++,R?(i.push(I),o+=O,F==="marine"?m+=O:p+=O):T&&(r.push(I),n+=O,F==="marine"?v+=O:g+=O);const H=I.properties.province||"Unassigned";h[H]||(h[H]={degraded:0,restoration:0,count:0}),R&&(h[H].degraded+=O),T&&(h[H].restoration+=O),h[H].count++,d[H]||(d[H]={degraded:[],restoration:[]}),R&&d[H].degraded.push(I),T&&d[H].restoration.push(I),u[$]||(u[$]={area:0,count:0}),u[$].area+=O,u[$].count++,f[$]||(f[$]=[]),f[$].push(I)}}const y=dt(i),b=dt(r),_=y?pt(y):o,x=b?pt(b):n,w=_>0?x/_*100:0,k=Object.entries(h).filter(([E])=>vs.has(E)).map(([E,S])=>{const A=d[E],$=A?dt(A.degraded):null,R=A?dt(A.restoration):null,T=$?pt($):S.degraded,N=R?pt(R):S.restoration;return{province:E,degraded_ha:U(T),restoration_ha:U(N),terrestrial_ha:U(T+N),total_ha:U(T+N),features:S.count,restoration_pct:T>0?Xt(N/T*100):0}}).sort((E,S)=>S.total_ha-E.total_ha),P=Object.entries(u).map(([E,S])=>{const A=dt(f[E]||[]),$=A?pt(A):S.area;return{category:E,area_ha:U($),gross_area_ha:U(S.area),features:S.count}}).sort((E,S)=>S.area_ha-E.area_ha),C={targetCode:"T2",degraded_ha:U(_),gross_degraded_ha:U(o),degraded_features:i.length,restoration_ha:U(x),gross_restoration_ha:U(n),restoration_features:r.length,restoration_pct:Xt(w),realmTotals:{degraded_terrestrial_ha:U(p),degraded_marine_ha:U(m),restoration_terrestrial_ha:U(g),restoration_marine_ha:U(v)},totalFeatures:l,layerCount:c,provinceBreakdown:k,categoryBreakdown:P,dissolvedDegraded:y,dissolvedRestoration:b};return zt.set(a,C),C}function fi(t,e={}){var u;const a=Pa("general",null,e),s=zt.get(a);if(s)return s;let i=0,r=0;const o=[],n={},l={terrestrial:0,marine:0};for(const f of t){const p=f.metadata;if(p.isReference||e.targets&&e.targets.length>0&&!p.targets.some(g=>e.targets.includes(g)))continue;const m=(((u=f.geojson)==null?void 0:u.features)||[]).filter(g=>!(e.province&&e.province!=="All"&&g.properties.province!==e.province));for(const g of m){i++,r+=g.properties.area_ha||0,o.push(g);const v=p.category||"OTHER";n[v]=(n[v]||0)+1;const y=we(g.properties,p);l[y]=(l[y]||0)+1}}const c=dt(o),h=c?pt(c):r,d={totalFeatures:i,totalAreaHa:U(h),grossAreaHa:U(r),categoryCounts:n,realmCounts:l};return zt.set(a,d),d}function le(t,e,a={}){var A,$,R;const s=Pa("target",e,a),i=zt.get(s);if(i)return i;let r=0,o=0,n=0;const l={},c={},h={},d={},u={};let f=0,p=0,m=0;for(const T of t){const N=T.metadata;if(N.isReference||!N.targets||!N.targets.includes(e)||a.category&&a.category!=="All"&&N.category!==a.category)continue;const I=we({},N);a.realm&&a.realm!=="All"&&I!==a.realm||(m+=(($=(A=T.geojson)==null?void 0:A.features)==null?void 0:$.length)||0)}const g=m>ui,v=g?null:[],y=g?null:{terrestrial:[],marine:[]};for(const T of t){const N=T.metadata;if(N.isReference||!N.targets||!N.targets.includes(e)||a.category&&a.category!=="All"&&N.category!==a.category||a.realm&&a.realm!=="All"&&we({},N)!==a.realm)continue;n++;const I=N.category||"OTHER",O=(((R=T.geojson)==null?void 0:R.features)||[]).filter(F=>{if(a.province&&a.province!=="All"&&F.properties.province!==a.province)return!1;if(a.year&&a.year!=="All"){const H=F.properties.year||N.year;if(H&&String(H)!==String(a.year))return!1}return!0});for(const F of O){const H=F.properties.area_ha||0,st=we(F.properties,N);r++,o+=H,st==="marine"?(p+=H,y&&y.marine.push(F)):(f+=H,y&&y.terrestrial.push(F)),v&&v.push(F);const K=F.properties.province||"Unassigned";l[K]||(l[K]={terrestrial:0,marine:0,tCount:0,mCount:0}),st==="marine"?(l[K].marine+=H,l[K].mCount++):(l[K].terrestrial+=H,l[K].tCount++),g||(c[K]||(c[K]={terrestrial:[],marine:[]}),st==="marine"?c[K].marine.push(F):c[K].terrestrial.push(F)),h[I]||(h[I]={area:0,count:0}),h[I].area+=H,h[I].count++,g||(d[I]||(d[I]=[]),d[I].push(F));const W=F.properties.type||F.properties.species_name||F.properties.name||N.name||"Unknown";u[W]||(u[W]={area_ha:0,features:0}),u[W].area_ha+=H,u[W].features++}}let b,_,x,w=null,k=null;if(g)b=o,_=f,x=p;else{const T=dt(v);b=T?pt(T):o,w=dt(y.terrestrial),k=dt(y.marine),_=w?pt(w):f,x=k?pt(k):p}const P=Object.entries(l).filter(([T])=>vs.has(T)).map(([T,N])=>{let I,O;if(g)I=N.terrestrial,O=N.marine;else{const F=c[T],H=F?dt(F.terrestrial):null,st=F?dt(F.marine):null;I=H?pt(H):N.terrestrial,O=st?pt(st):N.marine}return{province:T,terrestrial_ha:U(I),marine_ha:U(O),total_ha:U(I+O),features:N.tCount+N.mCount}}).sort((T,N)=>N.total_ha-T.total_ha),C={},M=[];for(const[T,N]of Object.entries(h)){let I=null,O;g?O=N.area:(I=dt(d[T]||[]),O=I?pt(I):N.area),C[T]=I,M.push({category:T,area_ha:U(O),gross_area_ha:U(N.area),features:N.count})}M.sort((T,N)=>N.area_ha-T.area_ha);const E=Object.entries(u).map(([T,N])=>({type:T,...N})).sort((T,N)=>N.area_ha-T.area_ha),S={targetCode:e,totalFeatures:r,totalAreaHa:U(b),grossAreaHa:U(o),layerCount:n,realmTotals:{terrestrial_ha:U(_),marine_ha:U(x),gross_terrestrial_ha:U(f),gross_marine_ha:U(p)},provinceBreakdown:P,categoryBreakdown:M,typeBreakdown:E,dissolvedByCategory:C};return zt.set(s,S),S}function U(t){return Math.round(t*100)/100}function Xt(t){return Math.round(t*1e3)/1e3}const q={layers:[],provincesGeojson:null,provinces:[],filters:{targets:["T3"],province:"All",category:"All",realm:"All",year:"All"},isAdmin:!1,customLayerNames:{},layerTracker:{}};function V(){return q}function Oa(t){Object.assign(q.filters,t),Qt=null,Kt(),Pe()}function gi(t){var a,s;const e=q.layers.findIndex(i=>i.id===t.id);if(e>=0)q.layers[e]=t;else{const i=(a=t.metadata)==null?void 0:a.originalFilename,r=(s=t.metadata)==null?void 0:s.category;i&&r&&(q.layers=q.layers.filter(o=>{var n,l;return((n=o.metadata)==null?void 0:n.originalFilename)===i&&((l=o.metadata)==null?void 0:l.category)===r?(console.warn(`Dedup on add: replacing "${o.metadata.name}" (${o.id}) with "${t.metadata.name}" (${t.id})`),!1):!0})),q.layers.push(t)}Qt=null,yi(),Kt(),Pe()}function hn(t,e){const a=q.layers.find(s=>s.id===t);a&&(Object.assign(a.metadata,e),Qt=null,Kt(),Pe())}function mi(t){q.layers=q.layers.filter(e=>e.id!==t);for(const[e,a]of Object.entries(q.layerTracker)){const s=a.filter(i=>i.layerId!==t);s.length===0?delete q.layerTracker[e]:s.length!==a.length&&(q.layerTracker[e]=s)}ha=null,Qt=null,yi(),Kt(),Pe()}function tr(t){const{unique:e,removedIds:a}=vl(t);return q.layers=e,Qt=null,yi(),Kt(),a}function vl(t){var i,r;const e={},a=[],s=[];for(const o of t){const n=(i=o.metadata)==null?void 0:i.originalFilename,l=(r=o.metadata)==null?void 0:r.category;if(!n){a.push(o);continue}const c=`${n}::${l}`;e[c]||(e[c]=[]),e[c].push(o)}for(const o of Object.values(e))if(o.length===1)a.push(o[0]);else{o.sort((n,l)=>new Date(l.metadata.uploadTimestamp)-new Date(n.metadata.uploadTimestamp)),a.push(o[0]);for(let n=1;n<o.length;n++)s.push(o[n].id);console.warn(`Dedup: kept latest "${o[0].metadata.originalFilename}" (${o[0].metadata.category}), removed ${o.length-1} older duplicate(s)`)}return{unique:a,removedIds:s}}function yl(t,e){return t&&q.layers.find(a=>{var s,i;return((s=a.metadata)==null?void 0:s.originalFilename)===t&&((i=a.metadata)==null?void 0:i.category)===e})||null}function bl(t,e,a){const s=[],i=new Set;for(const r of q.layers){const o=r.metadata;o&&(t&&o.originalFilename===t&&o.category===a&&(i.has(r.id)||(s.push(r),i.add(r.id))),e&&o.name===e&&o.category===a&&(i.has(r.id)||(s.push(r),i.add(r.id))))}return s}function xl(t){if(q.provincesGeojson=t,t&&t.features){const e=t.features.map(a=>a.properties.name||a.properties.province||a.properties.NAME||"").filter(Boolean).sort();q.provinces=[...new Set(e)]}}function un(t){q.customLayerNames=t||{}}function _l(t,e){q.customLayerNames[t]=e}function Me(t){return q.customLayerNames[t.id]||t.name}function vi(t){q.isAdmin=t,Pe()}function pn(t){if(!t){q.layerTracker={},xa();return}const e={};for(const[a,s]of Object.entries(t))Array.isArray(s)?e[a]=s:s&&s.layerId&&(e[a]=[s]);q.layerTracker=e,xa()}function wl(t,e){q.layerTracker[t]||(q.layerTracker[t]=[]),q.layerTracker[t].find(s=>s.layerId===e)||q.layerTracker[t].push({layerId:e,uploadedAt:new Date().toISOString()}),xa(),Pe()}function er(t,e=null){q.layerTracker[t]&&(e===null?delete q.layerTracker[t]:(q.layerTracker[t]=q.layerTracker[t].filter(a=>a.layerId!==e),q.layerTracker[t].length===0&&delete q.layerTracker[t]),xa(),Pe())}function Ml(){const t=new Set(q.layers.map(a=>a.id));let e=!1;for(const[a,s]of Object.entries(q.layerTracker)){const i=s.filter(r=>t.has(r.layerId));i.length!==s.length&&(e=!0,i.length===0?delete q.layerTracker[a]:q.layerTracker[a]=i)}return e&&xa(),e}let ha=null;function fn(){if(ha)return ha;const t=new Set;for(const e of Object.values(q.layerTracker))for(const a of e)t.add(a.layerId);return ha=t,t}function xa(){ha=null,Qt=null}function Sl(){const t=fn();return q.layers.filter(e=>t.has(e.id))}function El(){return fn().size>0}let Qt=null;function Lt(){if(Qt)return Qt;let t;if(El())t=Sl();else{const e=q.layers.filter(a=>!Al(a));t=e.length>0?e:q.layers}return Qt=t,t}function Al(t){const e=t.metadata;return e?e._isDemo||e.uploadedBy==="system"?!0:(e.name||"").toLowerCase().startsWith("demo "):!1}const sa=new Set(["Torba","Sanma","Penama","Malampa","Shefa","Tafea"]);let es=!0;const ae=new Set;function yi(){es=!0,gn()}function gn(){var e;if(!es)return;es=!1,ae.clear();for(const a of q.provinces||[])sa.has(a)&&ae.add(a);if(ae.size>=sa.size){q.provinces=[...ae].sort();return}const t=500;for(const a of q.layers){if(!a.geojson)continue;const s=a.geojson.features||[],i=Math.min(s.length,t);for(let r=0;r<i;r++){const o=(e=s[r].properties)==null?void 0:e.province;if(o&&sa.has(o)&&(ae.add(o),ae.size>=sa.size))break}if(ae.size>=sa.size)break}q.provinces=[...ae].sort()}const ks=new Set,mn=new Set(["ADMIN_BOUNDARY","EEZ","SPATIAL_PLAN"]);async function Qe(t){if(!t||t.length===0)return!1;const e=t.includes("T1"),a=q.layers.filter(r=>{if(r.geojson!==null||ks.has(r.id))return!1;const o=r.metadata;return o?!!(o.targets&&o.targets.some(n=>t.includes(n))||e&&mn.has(o.category)):!1});if(a.length===0)return!1;for(const r of a)ks.add(r.id);const i=(await Promise.allSettled(a.map(async r=>{try{const o=await hi(r.id);if(o&&o.geojson){const n=q.layers.findIndex(l=>l.id===r.id);return n>=0&&(q.layers[n]={...q.layers[n],geojson:o.geojson}),!0}return!1}finally{ks.delete(r.id)}}))).some(r=>r.status==="fulfilled"&&r.value===!0);return i&&(es=!0,gn(),Kt()),i}function vn(t){if(!t||t.length===0)return!1;const e=t.includes("T1");return q.layers.some(a=>{if(a.geojson!==null)return!1;const s=a.metadata;return s?!!(s.targets&&s.targets.some(i=>t.includes(i))||e&&mn.has(s.category)):!1})}function Pe(){window.dispatchEvent(new CustomEvent("nbsap:refresh"))}const kl="fcc1682b158fe80d089f1627dd31cf5fa6bf2162058ac3e688d24fe03cc538f8",bi="nbsap_admin_session";let $a=sessionStorage.getItem(bi)==="1",xi=$a?"admin":null;async function Pl(t){const a=new TextEncoder().encode(t),s=await crypto.subtle.digest("SHA-256",a);return Array.from(new Uint8Array(s)).map(i=>i.toString(16).padStart(2,"0")).join("")}function $l(){return localStorage.getItem("nbsap_admin_hash")||kl}async function Cl(t){if(!t)return{success:!1,error:"Passphrase required"};const e=await Pl(t),a=$l();return e===a?($a=!0,xi="admin",sessionStorage.setItem(bi,"1"),{success:!0}):{success:!1,error:"Invalid passphrase"}}function Tl(){$a=!1,xi=null,sessionStorage.removeItem(bi)}function Ll(){return{isAuthenticated:$a,user:xi,provider:"local-passphrase"}}function Nl(){return $a}const Il=Object.freeze(Object.defineProperty({__proto__:null,getAuthState:Ll,isAdmin:Nl,login:Cl,logout:Tl},Symbol.toStringTag,{value:"Module"})),{login:Gl,logout:Rl,getAuthState:Bl,isAdmin:At}=Il,jt={targets:[{code:"T1",name:"Target 1: Biodiversity Spatial Planning",icon:"🗺",color:"#1565C0",description:"Participatory spatial planning across all land and sea areas to reduce biodiversity loss from land and sea-use change. Tracks % of land and sea area covered by biodiversity-inclusive spatial plans. Terrestrial = (CCA + Inland Water) / land area. Marine = (EEZ − National Boundary) / EEZ.",isMetricTarget:!0,recommendedCategories:["CCA","INLAND_WATER"]},{code:"T2",name:"Target 2: Ecosystem Restoration",icon:"🌿",color:"#D84315",description:"Restore at least 30% of degraded terrestrial, inland water, marine and coastal ecosystems by 2030. Maps degraded areas and active restoration sites to track Vanuatu's restoration progress toward the global 30% goal.",isMetricTarget:!0,recommendedCategories:["DEGRADED","RESTORATION"]},{code:"T3",name:"Target 3: 30×30 Conservation",icon:"🌏",color:"#2E7D32",description:"Conserve and effectively manage at least 30% of terrestrial, inland water, and marine areas by 2030 through protected areas and other effective area-based conservation measures (CCAs, MPAs, LMMAs, Custom Forest Tabu Areas, OECMs).",isMetricTarget:!0,recommendedCategories:["CCA","MPA","PA","OECM","LMMA"]},{code:"T4",name:"Target 4: Species Recovery & Biodiversity",icon:"🦜",color:"#7E57C2",description:"Halt human-induced species extinction and support recovery of threatened species while maintaining genetic diversity. Maps distribution of significant Vanuatu species (Megapode, Mountain Starling, Streaked Fantail, Kingfisher, Flying Fox, Plerandra vanuatuensis) and Key Biodiversity Areas.",isMetricTarget:!0,recommendedCategories:["MEGAPODE","STARLING","FANTAIL","KINGFISHER","FLYING_FOX","PLERANDRA","KBA","SPECIES_DIST"]},{code:"T6",name:"Target 6: Invasive Alien Species",icon:"🪲",color:"#C62828",description:"Reduce invasive alien species introductions by at least 50% and minimize their ecological impacts. Spatial analysis of key IAS coverage and distribution — Merremia peltata (Big Leaf), Crown-of-Thorns Starfish, Mile-a-Minute Vine, Solanum torvum (Devil Fig), Fire Ants, African Snail, Sako, Coconut Beetle.",isMetricTarget:!0,recommendedCategories:["MERREMIA","CROWN_OF_THORNS","MILE_A_MINUTE","SOLANUM_TORVUM","INVASIVE"]},{code:"T7",name:"Target 7: Pollution Reduction",icon:"⚗",color:"#8E24AA",description:"Reduce pollution from all sources to levels not harmful to biodiversity, including halving nutrient and pesticide risks. Maps areas of pesticide and herbicide use in large-scale and small-scale commercial farming across Vanuatu.",isMetricTarget:!0,recommendedCategories:["PESTICIDE"]},{code:"T8",name:"Target 8: Climate & Ocean Impacts",icon:"🌊",color:"#00838F",description:"Minimize climate change and ocean acidification impacts on biodiversity through mitigation and nature-based solutions. Maps coastal eutrophication and nutrient-impacted marine zones around Vanuatu's islands as indicators of cumulative environmental pressures.",isMetricTarget:!0,recommendedCategories:["EUTROPHICATION"]},{code:"T10",name:"Target 10: Sustainable Land Use",icon:"🌾",color:"#795548",description:"Ensure sustainable biodiversity-compatible management across agriculture, aquaculture, fisheries and forestry. Maps land cover change to track ecosystem conversion and support integration of biodiversity practices across productive sectors.",isMetricTarget:!0,recommendedCategories:["LAND_COVER"]},{code:"T12",name:"Target 12: Urban Green & Blue Spaces",icon:"🌳",color:"#388E3C",description:"Increase and enhance green and blue spaces in urban and peri-urban areas to improve biodiversity, ecological connectivity, and human well-being. Maps parks, botanical gardens and coastal blue spaces across provincial and municipal areas.",isMetricTarget:!0,recommendedCategories:["GREEN_SPACE"]}]};/**
 ...
 */const Dl='xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"';function Ol(t,e){return`<svg width="${t}" height="${t}" viewBox="0 0 24 24" ${Dl}>${e}</svg>`}const yn={anchor:'<path d="M12 6v16"/><path d="m19 13 2-1a9 9 0 0 1-18 0l2 1"/><path d="M9 11h6"/><circle cx="12" cy="4" r="2"/>',landmark:'<path d="M10 18v-7"/><path d="M11.12 2.198a2 2 0 0 1 1.76.006l7.866 3.847c.476.233.31.949-.22.949H3.474c-.53 0-.695-.716-.22-.949z"/><path d="M14 18v-7"/><path d="M18 18v-7"/><path d="M3 22h18"/><path d="M6 18v-7"/>',users:'<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><path d="M16 3.128a4 4 0 0 1 0 7.744"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><circle cx="9" cy="7" r="4"/>',waves:'<path d="M2 6c.6.5 1.2 1 2.5 1C7 7 7 5 9.5 5c2.6 0 2.4 2 5 2 2.5 0 2.5-2 5-2 1.3 0 1.9.5 2.5 1"/><path d="M2 12c.6.5 1.2 1 2.5 1 2.5 0 2.5-2 5-2 2.6 0 2.4 2 5 2 2.5 0 2.5-2 5-2 1.3 0 1.9.5 2.5 1"/><path d="M2 18c.6.5 1.2 1 2.5 1 2.5 0 2.5-2 5-2 2.6 0 2.4 2 5 2 2.5 0 2.5-2 5-2 1.3 0 1.9.5 2.5 1"/>',shield:'<path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"/>',shieldCheck:'<path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"/><path d="m9 12 2 2 4-4"/>',star:'<path d="M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z"/>',fish:'<path d="M6.5 12c.94-3.46 4.94-6 8.5-6 3.56 0 6.06 2.54 7 6-.94 3.47-3.44 6-7 6s-7.56-2.53-8.5-6Z"/><path d="M18 12v.5"/><path d="M16 17.93a9.77 9.77 0 0 1 0-11.86"/><path d="M7 10.67C7 8 5.58 5.97 2.73 5.5c-1 1.5-1 5 .23 6.5-1.24 1.5-1.24 5-.23 6.5C5.58 18.03 7 16 7 13.33"/><path d="M10.46 7.26C10.2 5.88 9.17 4.24 8 3h5.8a2 2 0 0 1 1.98 1.67l.23 1.4"/><path d="m16.01 17.93-.23 1.4A2 2 0 0 1 13.8 21H9.5a5.96 5.96 0 0 0 1.49-3.98"/>',map:'<path d="M14.106 5.553a2 2 0 0 0 1.788 0l3.659-1.83A1 1 0 0 1 21 4.619v12.764a1 1 0 0 1-.553.894l-4.553 2.277a2 2 0 0 1-1.788 0l-4.212-2.106a2 2 0 0 0-1.788 0l-3.659 1.83A1 1 0 0 1 3 19.381V6.618a1 1 0 0 1 .553-.894l4.553-2.277a2 2 0 0 1 1.788 0z"/><path d="M15 5.764v15"/><path d="M9 3.236v15"/>',triangleAlert:'<path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3"/><path d="M12 9v4"/><path d="M12 17h.01"/>',sprout:'<path d="M14 9.536V7a4 4 0 0 1 4-4h1.5a.5.5 0 0 1 .5.5V5a4 4 0 0 1-4 4 4 4 0 0 0-4 4c0 2 1 3 1 5a5 5 0 0 1-1 3"/><path d="M4 9a5 5 0 0 1 8 4 5 5 0 0 1-8-4"/><path d="M5 21h14"/>',search:'<circle cx="11" cy="11" r="8"/><path d="m21 21-4.34-4.34"/>',bird:'<path d="M16 7h.01"/><path d="M3.4 18H12a8 8 0 0 0 8-8V7a4 4 0 0 0-7.28-2.3L2 20"/><path d="m20 7 2 .5-2 .5"/><path d="M10 18v3"/><path d="M14 17.75V21"/><path d="M7 18a6 6 0 0 0 3.84-10.61"/>',leaf:'<path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 4.18 2 8 0 5.5-4.78 10-10 10Z"/><path d="M2 21c0-3 1.85-5.36 5.08-6C9.5 14.52 12 13 13 12"/>',ban:'<circle cx="12" cy="12" r="10"/><path d="m4.9 4.9 14.2 14.2"/>',wind:'<path d="M12.8 19.6A2 2 0 1 0 14 16H2"/><path d="M17.5 8a2.5 2.5 0 1 1 2 4H2"/><path d="M9.8 4.4A2 2 0 1 1 11 8H2"/>',flaskConical:'<path d="M14 2v6a2 2 0 0 0 .245.96l5.51 10.08A2 2 0 0 1 18 22H6a2 2 0 0 1-1.755-2.96l5.51-10.08A2 2 0 0 0 10 8V2"/><path d="M6.453 15h11.094"/><path d="M8.5 2h7"/>',droplets:'<path d="M7 16.3c2.2 0 4-1.83 4-4.05 0-1.16-.57-2.26-1.71-3.19S7.29 6.75 7 5.3c-.29 1.45-1.14 2.84-2.29 3.76S3 11.1 3 12.25c0 2.22 1.8 4.05 4 4.05z"/><path d="M12.56 6.6A10.97 10.97 0 0 0 14 3.02c.5 2.5 2 4.9 4 6.5s3 3.5 3 5.5a6.98 6.98 0 0 1-11.91 4.97"/>',layers:'<path d="M12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.83z"/><path d="M2 12a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 12"/><path d="M2 17a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 17"/>',trees:'<path d="M10 10v.2A3 3 0 0 1 8.9 16H5a3 3 0 0 1-1-5.8V10a3 3 0 0 1 6 0Z"/><path d="M7 16v6"/><path d="M13 19v3"/><path d="M12 19h8.3a1 1 0 0 0 .7-1.7L18 14h.3a1 1 0 0 0 .7-1.7L16 9h.2a1 1 0 0 0 .8-1.7L13 3l-1.4 1.5"/>',globe:'<circle cx="12" cy="12" r="10"/><path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"/><path d="M2 12h20"/>',bug:'<path d="M12 20v-9"/><path d="M14 7a4 4 0 0 1 4 4v3a6 6 0 0 1-12 0v-3a4 4 0 0 1 4-4z"/><path d="M14.12 3.88 16 2"/><path d="M21 21a4 4 0 0 0-3.81-4"/><path d="M21 5a4 4 0 0 1-3.55 3.97"/><path d="M22 13h-4"/><path d="M3 21a4 4 0 0 1 3.81-4"/><path d="M3 5a4 4 0 0 0 3.55 3.97"/><path d="M6 13H2"/><path d="m8 2 1.88 1.88"/><path d="M9 7.13V6a3 3 0 1 1 6 0v1.13"/>',wheat:'<path d="M2 22 16 8"/><path d="M3.47 12.53 5 11l1.53 1.53a3.5 3.5 0 0 1 0 4.94L5 19l-1.53-1.53a3.5 3.5 0 0 1 0-4.94Z"/><path d="M7.47 8.53 9 7l1.53 1.53a3.5 3.5 0 0 1 0 4.94L9 15l-1.53-1.53a3.5 3.5 0 0 1 0-4.94Z"/><path d="M11.47 4.53 13 3l1.53 1.53a3.5 3.5 0 0 1 0 4.94L13 11l-1.53-1.53a3.5 3.5 0 0 1 0-4.94Z"/><path d="M20 2h2v2a4 4 0 0 1-4 4h-2V6a4 4 0 0 1 4-4Z"/><path d="M11.47 17.47 13 19l-1.53 1.53a3.5 3.5 0 0 1-4.94 0L5 19l1.53-1.53a3.5 3.5 0 0 1 4.94 0Z"/><path d="M15.47 13.47 17 15l-1.53 1.53a3.5 3.5 0 0 1-4.94 0L9 15l1.53-1.53a3.5 3.5 0 0 1 4.94 0Z"/><path d="M19.47 9.47 21 11l-1.53 1.53a3.5 3.5 0 0 1-4.94 0L13 11l1.53-1.53a3.5 3.5 0 0 1 4.94 0Z"/>',circle:'<circle cx="12" cy="12" r="10"/>'};yn.bat='<path d="M12 4c-1 2-4 4-8 5 1 3 3 5 5 6l-2 3h10l-2-3c2-1 4-3 5-6-4-1-7-3-8-5z"/><circle cx="10" cy="9" r="1"/><circle cx="14" cy="9" r="1"/>';function bn(t,e=16){const a=yn[t];return a?Ol(e,a):""}const Fl={EEZ:"anchor",ADMIN_BOUNDARY:"landmark",CCA:"users",MPA:"waves",PA:"shield",OECM:"shieldCheck",KBA:"star",LMMA:"fish",SPATIAL_PLAN:"map",DEGRADED:"triangleAlert",RESTORATION:"sprout",SPECIES_DIST:"search",MEGAPODE:"bird",STARLING:"bird",FANTAIL:"bird",KINGFISHER:"bird",FLYING_FOX:"bat",PLERANDRA:"leaf",INVASIVE:"ban",MERREMIA:"leaf",CROWN_OF_THORNS:"star",MILE_A_MINUTE:"wind",SOLANUM_TORVUM:"sprout",PESTICIDE:"flaskConical",EUTROPHICATION:"droplets",LAND_COVER:"layers",GREEN_SPACE:"trees",OTHER:"circle"},zl={T1:"map",T2:"sprout",T3:"globe",T4:"bird",T6:"bug",T7:"flaskConical",T8:"waves",T10:"wheat",T12:"trees"};function ta(t,e=16){return bn(Fl[t]||"circle",e)}function _i(t,e=16){return bn(zl[t]||"circle",e)}function jl(t){const e=V(),a=e.provinces||[],s=ql();t.innerHTML=`
        ...
        <div class="target-checkboxes" id="target-filter-checkboxes">
          ${jt.targets.map(i=>{const r=e.filters.targets.includes(i.code),o=r?`background:${i.color};border-color:${i.color};color:#fff`:"",n=s[i.code],l=n!=null?`${n.toFixed(1)}%`:"—",c=r?"rgba(255,255,255,0.4)":i.color,h=n!=null?Math.min(n,100):0;return`
            <label class="target-checkbox ${r?"selected":""}"
              ...
              <span class="target-pill-icon">${_i(i.code,14)}</span>
  ...
  `,t.querySelectorAll(".target-checkbox").forEach(i=>{i.addEventListener("click",r=>{r.preventDefault();const o=i.dataset.code;Oa({targets:[o]})})}),t.querySelector("#filter-province").addEventListener("change",i=>{Oa({province:i.target.value})}),t.querySelector("#filter-realm").addEventListener("change",i=>{Oa({realm:i.target.value})}),t.querySelector("#btn-clear-filters").addEventListener("click",()=>{Oa({targets:["T3"],province:"All",category:"All",realm:"All",year:"All"})})}let Ps=null,ar=-1;const ia={targets:[],province:"All",category:"All",realm:"All",year:"All"},sr=["MEGAPODE","STARLING","FANTAIL","KINGFISHER","FLYING_FOX","PLERANDRA"];function ql(){const t=Lt();if(Ps&&t.length===ar)return Ps;ar=t.length;const e=lt.nationalBaselines,a={};for(const s of jt.targets){if(!t.some(r=>{var o,n;return(n=(o=r.metadata)==null?void 0:o.targets)==null?void 0:n.includes(s.code)})){a[s.code]=null;continue}try{if(s.code==="T3"){const r=We(t,ia),o=e.terrestrial_ha+e.marine_ha;a.T3=o>0?(r.terrestrial_ha+r.marine_ha)/o*100:0}else if(s.code==="T1"){const r=ys(t,ia);a.T1=r.total_pct||0}else if(s.code==="T2"){const r=pi(t,ia);a.T2=r.restoration_pct||0}else if(s.code==="T4"){const r=le(t,"T4",ia),o=sr.filter(n=>r.categoryBreakdown.some(l=>l.category===n&&l.features>0)).length;a.T4=o/sr.length*100}else{const r=le(t,s.code,ia),o=6;a[s.code]=r.provinceBreakdown.length/o*100}}catch{a[s.code]=null}}return Ps=a,a}const js={EEZ:{fill:"#FF0000",stroke:"#CC0000"},ADMIN_BOUNDARY:{fill:"#37474F",stroke:"#263238"},CCA:{fill:"#2E7D32",stroke:"#1B5E20"},PA:{fill:"#1B5E20",stroke:"#0D3311"},OECM:{fill:"#7E57C2",stroke:"#5E35B1"},KBA:{fill:"#EF6C00",stroke:"#E65100"},MPA:{fill:"#1565C0",stroke:"#0D47A1"},LMMA:{fill:"#00796B",stroke:"#004D40"},INLAND_WATER:{fill:"#4FC3F7",stroke:"#0288D1"},SPATIAL_PLAN:{fill:"#78909C",stroke:"#546E7A"},DEGRADED:{fill:"#D84315",stroke:"#BF360C"},RESTORATION:{fill:"#F9A825",stroke:"#F57F17"},SPECIES_DIST:{fill:"#26A69A",stroke:"#00897B"},MEGAPODE:{fill:"#E65100",stroke:"#BF360C"},STARLING:{fill:"#5C6BC0",stroke:"#3949AB"},FANTAIL:{fill:"#FFB300",stroke:"#FF8F00"},KINGFISHER:{fill:"#00ACC1",stroke:"#00838F"},FLYING_FOX:{fill:"#6D4C41",stroke:"#4E342E"},PLERANDRA:{fill:"#66BB6A",stroke:"#43A047"},INVASIVE:{fill:"#C62828",stroke:"#B71C1C"},MERREMIA:{fill:"#BF360C",stroke:"#8D2409"},CROWN_OF_THORNS:{fill:"#FF6F00",stroke:"#E65100"},MILE_A_MINUTE:{fill:"#AD1457",stroke:"#880E4F"},SOLANUM_TORVUM:{fill:"#6A1B9A",stroke:"#4A148C"},PESTICIDE:{fill:"#8E24AA",stroke:"#6A1B9A"},EUTROPHICATION:{fill:"#D81B60",stroke:"#AD1457"},LAND_COVER:{fill:"#795548",stroke:"#5D4037"},GREEN_SPACE:{fill:"#388E3C",stroke:"#2E7D32"},OTHER:{fill:"#78909C",stroke:"#546E7A"}},ir={Forest:{fill:"#1B5E20",stroke:"#0D3311"},"Dense Forest":{fill:"#1B5E20",stroke:"#0D3311"},"Sparse Forest":{fill:"#388E3C",stroke:"#2E7D32"},"Medium Forest":{fill:"#2E7D32",stroke:"#1B5E20"},"Thicket/Dense Shrub":{fill:"#558B2F",stroke:"#33691E"},Mangrove:{fill:"#004D40",stroke:"#00251A"},Agriculture:{fill:"#F9A825",stroke:"#F57F17"},Cropland:{fill:"#FFD54F",stroke:"#FFC107"},Plantation:{fill:"#827717",stroke:"#524A03"},Coconut:{fill:"#9E9D24",stroke:"#6D6B1E"},"Coconut Plantation":{fill:"#9E9D24",stroke:"#6D6B1E"},Agroforestry:{fill:"#8D6E63",stroke:"#6D4C41"},Grassland:{fill:"#AED581",stroke:"#8BC34A"},Shrub:{fill:"#7CB342",stroke:"#558B2F"},Savanna:{fill:"#C0CA33",stroke:"#9E9D24"},Urban:{fill:"#E53935",stroke:"#C62828"},"Built-up":{fill:"#E53935",stroke:"#C62828"},Settlement:{fill:"#EF5350",stroke:"#D32F2F"},Bare:{fill:"#A1887F",stroke:"#795548"},"Bare Ground":{fill:"#A1887F",stroke:"#795548"},Rock:{fill:"#8D6E63",stroke:"#5D4037"},Sand:{fill:"#FFE0B2",stroke:"#FFCC80"},Water:{fill:"#1565C0",stroke:"#0D47A1"},"Inland Water":{fill:"#1565C0",stroke:"#0D47A1"},Wetland:{fill:"#00838F",stroke:"#006064"},Swamp:{fill:"#00695C",stroke:"#004D40"},Coral:{fill:"#FF7043",stroke:"#E64A19"},Reef:{fill:"#FF7043",stroke:"#E64A19"},Lagoon:{fill:"#4FC3F7",stroke:"#0288D1"},Seagrass:{fill:"#26A69A",stroke:"#00897B"},Cloud:{fill:"#ECEFF1",stroke:"#CFD8DC"},Shadow:{fill:"#90A4AE",stroke:"#607D8B"},"No Data":{fill:"#BDBDBD",stroke:"#9E9E9E"}},rr=[{fill:"#1B5E20",stroke:"#0D3311"},{fill:"#F9A825",stroke:"#F57F17"},{fill:"#0277BD",stroke:"#01579B"},{fill:"#E53935",stroke:"#C62828"},{fill:"#6A1B9A",stroke:"#4A148C"},{fill:"#00838F",stroke:"#006064"},{fill:"#EF6C00",stroke:"#E65100"},{fill:"#558B2F",stroke:"#33691E"},{fill:"#AD1457",stroke:"#880E4F"},{fill:"#4527A0",stroke:"#311B92"},{fill:"#00695C",stroke:"#004D40"},{fill:"#9E9D24",stroke:"#6D6B1E"},{fill:"#C62828",stroke:"#B71C1C"},{fill:"#1565C0",stroke:"#0D47A1"},{fill:"#FF8F00",stroke:"#FF6F00"},{fill:"#2E7D32",stroke:"#1B5E20"},{fill:"#5C6BC0",stroke:"#3949AB"},{fill:"#D84315",stroke:"#BF360C"},{fill:"#00897B",stroke:"#00695C"},{fill:"#827717",stroke:"#524A03"}],$s=new Map;function Hl(t){if($s.has(t))return $s.get(t);let e=0;for(let i=0;i<t.length;i++)e=(e<<5)-e+t.charCodeAt(i)|0;const a=Math.abs(e)%rr.length,s=rr[a];return $s.set(t,s),s}const xn={Designated:{fillOpacity:.35,dashArray:null,weight:2},Active:{fillOpacity:.35,dashArray:null,weight:2},Proposed:{fillOpacity:.18,dashArray:"6 4",weight:1.5},Inactive:{fillOpacity:.1,dashArray:"2 4",weight:1},Unknown:{fillOpacity:.28,dashArray:null,weight:1.5}},Ul=xn.Unknown,wi=new Set(["MEGAPODE","STARLING","FANTAIL","KINGFISHER","FLYING_FOX","PLERANDRA","SPECIES_DIST"]);function mt(t,e){const a=t||"OTHER",s=js[a]||js.OTHER;if(a==="LAND_COVER"&&e){const i=ir[e];if(i)return i;const r=e.toUpperCase();for(const[o,n]of Object.entries(ir))if(r.includes(o.toUpperCase())||o.toUpperCase().includes(r))return n;return Hl(e)}return s}function _n(t,e){var a;return t==="LAND_COVER"?`LAND_COVER::${((a=e.properties)==null?void 0:a.type)||"Unknown"}`:t}function Vl(t,e){const a=mt(t,e);return t==="EEZ"?{fillColor:a.fill,color:a.stroke,weight:2.5,fillOpacity:0,interactive:!1}:{fillColor:a.fill,color:a.stroke,weight:2.5,fillOpacity:.45,interactive:!1}}function Wl(t,e){const a=t.properties||{},s=mt(e,a.type),i=xn[a.status]||Ul;return{fillColor:s.fill,color:s.stroke,weight:i.weight*.8,fillOpacity:0,dashArray:i.dashArray||"4 3"}}function wn(t,e){const a=mt(t,e);return t==="EEZ"?{fillColor:a.fill,color:a.stroke,weight:2.5,fillOpacity:0,dashArray:null}:{fillColor:a.fill,color:a.stroke,weight:2,fillOpacity:.15,dashArray:"8 4"}}function Kl(t,e){const a=t.properties||{},s=mt(e,a.type);return{radius:wi.has(e)?7:6,fillColor:s.fill,color:"#fff",weight:1.5,fillOpacity:.85}}function Mn(t){const e=mt(t);return{radius:wi.has(t)?6:5,fillColor:e.fill,color:e.stroke,weight:1.5,fillOpacity:.3,dashArray:"3 3"}}function Sn(t,e){const a=mt(t,e);return{fillColor:a.fill,color:a.stroke,weight:2.5,fillOpacity:.5}}function En(t){const e=mt(t);return{radius:wi.has(t)?6:5,fillColor:e.fill,color:"#fff",weight:1,fillOpacity:.85}}const An="#B0BEC5",kn="#78909C";function ua(t){var a,s;const e=(((a=t.properties)==null?void 0:a.presence)||((s=t.properties)==null?void 0:s.type)||"").toLowerCase();return e.includes("extinct")||e.includes("possibly extinct")||e==="ex"}function Yl(t){return{fillColor:An,color:kn,weight:2,fillOpacity:.25,dashArray:"6 4"}}function Jl(t){return{radius:6,fillColor:An,color:kn,weight:1.5,fillOpacity:.5,dashArray:"4 3"}}function Zl(t){var a,s;const e=new Map;for(const i of t){const r=i.metadata;if(!r)continue;const o=r.category||"OTHER",n=r.category?js[o]?void 0:o:"Other";if(o==="LAND_COVER"&&((a=i.geojson)!=null&&a.features)){const l=new Set;for(const c of i.geojson.features)l.add(((s=c.properties)==null?void 0:s.type)||"Unknown");for(const c of l){const h=`LAND_COVER::${c}`;if(!e.has(h)){const d=mt("LAND_COVER",c);e.set(h,{label:c,fill:d.fill,stroke:d.stroke})}}}else if(!e.has(o)){const l=mt(o);e.set(o,{label:n,fill:l.fill,stroke:l.stroke})}}return[...e.entries()].map(([i,r])=>({key:i,label:r.label,fill:r.fill,stroke:r.stroke}))}const Pn={T1:{label:"Biodiversity Spatial Planning",color:"#1565C0",unit:"ha planned"},T2:{label:"Degraded Areas & Restoration",color:"#D84315",unit:"ha mapped"},T3:{label:"30x30 Conservation",color:"#2E7D32",unit:"ha conserved"},T4:{label:"Species & Biodiversity",color:"#7E57C2",unit:"species records"},T6:{label:"Invasive Alien Species",color:"#C62828",unit:"ha detected"},T7:{label:"Pesticide & Herbicide",color:"#8E24AA",unit:"ha mapped"},T8:{label:"Coastal Eutrophication",color:"#00838F",unit:"ha impacted"},T10:{label:"Land Cover Change",color:"#795548",unit:"ha mapped"},T12:{label:"Blue & Green Spaces",color:"#388E3C",unit:"ha mapped"}};function Xl(t){const a=V().filters,s=Lt(),i=a.targets;if(i.length===1){const o=i[0];if(!s.some(l=>l.metadata.targets&&l.metadata.targets.includes(o))){oc(t,o);return}o==="T1"?Ql(t,s,a):o==="T2"?tc(t,s,a):o==="T3"?nr(t,s,a):o==="T4"?ec(t,s,a):o==="T6"?ac(t,s,a):o==="T10"?sc(t,s,a):ic(t,s,a,o);return}i.length===0||i.includes("T3")?nr(t,s,a):rc(t,s,a)}function Ql(t,e,a){const s=ys(e,a),i=s.baselines,r=s.terrestrial_pct,o=Math.min(r,100),n=s.marine_pct,l=Math.min(n,100),c=s.total_pct,h=Math.min(c,100),d=s.categoryBreakdown.map(u=>{const f=Y[u.category]||{label:u.category,color:"#95a5a6"};return`<span class="cat-badge" style="background:${f.color}20;color:${f.color};border:1px solid ${f.color}40">
      ${ta(u.category,13)} ${f.label}: ${j(u.area_ha)} ha (${u.features})
  ...
  `}function tc(t,e,a){const s=pi(e,a),i=Math.min(s.restoration_pct,100),r=s.degraded_ha+s.restoration_ha,o=s.provinceBreakdown.filter(h=>h.degraded_ha>0||h.restoration_ha>0).map(h=>{const d=h.restoration_pct||0,u=Math.min(d,100);return`
      ...
      ${ta(h.category,13)} ${d.label}: ${j(h.area_ha)} ha (${h.features})
  ...
  `}const Cs=[{key:"MEGAPODE",name:"Vanuatu Megapode",scientific:"Megapodius layardi",taxa:"Bird",photo:"species-photos/megapode.jpg",credit:"Euan Moore / iNaturalist (CC BY)"},{key:"STARLING",name:"Vanuatu Mountain Starling",scientific:"Aplonis santovestris",taxa:"Bird",photo:null,credit:null},{key:"FANTAIL",name:"Vanuatu Streaked Fantail",scientific:"Rhipidura spilodera",taxa:"Bird",photo:"species-photos/fantail.jpg",credit:"iNaturalist (CC BY-NC)"},{key:"KINGFISHER",name:"Vanuatu Kingfisher",scientific:"Todiramphus farquhari",taxa:"Bird",photo:"species-photos/kingfisher.jpg",credit:"Andrew Toara Morris / iNaturalist (CC BY-NC)"},{key:"FLYING_FOX",name:"Vanuatu Flying Fox",scientific:"Pteropus anetianus",taxa:"Mammal",photo:"species-photos/flying-fox.jpg",credit:"craigjhowe / iNaturalist (CC BY-NC)"},{key:"PLERANDRA",name:"Plerandra vanuatuensis",scientific:"Plerandra vanuatuensis",taxa:"Plant",photo:null,credit:null}];function ec(t,e,a){const s=le(e,"T4",a),i=Cs.filter(l=>s.categoryBreakdown.some(c=>c.category===l.key&&c.features>0)),r=s.categoryBreakdown.find(l=>l.category==="KBA"),o=s.categoryBreakdown.find(l=>l.category==="SPECIES_DIST"),n=Cs.map(l=>{const c=s.categoryBreakdown.find(f=>f.category===l.key),h=Y[l.key]||{color:"#95a5a6"},d=c&&c.features>0,u=l.photo?`<div class="species-photo" style="background-image:url('${l.photo}')" title="${l.credit||""}"></div>`:`<div class="species-photo species-photo-placeholder"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="${h.color}" stroke-width="1.5" opacity="0.4"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2z"/><path d="M8 14s1.5 2 4 2 4-2 4-2"/><path d="M9 9h.01"/><path d="M15 9h.01"/></svg></div>`;return`
    ...
    <div class="kpi-grid">
      ...
      <div class="kpi-card">
        <div class="kpi-value">${i.length} / ${Cs.length}</div>
    ...
    ${o&&o.features>0?`
      <div class="kpi-cat-badges" style="margin-top:8px">
        <span class="cat-badge" style="background:${Y.SPECIES_DIST.color}20;color:${Y.SPECIES_DIST.color};border:1px solid ${Y.SPECIES_DIST.color}40">
          ${ta("SPECIES_DIST",13)} Other Species: ${j(o.area_ha)} ha (${o.features})
        </span>
      </div>
    `:""}
  `}function ac(t,e,a){const s=le(e,"T6",a),i=s.categoryBreakdown.find(o=>o.category==="MERREMIA"),r=s.categoryBreakdown.find(o=>o.category==="INVASIVE");s.grossAreaHa>0&&Math.abs(s.grossAreaHa-s.totalAreaHa)>1,t.innerHTML=`
    <div class="kpi-grid">
    ...
    ${s.typeBreakdown.length>0?$n(s.typeBreakdown,"Species / Detection Type"):""}
  `}function sc(t,e,a){const s=le(e,"T10",a);s.grossAreaHa>0&&Math.abs(s.grossAreaHa-s.totalAreaHa)>1;const i=s.typeBreakdown,r=i.length,n=i.slice(0,25),l=i.length-n.length,c=n.map(d=>{const f=mt("LAND_COVER",d.type).fill,p=s.grossAreaHa>0?d.area_ha/s.grossAreaHa*100:0;return`
      <tr>
        <td>
  ...
  `;t.innerHTML=`
    ...
    `:""}
  `}function ic(t,e,a,s){const i=le(e,s,a),r=Pn[s]||{unit:"ha"};i.grossAreaHa>0&&Math.abs(i.grossAreaHa-i.totalAreaHa)>1;const o=i.categoryBreakdown.map(n=>{const l=Y[n.category]||{label:n.category,color:"#95a5a6"};return`<span class="cat-badge" style="background:${l.color}20;color:${l.color};border:1px solid ${l.color}40">
      ${ta(n.category,13)} ${l.label}: ${j(n.area_ha)} ha (${n.features})
    </span>`}).join("");t.innerHTML=`
    <div class="kpi-grid">
      <div class="kpi-card">
    ...
    ${i.typeBreakdown.length>1?$n(i.typeBreakdown,"Type Breakdown"):""}
  `}function rc(t,e,a){const s=fi(e,a);s.grossAreaHa>0&&Math.abs(s.grossAreaHa-s.totalAreaHa)>1,t.innerHTML=`
    <div class="kpi-grid">
      <div class="kpi-card">
        <div class="kpi-value">${s.totalFeatures}</div>
        <div class="kpi-label">Data Records</div>
  ...
  `}function $n(t,e){const a=t.slice(0,10).map(s=>`
    <tr>
  ...
  `}const Cn="nbsap_layer_styles_v1";let ea={};try{const t=localStorage.getItem(Cn);t&&(ea=JSON.parse(t))}catch{}function Tn(){try{localStorage.setItem(Cn,JSON.stringify(ea))}catch{}}function ie(t){return ea[t]||null}function Ts(t,e){ea[t]=e,Tn()}function lc(t){delete ea[t],Tn()}function cc(t){return!!ea[t]}function or(t,e,a){if(!e)return t;if(e.mode==="categorized"&&e.categoryColors){const i=e.categoryColors[a];return i?{...t,...i.fillColor&&{fillColor:i.fillColor},...i.strokeColor&&{color:i.strokeColor}}:t}const s={...t};return e.fillTransparent?(s.fill=!1,s.fillOpacity=0):(e.fillColor&&(s.fillColor=e.fillColor),e.fillOpacity!==void 0&&(s.fillOpacity=e.fillOpacity)),e.strokeTransparent?(s.stroke=!1,s.weight=0):(e.strokeColor&&(s.color=e.strokeColor),e.weight!==void 0&&(s.weight=e.weight)),e.dashArray!==void 0&&(s.dashArray=e.dashArray||null),s}function dc(t,e,a){if(!e)return t;if(e.mode==="categorized"&&e.categoryColors){const i=e.categoryColors[a];return i?{...t,...i.fillColor&&{fillColor:i.fillColor},...i.strokeColor&&{color:i.strokeColor}}:t}const s={...t};return e.fillTransparent?(s.fill=!1,s.fillOpacity=0):(e.fillColor&&(s.fillColor=e.fillColor),e.fillOpacity!==void 0&&(s.fillOpacity=e.fillOpacity)),e.strokeTransparent?(s.stroke=!1,s.weight=0):(e.strokeColor&&(s.color=e.strokeColor),e.weight!==void 0&&(s.weight=e.weight)),e.pointRadius!==void 0&&(s.radius=e.pointRadius),s}let Zt=null,as=null,Ge=null;const hc=[{label:"Solid",value:""},{label:"Dashed",value:"8 4"},{label:"Short dash",value:"6 4"},{label:"Dotted",value:"2 4"},{label:"Dash-dot",value:"10 4 2 4"}];function Ln(t){var e,a;return!!((a=(e=t.geojson)==null?void 0:e.features)!=null&&a.some(s=>{var i,r;return((i=s.geometry)==null?void 0:i.type)==="Point"||((r=s.geometry)==null?void 0:r.type)==="MultiPoint"}))}function Nn(t,e){var s,i;if(!((s=t.geojson)!=null&&s.features))return[];const a=new Set;for(const r of t.geojson.features){const o=(i=r.properties)==null?void 0:i[e];o!=null&&o!==""&&a.add(String(o))}return[...a].sort()}function uc(t){var a,s;if(!((s=(a=t.geojson)==null?void 0:a.features)!=null&&s.length))return[];const e=new Set;for(const i of t.geojson.features)i.properties&&Object.keys(i.properties).forEach(r=>e.add(r));return[...e].sort()}function pc(t,e,a){if(Zt&&as===t.id){ss();return}ss(),as=t.id,Ge=e,Zt=document.createElement("div"),Zt.className="sym-panel",Zt.innerHTML=gc(t),document.body.appendChild(Zt),vc(Zt,t)}function ss(){Zt&&(Zt.remove(),Zt=null),as=null,Ge=null}function fc(){return as}function gc(t){const e=t.metadata,a=e.category||"OTHER",s=e.name||"Unnamed Layer",i=ie(t.id),r=mt(a),o=Ln(t),n=uc(t),l=n.length>0,c=(i==null?void 0:i.mode)||"single",h=(i==null?void 0:i.fillColor)||r.fill,d=(i==null?void 0:i.strokeColor)||r.stroke,u=(i==null?void 0:i.fillOpacity)??.45,f=(i==null?void 0:i.weight)??2.5,p=(i==null?void 0:i.dashArray)||"",m=(i==null?void 0:i.pointRadius)??6,g=(i==null?void 0:i.fillTransparent)||!1,v=(i==null?void 0:i.strokeTransparent)||!1,y=At(),b=c!=="categorized"&&c!=="labels"?"active":"",_=c==="categorized"?"active":"";let x="";y&&(x+=`<button class="sym-tab ${b}" data-tab="single">Simple</button>`,l&&(x+=`<button class="sym-tab ${_}" data-tab="categorized">Categorized</button>`));const w=p?"dashed":"solid",k=g?"transparent":h,P=v?"none":`${f}px ${w} ${d}`,C=g?"":`opacity:${Math.min(u+.55,1)}`,M=g?"disabled":"",E=v?"disabled":"",S=g?"sym-field sym-field-disabled":"sym-field",A=v?"sym-field sym-field-disabled":"sym-field",$=`
    <div class="sym-tab-content ${b}" data-content="single">
      ...
      <div class="${A}" id="sym-stroke-group">
        <label>Stroke Color
          <label class="sym-check-label"><input type="checkbox" id="sym-stroke-none" ${v?"checked":""}> No stroke</label>
        </label>
        <div class="sym-color-row">
          <input type="color" class="sym-color" id="sym-stroke" value="${d}" ${E}>
          <span class="sym-color-hex">${d}</span>
        </div>
      </div>
      <div class="${A}" id="sym-weight-group">
        <label>Stroke Width</label>
        <div class="sym-slider-row">
          <input type="range" class="sym-slider" id="sym-weight" min="0.5" max="8" step="0.5" value="${f}" ${E}>
          <span class="sym-slider-val">${f}px</span>
        </div>
      </div>
      <div class="${A}" id="sym-dash-group">
        <label>Stroke Style</label>
        <select class="sym-select" id="sym-dash" ${E}>
          ${hc.map(I=>`<option value="${I.value}" ${p===I.value?"selected":""}>${I.label}</option>`).join("")}
        </select>
      </div>
      ${o?`
      <div class="sym-field">
      ...
      <div class="sym-preview-row">
        <div class="sym-preview-swatch ${g?"sym-preview-transparent":""}" id="sym-preview"
          style="background:${k};border:${P};${C}">
        </div>
        <span class="sym-preview-label">Preview</span>
      </div>
    </div>`;let R="";if(l){const I=i!=null&&i.categoryBy&&n.includes(i.categoryBy)?i.categoryBy:n[0]||"",O=Nn(t,I),F=(i==null?void 0:i.categoryColors)||{},H=n.map(st=>`<option value="${st}" ${I===st?"selected":""}>${st}</option>`).join("");R=`
      ...
      </div>`}x+=`<button class="sym-tab ${!y||c==="labels"?"active":""}" data-tab="labels">Labels</button>`;const N=mc(n,i,!y);return`
    ...
    <div class="sym-footer">
    ...
    </div>`}function In(t,e,a){return t.length===0?'<p class="sym-no-types">No values found in layer data.</p>':t.map(s=>{var n,l;const i=mt(e,s),r=((n=a[s])==null?void 0:n.fillColor)||i.fill,o=((l=a[s])==null?void 0:l.strokeColor)||i.stroke;return`
      ...
      </div>`}).join("")}function mc(t,e,a=!1){const s=(e==null?void 0:e.labels)||{},i=s.enabled||!1,r=s.field&&t.includes(s.field)?s.field:t[0]||"name",o=s.fontSize??11,n=s.fontColor||"#222222",l=s.bufferSize??2,c=s.bufferColor||"#ffffff",h=i?"":"disabled",d=i?"sym-field":"sym-field sym-field-disabled",u=t.length>0?t.map(f=>`<option value="${f}" ${r===f?"selected":""}>${f}</option>`).join(""):'<option value="name">name</option>';return`
    <div class="sym-tab-content ${a?"active":""}" data-content="labels">
      ...
      <div class="sym-label-preview-row" id="sym-label-preview-row">
        <span class="sym-label-preview-text" id="sym-label-preview-text"
          style="font-size:${o}px;color:${n};${Gn(l,c)}">
          Label Preview
        </span>
      </div>
    </div>`}function Gn(t,e){if(!t||t<=0)return"";const a=t,s=e;return`text-shadow:${-a}px ${-a}px ${a}px ${s},${a}px ${-a}px ${a}px ${s},${-a}px ${a}px ${a}px ${s},${a}px ${a}px ${a}px ${s},${-a}px 0 ${a}px ${s},${a}px 0 ${a}px ${s},0 ${-a}px ${a}px ${s},0 ${a}px ${a}px ${s};`}function vc(t,e){var m,g,v,y,b;t.querySelector(".sym-close").addEventListener("click",ss),t.querySelectorAll(".sym-tab").forEach(_=>{_.addEventListener("click",()=>{var x;t.querySelectorAll(".sym-tab").forEach(w=>w.classList.remove("active")),t.querySelectorAll(".sym-tab-content").forEach(w=>w.classList.remove("active")),_.classList.add("active"),(x=t.querySelector(`[data-content="${_.dataset.tab}"]`))==null||x.classList.add("active")})}),(m=t.querySelector("#sym-col-select"))==null||m.addEventListener("change",_=>{yc(t,e,_.target.value)});const a=t.querySelector("#sym-fill"),s=t.querySelector("#sym-stroke"),i=t.querySelector("#sym-opacity"),r=t.querySelector("#sym-weight"),o=t.querySelector("#sym-dash"),n=t.querySelector("#sym-preview"),l=t.querySelector("#sym-fill-none"),c=t.querySelector("#sym-stroke-none");function h(_,x){_.forEach(w=>{const k=t.querySelector(`#${w}`);k&&(k.classList.toggle("sym-field-disabled",x),k.querySelectorAll("input:not([type=checkbox]), select").forEach(P=>{P.disabled=x}))})}function d(){if(!n)return;const _=l==null?void 0:l.checked,x=c==null?void 0:c.checked,w=(a==null?void 0:a.value)||"#ccc",k=(s==null?void 0:s.value)||"#000",P=parseFloat((i==null?void 0:i.value)??.45),C=parseFloat((r==null?void 0:r.value)??2.5),M=o&&o.value!=="";n.classList.toggle("sym-preview-transparent",_),n.style.background=_?"transparent":w,n.style.border=x?"none":`${C}px ${M?"dashed":"solid"} ${k}`,n.style.opacity=_?"":String(Math.min(P+.55,1))}l==null||l.addEventListener("change",()=>{h(["sym-fill-group","sym-opacity-group"],l.checked),d()}),c==null||c.addEventListener("change",()=>{h(["sym-stroke-group","sym-weight-group","sym-dash-group"],c.checked),d()}),t.querySelectorAll(".sym-color").forEach(_=>{_.addEventListener("input",()=>{const x=_.nextElementSibling;x&&(x.textContent=_.value),d()})}),t.querySelectorAll(".sym-slider").forEach(_=>{_.addEventListener("input",()=>{const x=_.nextElementSibling;x&&(x.textContent=_.id==="sym-opacity"?Math.round(parseFloat(_.value)*100)+"%":_.value+"px"),d()})}),o==null||o.addEventListener("change",d);const u=t.querySelector("#sym-label-enabled"),f=["sym-label-field-group","sym-label-size-group","sym-label-color-group","sym-label-buf-group","sym-label-bufcol-group"];function p(){var C,M,E,S;const _=t.querySelector("#sym-label-preview-text");if(!_)return;const x=((C=t.querySelector("#sym-label-size"))==null?void 0:C.value)||11,w=((M=t.querySelector("#sym-label-color"))==null?void 0:M.value)||"#222222",k=parseInt(((E=t.querySelector("#sym-label-bufsize"))==null?void 0:E.value)??2,10),P=((S=t.querySelector("#sym-label-bufcolor"))==null?void 0:S.value)||"#ffffff";_.style.fontSize=x+"px",_.style.color=w,_.style.cssText+=Gn(k,P)}u==null||u.addEventListener("change",()=>{const _=u.checked;f.forEach(x=>{const w=t.querySelector(`#${x}`);w&&(w.classList.toggle("sym-field-disabled",!_),w.querySelectorAll("input:not([type=checkbox]), select").forEach(k=>{k.disabled=!_}))}),p()}),(g=t.querySelector("#sym-label-size"))==null||g.addEventListener("input",_=>{const x=_.target.nextElementSibling;x&&(x.textContent=_.target.value+"px"),p()}),(v=t.querySelector("#sym-label-bufsize"))==null||v.addEventListener("input",_=>{const x=_.target.nextElementSibling;x&&(x.textContent=_.target.value+"px"),p()}),(y=t.querySelector("#sym-label-color"))==null||y.addEventListener("input",_=>{const x=_.target.nextElementSibling;x&&(x.textContent=_.target.value),p()}),(b=t.querySelector("#sym-label-bufcolor"))==null||b.addEventListener("input",_=>{const x=_.target.nextElementSibling;x&&(x.textContent=_.target.value),p()}),Rn(t),t.querySelector(".sym-btn-reset").addEventListener("click",()=>{lc(e.id),Ge&&Ge(),ss()}),t.querySelector(".sym-btn-apply").addEventListener("click",()=>{var S,A;const _=((S=t.querySelector(".sym-tab.active"))==null?void 0:S.dataset.tab)||"single",x=t.querySelector("#sym-label-enabled"),w=t.querySelector("#sym-label-field"),k=t.querySelector("#sym-label-size"),P=t.querySelector("#sym-label-color"),C=t.querySelector("#sym-label-bufsize"),M=t.querySelector("#sym-label-bufcolor"),E={enabled:(x==null?void 0:x.checked)||!1,field:(w==null?void 0:w.value)||"name",fontSize:parseInt((k==null?void 0:k.value)??11,10),fontColor:(P==null?void 0:P.value)||"#222222",bufferSize:parseInt((C==null?void 0:C.value)??2,10),bufferColor:(M==null?void 0:M.value)||"#ffffff"};if(_==="single"){const $=Ln(e),R={mode:"single",fillColor:(a==null?void 0:a.value)||mt(e.metadata.category||"OTHER").fill,strokeColor:(s==null?void 0:s.value)||mt(e.metadata.category||"OTHER").stroke,fillOpacity:parseFloat((i==null?void 0:i.value)??.45),weight:parseFloat((r==null?void 0:r.value)??2.5),dashArray:(o==null?void 0:o.value)||null,fillTransparent:(l==null?void 0:l.checked)||!1,strokeTransparent:(c==null?void 0:c.checked)||!1,labels:E};if($){const T=t.querySelector("#sym-radius");T&&(R.pointRadius=parseFloat(T.value))}Ts(e.id,R)}else if(_==="labels"){const $=ie(e.id)||{mode:"single"};Ts(e.id,{...$,labels:E})}else{const $=t.querySelector(".sym-cat-list");(A=t.querySelector("#sym-col-select"))!=null&&A.value||$!=null&&$.dataset.groupby;const R={};t.querySelectorAll(".sym-cat-row").forEach(T=>{var F,H;const N=T.dataset.type,I=(F=T.querySelector(".sym-cat-fill"))==null?void 0:F.value,O=(H=T.querySelector(".sym-cat-stroke"))==null?void 0:H.value;N&&I&&(R[N]={fillColor:I,strokeColor:O})}),Ts(e.id,{mode:"categorized",categoryBy,categoryColors:R,labels:E})}Ge&&Ge()})}function Rn(t){t.querySelectorAll(".sym-cat-fill, .sym-cat-stroke").forEach(e=>{e.addEventListener("input",()=>{const a=e.closest(".sym-cat-row"),s=a==null?void 0:a.querySelector(".sym-cat-swatch");s&&(s.style.background=a.querySelector(".sym-cat-fill").value,s.style.borderColor=a.querySelector(".sym-cat-stroke").value)})})}function yc(t,e,a){const i=e.metadata.category||"OTHER",r=ie(e.id),o=(r==null?void 0:r.categoryColors)||{},n=Nn(e,a),l=t.querySelector(".sym-cat-list");l&&(l.dataset.groupby=a,l.innerHTML=In(n,i,o),Rn(t))}let yt=null,Ls={},Re=null,Jt=null,pa=null,Fa=null,$e=null;const Wa=new Set,bc=new Set(["ADMIN_BOUNDARY","EEZ","SPATIAL_PLAN"]),xc=new Set(["CCA","LMMA"]);let ft=[],Ke=!1;function Bn(t){const e=new Set(t.map(s=>s.id));ft=ft.filter(s=>e.has(s));for(const s of t)ft.includes(s.id)||ft.push(s.id);const a=new Map(ft.map((s,i)=>[s,i]));return[...t].sort((s,i)=>(a.get(s.id)??999)-(a.get(i.id)??999))}const Ns=D.canvas({padding:.5}),lr=1e3;function _c(t){if(yt)return yt.invalidateSize(),yt;yt=D.map(t,{center:lt.mapCenter,zoom:lt.mapZoom,zoomControl:!0});for(const[a,s]of Object.entries(lt.tileSources))Ls[s.name]=D.tileLayer(s.url,{attribution:s.attribution,maxZoom:s.maxZoom});const e=Object.values(Ls)[0];return e&&e.addTo(yt),Re=D.featureGroup(),Re.addTo(yt),Jt=D.featureGroup(),Jt.addTo(yt),pa=D.layerGroup(),pa.addTo(yt),D.control.layers(Ls,{},{position:"topright"}).addTo(yt),D.control.scale({imperial:!1,position:"bottomleft"}).addTo(yt),yt}function _a(){var g,v,y,b,_;if(!yt)return;Re&&Re.clearLayers(),Jt.clearLayers(),pa&&pa.clearLayers(),Fa&&(Fa.remove(),Fa=null);const t=V(),e=t.filters,a=Lt(),s=Bn(a);t.provincesGeojson&&(Fa=D.geoJSON(t.provincesGeojson,{style:{color:"#555",weight:1.5,fillOpacity:.03,dashArray:"4 4"},onEachFeature:(x,w)=>{const k=x.properties.name||x.properties.province||"Unknown";w.bindTooltip(k,{sticky:!0,className:"province-tooltip"})}}).addTo(yt));const i={},r={},o={},n={},l={},c=[],h=[],d=[],u=[];for(const x of s){const w=x.metadata;if(!x.geojson)continue;if(e.targets.length>0){const S=e.targets.includes("T1"),A=S&&bc.has(w.category),$=S&&w.targets.includes("T1")&&!xc.has(w.category),R=w.targets.some(T=>e.targets.includes(T)&&T!=="T1");if(!A&&!$&&!R)continue}if(e.category&&e.category!=="All"&&w.category!==e.category)continue;const k=w.category||"OTHER",P=kc(x.geojson.features||[],e),C=w.isReference===!0;if(P.length===0||(C||u.push(x),Wa.has(x.id)))continue;C||d.push(x);const M=[],E=[];for(const S of P){const A=(g=S.geometry)==null?void 0:g.type;if(A==="Polygon"||A==="MultiPolygon")if(C)c.push({feature:S,meta:w,cat:k});else{M.push(S);const $=_n(k,S);i[$]||(i[$]=[]),i[$].push(S),r[$]||(r[$]={cat:k,typeValue:k==="LAND_COVER"&&((v=S.properties)==null?void 0:v.type)||null}),o[$]||(o[$]=x.id)}else(A==="Point"||A==="MultiPoint")&&(C?h.push({feature:S,meta:w,cat:k}):E.push(S))}M.length>0&&!C&&(n[k]||(n[k]=[]),n[k].push({features:M,meta:w})),E.length>0&&!C&&(l[k]||(l[k]={features:[],meta:w}),l[k].features.push(...E))}if(c.length>0){const x={};for(const{feature:w,meta:k,cat:P}of c)x[P]||(x[P]={features:[],meta:k}),x[P].features.push(w);for(const[w,k]of Object.entries(x)){const P=D.geoJSON({type:"FeatureCollection",features:k.features},{style:()=>wn(w),onEachFeature:(C,M)=>{ra(C,M,k.meta,!0)}});Re.addLayer(P)}}if(h.length>0){const x={};for(const{feature:w,meta:k,cat:P}of h)x[P]||(x[P]={features:[],meta:k}),x[P].features.push(w);for(const[w,k]of Object.entries(x)){const P=D.geoJSON({type:"FeatureCollection",features:k.features},{pointToLayer:(C,M)=>D.circleMarker(M,Mn(w)),onEachFeature:(C,M)=>{ra(C,M,k.meta,!0)}});Re.addLayer(P)}}let f=0;for(const x of Object.values(i))f+=x.length;const p=f>lr,m=200;for(const[x,w]of Object.entries(i)){const{cat:k,typeValue:P}=r[x],C=o[x],M=ie(C),E=p?{renderer:Ns}:{},S=A=>{var T,N;const $=Vl(k,P),R=M!=null&&M.categoryBy?String(((T=A==null?void 0:A.properties)==null?void 0:T[M.categoryBy])??"")||P:((N=A==null?void 0:A.properties)==null?void 0:N.type)||P;return or($,M,R)};if(p||w.length>m){const A=D.geoJSON({type:"FeatureCollection",features:w},{style:S,interactive:!0,renderer:Ns});A.on("click",$=>{if($.layer&&$.layer.feature){const R=$.layer.feature,T=Sc(R,n[k]);T&&ra(R,$.layer,T),$.layer.openPopup($.latlng)}}),Jt.addLayer(A)}else{const A=dt(w);if(A){const $=D.geoJSON(A,{style:R=>S(R),interactive:!1,...E});Jt.addLayer($)}}}if(!p)for(const[x,w]of Object.entries(n))for(const k of w){const P=ie(k.meta.id),C=D.geoJSON({type:"FeatureCollection",features:k.features},{style:M=>{var A,$;const E=Wl(M,x),S=(P==null?void 0:P.categoryBy)==="status"?(A=M.properties)==null?void 0:A.status:($=M.properties)==null?void 0:$.type;return or(E,P,S)},onEachFeature:(M,E)=>{ra(M,E,k.meta)}});Jt.addLayer(C)}for(const[x,w]of Object.entries(l)){const k=w.features.length>lr?{renderer:Ns}:{},P=ie(w.meta.id),C=D.geoJSON({type:"FeatureCollection",features:w.features},{pointToLayer:(M,E)=>{var $,R;const S=Kl(M,x),A=(P==null?void 0:P.categoryBy)==="status"?($=M.properties)==null?void 0:$.status:(R=M.properties)==null?void 0:R.type;return D.circleMarker(E,dc(S,P,A))},onEachFeature:(M,E)=>{ra(M,E,w.meta)},...k});Jt.addLayer(C)}for(const x of d){const w=(y=ie(x.id))==null?void 0:y.labels;if(!(w!=null&&w.enabled))continue;const k=w.field||"name",P=w.fontSize??11,C=w.fontColor||"#222222",M=w.bufferSize??2,E=w.bufferColor||"#ffffff",S=Ec(M,E);for(const A of((b=x.geojson)==null?void 0:b.features)||[]){const $=String(((_=A.properties)==null?void 0:_[k])??"");if(!$)continue;const R=Ac(A);if(!R)continue;const T=$.replace(/</g,"&lt;").replace(/>/g,"&gt;"),N=D.marker(R,{icon:D.divIcon({className:"feature-label",html:`<span class="feature-label-text" style="font-size:${P}px;color:${C};${S}">${T}</span>`,iconSize:null,iconAnchor:null}),interactive:!1,zIndexOffset:1e3});pa.addLayer(N)}}if(wc(u),!Ke&&Jt.getLayers().length>0){const x=Jt.getBounds();x.isValid()&&yt.fitBounds(x,{padding:[30,30],maxZoom:12})}Ke=!1}function wc(t,e){if($e&&($e.remove(),$e=null),!yt||t.length===0)return;const a=Bn(t);$e=D.control({position:"bottomright"}),$e.onAdd=function(){const s=D.DomUtil.create("div","map-legend");D.DomEvent.disableClickPropagation(s),D.DomEvent.disableScrollPropagation(s);const i=At();let r='<div class="map-legend-title">Layers <span class="map-legend-hint">(use arrows to reorder)</span></div>';for(let o=0;o<a.length;o++){const n=a[o],l=n.metadata,c=l.category||"OTHER",h=mt(c),d=l.name||"Unnamed Layer",u=!Wa.has(n.id),f=o===0,p=o===a.length-1,m=ie(n.id),g=(m==null?void 0:m.mode)==="single"&&m.fillColor?m.fillColor:h.fill,v=(m==null?void 0:m.mode)==="single"&&m.strokeColor?m.strokeColor:h.stroke,y=fc()===n.id,b=cc(n.id);r+=`<div class="map-legend-row map-layer-toggle ${u?"":"layer-hidden"}" data-layer-id="${n.id}" ${i?'draggable="true"':""} title="${d}">
      ...
      </div>`}if(s.innerHTML=r,s.querySelectorAll(".map-layer-cb").forEach(o=>{o.addEventListener("change",()=>{const n=o.dataset.layerId;o.checked?Wa.delete(n):Wa.add(n),Ke=!0,_a()})}),s.querySelectorAll(".layer-move-up").forEach(o=>{o.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),cr(o.dataset.layerId,"up")})}),s.querySelectorAll(".layer-move-down").forEach(o=>{o.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),cr(o.dataset.layerId,"down")})}),s.querySelectorAll(".layer-style-btn").forEach(o=>{o.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation();const l=o.dataset.layerId,c=a.find(h=>h.id===l);c&&pc(c,()=>{Ke=!0,_a()})})}),i){let o=null;s.querySelectorAll(".map-layer-toggle[draggable]").forEach(l=>{l.addEventListener("dragstart",c=>{o=l.dataset.layerId,l.classList.add("layer-dragging"),c.dataTransfer.effectAllowed="move"}),l.addEventListener("dragend",()=>{l.classList.remove("layer-dragging"),s.querySelectorAll(".layer-dragover").forEach(c=>c.classList.remove("layer-dragover")),o=null}),l.addEventListener("dragover",c=>{c.preventDefault(),c.dataTransfer.dropEffect="move",l.classList.add("layer-dragover")}),l.addEventListener("dragleave",()=>{l.classList.remove("layer-dragover")}),l.addEventListener("drop",c=>{c.preventDefault(),l.classList.remove("layer-dragover");const h=l.dataset.layerId;o&&o!==h&&Mc(o,h)})})}return s},$e.addTo(yt)}function cr(t,e){const a=ft.indexOf(t);if(a!==-1){if(e==="up"&&a<ft.length-1)[ft[a],ft[a+1]]=[ft[a+1],ft[a]];else if(e==="down"&&a>0)[ft[a],ft[a-1]]=[ft[a-1],ft[a]];else return;Ke=!0,_a()}}function Mc(t,e){const a=ft.indexOf(t),s=ft.indexOf(e);if(a===-1||s===-1)return;ft.splice(a,1);const i=ft.indexOf(e);ft.splice(i,0,t),Ke=!0,_a()}function Sc(t,e){if(!e)return null;for(const a of e)if(a.features.includes(t))return a.meta;return e.length>0?e[0].meta:null}function ra(t,e,a,s=!1){var h;const i=t.properties,r=mt(a.category,i.type),o=((h=Y[a.category])==null?void 0:h.label)||a.category,n=s?'<span style="display:inline-block;background:#f0ad4e;color:#fff;font-size:10px;font-weight:600;padding:1px 6px;border-radius:10px;margin-left:6px">REF</span>':"",c=`
  ...
  `;e.bindPopup(c)}function Ec(t,e){if(!t||t<=0)return"";const a=t,s=e;return`text-shadow:${[`${-a}px ${-a}px ${a}px ${s}`,`${a}px ${-a}px ${a}px ${s}`,`${-a}px ${a}px ${a}px ${s}`,`${a}px ${a}px ${a}px ${s}`,`${-a}px 0 ${a}px ${s}`,`${a}px 0 ${a}px ${s}`,`0 ${-a}px ${a}px ${s}`,`0 ${a}px ${a}px ${s}`].join(",")};`}function Ac(t){const e=t==null?void 0:t.geometry;if(!e)return null;const a=e.type;if(a==="Point")return D.latLng(e.coordinates[1],e.coordinates[0]);if(a==="MultiPoint")return D.latLng(e.coordinates[0][1],e.coordinates[0][0]);try{const s=D.geoJSON(t).getBounds();if(s.isValid())return s.getCenter()}catch{}return null}function kc(t,e){return t.filter(a=>{const s=a.properties||{};return!(e.province&&e.province!=="All"&&s.province!==e.province||e.realm&&e.realm!=="All"&&s.realm!==e.realm||e.year&&e.year!=="All"&&String(s.year)!==String(e.year))})}function Dn(){return yt}function Pc(){return[...ft]}function $c(){yt&&setTimeout(()=>yt.invalidateSize(),100)}function dr(t,e){if(!e||e.length===0){t.innerHTML='<p style="color:var(--text-light);font-size:13px;padding:10px">No province data available</p>';return}const a=Math.max(...e.map(i=>i.total_ha),1),s=e.map(i=>{const r=(i.terrestrial_ha/a*100).toFixed(1),o=(i.marine_ha/a*100).toFixed(1);return`
      <div class="bar-row">
  ...
  `,t.querySelectorAll(".bar-track").forEach(i=>{i.style.position="relative"}),t.querySelectorAll(".province-zoom-link").forEach(i=>{i.addEventListener("click",r=>{r.preventDefault(),On(i.dataset.province)})})}function hr(t,e){if(!e||e.length===0){t.innerHTML='<p style="color:var(--text-light);font-size:13px">No data</p>';return}const a=e.map(i=>`
    <tr>
  ...
  `,t.querySelectorAll(".province-zoom-link").forEach(i=>{i.addEventListener("click",r=>{r.preventDefault(),On(i.dataset.province)})})}function On(t){const e=Dn();if(!e)return;const s=V().provincesGeojson;if(!s||!s.features)return;const i=s.features.find(n=>(n.properties.name||n.properties.province||n.properties.NAME||"")===t);if(!i)return;const o=D.geoJSON(i).getBounds();o.isValid()&&e.fitBounds(o,{padding:[40,40],maxZoom:11})}function ve(t){return!t&&t!==0?"-":t>=1e6?(t/1e6).toFixed(1)+"M":t>=1e3?(t/1e3).toFixed(1)+"K":t.toFixed(1)}const Cc=`
...
`;let ur=!1;function Nc(){if(ur)return;ur=!0;const t=document.createElement("style");t.textContent=`
...
`);zn(i,"nbsap-export.csv","text/csv")}function Bc(){const e=V().filters,a=Lt(),s=e.targets.length===0||e.targets.includes("T3"),i={type:"TOR_Reporting_Snapshot",version:"1.0",timestamp:new Date().toISOString(),filters:{...e},includedLayers:[],metrics:{}};s&&(i.metrics=We(a,e));const r=fi(a,e);i.metrics.general=r;for(const n of a){const l=n.metadata;e.targets.length>0&&!l.targets.some(c=>e.targets.includes(c))||e.category&&e.category!=="All"&&l.category!==e.category||i.includedLayers.push({id:l.id,name:l.name,category:l.category,targets:l.targets,realm:l.realm,featureCount:l.featureCount,totalAreaHa:l.totalAreaHa,countsToward30x30:l.countsToward30x30,status:l.status})}const o=JSON.stringify(i,null,2);zn(o,"tor-snapshot.json","application/json")}async function Dc(){const t=Dn(),e=document.getElementById("map");if(!t||!e){Ye("Map not ready. Please wait for layers to load.");return}try{const a=t.getSize(),s=2,i=document.createElement("canvas");i.width=a.x*s,i.height=a.y*s;const r=i.getContext("2d");r.scale(s,s),r.fillStyle="#fff",r.fillRect(0,0,a.x,a.y);const o=e.querySelector(".leaflet-map-pane"),n=Ce(o),l=e.querySelector(".leaflet-tile-pane");if(l){const d=l.querySelectorAll(".leaflet-tile-container");for(const u of d){const f=Ce(u),p=u.querySelectorAll("img.leaflet-tile");for(const m of p)if(!(!m.complete||m.naturalWidth===0))try{const g=Ce(m),v=n.x+f.x+g.x,y=n.y+f.y+g.y;r.drawImage(m,v,y,m.width,m.height)}catch{}}}const c=e.querySelectorAll(".leaflet-overlay-pane canvas");for(const d of c)if(!(d.width===0||d.height===0))try{const u=Ce(e.querySelector(".leaflet-overlay-pane")),f=Ce(d),p=n.x+u.x+f.x,m=n.y+u.y+f.y;r.drawImage(d,p,m)}catch{}const h=e.querySelectorAll(".leaflet-overlay-pane svg");for(const d of h)try{const u=new XMLSerializer().serializeToString(d),f=new Blob([u],{type:"image/svg+xml;charset=utf-8"}),p=URL.createObjectURL(f),m=await Oc(p);URL.revokeObjectURL(p);const g=Ce(e.querySelector(".leaflet-overlay-pane")),v=d.getBoundingClientRect(),y=e.getBoundingClientRect(),b=v.left-y.left,_=v.top-y.top;r.drawImage(m,b,_,v.width,v.height)}catch{}r.fillStyle="rgba(255,255,255,0.8)",r.fillRect(0,a.y-22,a.x,22),r.fillStyle="#555",r.font="11px sans-serif",r.fillText("Vanuatu NBSAP GIS Portal — "+new Date().toLocaleDateString("en-GB"),8,a.y-7),i.toBlob(d=>{if(d){const u=URL.createObjectURL(d),f=document.createElement("a");f.href=u,f.download="nbsap-map.png",f.click(),URL.revokeObjectURL(u)}},"image/png")}catch(a){console.error("Map PNG export failed:",a),Ye("Map PNG export failed. Try using browser Print/Screenshot (Ctrl+Shift+S) instead.")}}function Ce(t){var r;if(!t)return{x:0,y:0};const e=((r=t.style)==null?void 0:r.transform)||window.getComputedStyle(t).transform||"",a=e.match(/translate3d\(\s*(-?[\d.]+)px\s*,\s*(-?[\d.]+)px/);if(a)return{x:parseFloat(a[1]),y:parseFloat(a[2])};const s=e.match(/translate\(\s*(-?[\d.]+)px\s*,\s*(-?[\d.]+)px/);if(s)return{x:parseFloat(s[1]),y:parseFloat(s[2])};const i=e.match(/matrix\([^,]+,[^,]+,[^,]+,[^,]+,\s*(-?[\d.]+)\s*,\s*(-?[\d.]+)/);return i?{x:parseFloat(i[1]),y:parseFloat(i[2])}:{x:0,y:0}}function Oc(t){return new Promise((e,a)=>{const s=new Image;s.onload=()=>e(s),s.onerror=a,s.src=t})}function zn(t,e,a){const s=new Blob([t],{type:a}),i=URL.createObjectURL(s),r=document.createElement("a");r.href=i,r.download=e,document.body.appendChild(r),r.click(),document.body.removeChild(r),URL.revokeObjectURL(i)}const Ne=[{id:"spatial-plans",name:"Biodiversity Spatial Plans",category:"SPATIAL_PLAN",target:"T1",realm:"terrestrial",countsToward30x30:!1,description:"Provincial and municipal physical plans with CCA boundary zones"},{id:"kba-terrestrial",name:"Key Biodiversity Areas",category:"KBA",target:"T1",realm:"terrestrial",countsToward30x30:!1,description:"Sites of global importance for biodiversity (BirdLife / KBA Partnership)"},{id:"mpa-spatial-plan",name:"Marine Protected Areas (Spatial Planning)",category:"MPA",target:"T1",realm:"marine",countsToward30x30:!1,description:"Marine protected areas included in biodiversity spatial planning"},{id:"lmma-spatial-plan",name:"Locally Managed Marine Areas (Spatial Planning)",category:"LMMA",target:"T1",realm:"marine",countsToward30x30:!1,description:"Community-managed marine areas included in biodiversity spatial planning"},{id:"degraded-terrestrial",name:"Degraded Terrestrial Areas",category:"DEGRADED",target:"T2",realm:"terrestrial",countsToward30x30:!1,description:"Mapped degraded terrestrial and inland water ecosystems"},{id:"degraded-marine",name:"Degraded Marine & Coastal Areas",category:"DEGRADED",target:"T2",realm:"marine",countsToward30x30:!1,description:"Mapped degraded marine and coastal ecosystems"},{id:"restoration-sites",name:"Ecosystem Restoration Sites",category:"RESTORATION",target:"T2",realm:"terrestrial",countsToward30x30:!1,description:"Active and planned restoration sites for degraded ecosystems"},{id:"eez-boundary",name:"Exclusive Economic Zone (EEZ)",category:"EEZ",target:"T3",realm:"marine",countsToward30x30:!1,isReference:!0,description:"Vanuatu EEZ boundary — used to derive marine baseline area for 30x30 target"},{id:"admin0-boundary",name:"National Boundary (Admin0 Coastline)",category:"ADMIN_BOUNDARY",target:"T3",realm:"terrestrial",countsToward30x30:!1,isReference:!0,description:"Vanuatu national boundary / coastline — used as terrestrial baseline for 30x30 target"},{id:"cca-terrestrial",name:"Community Conserved Areas",category:"CCA",target:"T3",realm:"terrestrial",countsToward30x30:!0,description:"Community-managed conservation areas (Custom Tabu Areas, Community Conservation Areas)"},{id:"mpa-marine",name:"Marine Protected Areas",category:"MPA",target:"T3",realm:"marine",countsToward30x30:!0,description:"Nationally designated marine protected areas and management zones"},{id:"lmma-marine",name:"Locally Managed Marine Areas",category:"LMMA",target:"T3",realm:"marine",countsToward30x30:!0,description:"LMMAs managed by local communities for marine resource conservation"},{id:"pa-terrestrial",name:"Protected Areas (WDPA)",category:"PA",target:"T3",realm:"terrestrial",countsToward30x30:!0,description:"Protected areas from the World Database on Protected Areas"},{id:"oecm-terrestrial",name:"Other Effective Conservation Measures",category:"OECM",target:"T3",realm:"terrestrial",countsToward30x30:!0,description:"OECMs contributing to in-situ conservation outside protected areas"},{id:"megapode-distribution",name:"Vanuatu Megapode Distribution",category:"MEGAPODE",target:"T4",realm:"terrestrial",countsToward30x30:!1,description:"Distribution range and nesting sites of Megapodius layardi (Vanuatu Megapode) — endemic ground-nesting bird"},{id:"starling-distribution",name:"Vanuatu Mountain Starling Distribution",category:"STARLING",target:"T4",realm:"terrestrial",countsToward30x30:!1,description:"Distribution range of Aplonis santovestris (Vanuatu Mountain Starling) — critically endangered endemic bird"},{id:"fantail-distribution",name:"Vanuatu Streaked Fantail Distribution",category:"FANTAIL",target:"T4",realm:"terrestrial",countsToward30x30:!1,description:"Distribution range of Rhipidura spilodera (Vanuatu Streaked Fantail) — endemic passerine bird"},{id:"kingfisher-distribution",name:"Vanuatu Kingfisher Distribution",category:"KINGFISHER",target:"T4",realm:"terrestrial",countsToward30x30:!1,description:"Distribution range of Todiramphus farquhari (Vanuatu Kingfisher) — endemic kingfisher species"},{id:"flying-fox-distribution",name:"Vanuatu Flying Fox Distribution",category:"FLYING_FOX",target:"T4",realm:"terrestrial",countsToward30x30:!1,description:"Distribution range and roost sites of Pteropus anetianus (Vanuatu Flying Fox) — endemic fruit bat"},{id:"plerandra-distribution",name:"Plerandra vanuatuensis Distribution",category:"PLERANDRA",target:"T4",realm:"terrestrial",countsToward30x30:!1,description:"Distribution range of Plerandra vanuatuensis — endemic plant species of Vanuatu"},{id:"kba-t4",name:"Key Biodiversity Areas",category:"KBA",target:"T4",realm:"terrestrial",countsToward30x30:!1,description:"Key Biodiversity Areas (KBAs) of Vanuatu — sites of global importance for biodiversity (BirdLife / KBA Partnership)"},{id:"merremia-detection",name:"Merremia peltata (Big Leaf)",category:"MERREMIA",target:"T6",realm:"terrestrial",countsToward30x30:!1,description:"Remote sensing and field survey detections of Merremia peltata invasive vine coverage"},{id:"crown-of-thorns",name:"Crown of Thorns Starfish",category:"CROWN_OF_THORNS",target:"T6",realm:"marine",countsToward30x30:!1,description:"Acanthaster planci (Crown-of-Thorns starfish) outbreak locations and affected reef areas"},{id:"mile-a-minute",name:"Mile a Minute Vine",category:"MILE_A_MINUTE",target:"T6",realm:"terrestrial",countsToward30x30:!1,description:"Mikania micrantha (Mile a Minute) invasive vine distribution and coverage areas"},{id:"solanum-torvum",name:"Solanum torvum (Devil Fig)",category:"SOLANUM_TORVUM",target:"T6",realm:"terrestrial",countsToward30x30:!1,description:"Solanum torvum (Devil Fig / Prickly Nightshade) distribution and infestation areas"},{id:"invasive-species",name:"Other Invasive Alien Species",category:"INVASIVE",target:"T6",realm:"terrestrial",countsToward30x30:!1,description:"Fire Ants, African Snail, Sako, Coconut Beetle and other IAS"},{id:"pesticide-areas",name:"Pesticide & Herbicide Use Areas",category:"PESTICIDE",target:"T7",realm:"terrestrial",countsToward30x30:!1,description:"Areas of pesticide and herbicide use in large-scale and small-scale commercial farming"},{id:"eutrophication-zones",name:"Coastal Eutrophication Zones",category:"EUTROPHICATION",target:"T8",realm:"marine",countsToward30x30:!1,description:"Mapped coastal eutrophication and nutrient-impacted zones"},{id:"land-cover",name:"Land Cover / Land Use Change",category:"LAND_COVER",target:"T10",realm:"terrestrial",countsToward30x30:!1,description:"Land cover change mapping for agriculture, livestock, fisheries and forestry"},{id:"green-spaces",name:"Blue & Green Spaces",category:"GREEN_SPACE",target:"T12",realm:"terrestrial",countsToward30x30:!1,description:"Parks within provincial and municipal areas, and botanical gardens"}],jn="print-map-overlay";function wa(t,e,a){var s,i,r,o;if(e==="T3")return We(t,a);if(e==="T1"){const n=ys(t,a);return{...n,totalAreaHa:n.terrestrial_ha+n.marine_ha,grossAreaHa:n.gross_terrestrial_ha+n.gross_marine_ha,realmTotals:{terrestrial_ha:n.terrestrial_ha,marine_ha:n.marine_ha,gross_terrestrial_ha:n.gross_terrestrial_ha,gross_marine_ha:n.gross_marine_ha},typeBreakdown:[]}}if(e==="T2"){const n=pi(t,a),l=(((s=n.realmTotals)==null?void 0:s.degraded_terrestrial_ha)||0)+(((i=n.realmTotals)==null?void 0:i.restoration_terrestrial_ha)||0),c=(((r=n.realmTotals)==null?void 0:r.degraded_marine_ha)||0)+(((o=n.realmTotals)==null?void 0:o.restoration_marine_ha)||0);return{...n,totalAreaHa:n.degraded_ha+n.restoration_ha,grossAreaHa:n.gross_degraded_ha+n.gross_restoration_ha,realmTotals:{terrestrial_ha:l,marine_ha:c,gross_terrestrial_ha:l,gross_marine_ha:c},typeBreakdown:[]}}return le(t,e,a)}const Ca='<svg width="48" height="36" viewBox="0 0 640 480" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="border:0.5px solid #ccc;border-radius:2px;flex-shrink:0"><defs><clipPath id="vu-a"><path d="M0 0v475l420-195h480v-85H420Z"/></clipPath></defs><path fill="#009543" d="M0 0h640v480H0z"/><path fill="#d21034" d="M0 0h640v240H0z"/><g clip-path="url(#vu-a)" transform="scale(.71111 1.01053)"><path stroke="#fdce12" stroke-width="110" d="m0 0 420 195h480v85H420L0 475"/><path fill="none" stroke="#000" stroke-width="60" d="m0 0 420 195h480m0 85H420L0 475"/></g><g fill="#fdce12" transform="translate(-22)scale(1.01053)"><path d="M106.9 283v27c23.5 0 69.7-18 69.7-76.1s-49.3-68.9-64-68.9-60.3 10.6-60.3 58c0 47.6 44.7 52 53.5 52s41.8-8 38-43.6a35.5 35.5 0 0 1-35.4 31.5c-24 0-39-17.8-39-35.4s14.6-41.2 39.9-41.2 43.8 22.5 43.8 45.1-17.8 51.5-46.2 51.5z"/><g id="vu-b"><path stroke="#fdce12" stroke-width=".8" d="m86.2 247.7 1.4 1s11.2-25.5 41.1-43.6c-3.8 2-23.8 12-42.5 42.6z"/><path d="M89.1 243.3s-3.4-7-.4-10.2 1.7 8.3 1.7 8.3l1.3-1.9s-2-8.6.2-10.4 1.2 8.3 1.2 8.3l1.4-1.8s-1.5-8.4.7-10 .9 8 .9 8l1.6-2s-1.2-8 1.5-9.9.3 7.6.3 7.6l1.8-2s-.8-7.3 1.5-9c2.3-1.6.4 7 .4 7l1.6-1.8s-.5-6.8 1.7-8.4.2 6.5.2 6.5l1.7-1.6s-.4-6.9 2.4-8.2-.5 6.4-.5 6.4l2-1.6s.5-8 2.9-8.7c2.4-.8-1 7-1 7l1.7-1.4s.9-6.8 3.5-7.6c2.7-.9-1.6 6.2-1.6 6.2l1.7-1.3s1.9-6.8 4.4-7.6c2.4-.7-2.6 6.5-2.6 6.5l1.7-1.2s2.7-6.2 5-6.6c2.1-.4-2.6 5.1-2.6 5.1l2.1-1.2s3.5-6.4 4.8-4.5-5 4.9-5 4.9l-2 1.2s7.5-3.6 8.4-1.8-10.3 3-10.3 3l-1.8 1.2s7.5-2 6.6-.1-8.4 1.5-8.4 1.5l-1.7 1.2s7.5-1.8 6.5 0c-1 1.6-8.3 1.5-8.3 1.5l-1.8 1.5s7.3-2 6.2.3-9.4 2.1-9.4 2.1l-2 2s7.7-2.7 7-.6c-.6 2-9.4 3-9.4 3l-2 2s8.3-2.7 5.8-.2c-2.4 2.6-8.5 3.2-8.5 3.2l-2.3 3s8.2-5 7-2.2-9.2 4.7-9.2 4.7l-1.6 2s7.4-4.3 6.6-2c-.7 2.5-8.6 5-8.6 5l-1.3 1.8s8.7-5.2 8-2.5c-.8 2.6-9.1 4.5-9.1 4.5l-1 1.7s8-4.7 8-2.4c.2 2.2-9.4 4.4-9.4 4.4z"/></g><use xlink:href="#vu-b" width="100%" height="100%" transform="matrix(-1 0 0 1 220 0)"/></g></svg>';function Ta(t){return Lt().filter(a=>{var s,i;return(i=(s=a.metadata)==null?void 0:s.targets)==null?void 0:i.includes(t)})}function bs(t){return jt.targets.find(e=>e.code===t)}function Ci(t){return Ne.filter(e=>e.target===t)}function Vt(t){return!t&&t!==0?"0":t>=1e6?(t/1e6).toFixed(2)+"M":t>=1e3?(t/1e3).toFixed(1)+"K":t.toFixed(1)}function z(t){return!t&&t!==0?"0.00":t.toLocaleString("en",{minimumFractionDigits:2,maximumFractionDigits:2})}function ot(t){return!t&&t!==0?"0.0%":t.toFixed(1)+"%"}function Ti(t,e){let s=Zl(t).map(i=>{var o;const r=i.label||((o=Y[i.key])==null?void 0:o.label)||i.key;return`<div class="print-legend-item">
  ...
  `;let b=`<div class="print-legend-item">
    ...
    `}const w=s.scientific?`<i>${s.scientific}</i>`:"",k=s.taxa?` (${s.taxa})`:"";return m.innerHTML=`
    ...
    <div class="print-target-bar">
      ...
      <div class="print-target-info">
        <div class="print-target-name">${s.name}${k}</div>
  ...
  `,t.appendChild(m),g}function Hc(t,e,a){if(!document.getElementById(t))return;const i=D.map(t,{center:lt.mapCenter,zoom:lt.mapZoom,zoomControl:!1,attributionControl:!1,dragging:!1,scrollWheelZoom:!1,doubleClickZoom:!1,touchZoom:!1,preferCanvas:!0});D.tileLayer("https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}{r}.png",{maxZoom:19}).addTo(i),D.control.scale({imperial:!1,position:"bottomleft",maxWidth:150}).addTo(i),a&&D.geoJSON(a,{style:()=>({color:"#777",weight:1.2,fillOpacity:.02,dashArray:"4 4"}),onEachFeature:(y,b)=>{const _=y.properties.name||y.properties.province||"";_&&b.bindTooltip(_,{permanent:!0,direction:"center",className:"print-province-label"})}}).addTo(i);const r=D.featureGroup(),o=e.features,n=o.filter(y=>!ua(y)),l=o.filter(y=>ua(y)),c=e.key,h=Sn(c),d=Yl(),u=En(c),f=Jl(),p=l.filter(y=>{var _;const b=(_=y.geometry)==null?void 0:_.type;return b==="Polygon"||b==="MultiPolygon"}),m=l.filter(y=>{var _;const b=(_=y.geometry)==null?void 0:_.type;return b==="Point"||b==="MultiPoint"});if(p.length>0){const y=dt(p);y?r.addLayer(D.geoJSON(y,{style:()=>d})):r.addLayer(D.geoJSON({type:"FeatureCollection",features:p},{style:()=>d}))}m.length>0&&r.addLayer(D.geoJSON({type:"FeatureCollection",features:m},{pointToLayer:(y,b)=>D.circleMarker(b,f)}));const g=n.filter(y=>{var _;const b=(_=y.geometry)==null?void 0:_.type;return b==="Polygon"||b==="MultiPolygon"}),v=n.filter(y=>{var _;const b=(_=y.geometry)==null?void 0:_.type;return b==="Point"||b==="MultiPoint"});if(g.length>0){const y=dt(g);y?r.addLayer(D.geoJSON(y,{style:()=>h})):r.addLayer(D.geoJSON({type:"FeatureCollection",features:g},{style:()=>h}))}v.length>0&&r.addLayer(D.geoJSON({type:"FeatureCollection",features:v},{pointToLayer:(y,b)=>D.circleMarker(b,u)})),r.addTo(i),setTimeout(()=>{if(i.invalidateSize(),r.getLayers().length>0){const y=r.getBounds();y.isValid()&&i.fitBounds(y,{padding:[40,40],maxZoom:12})}},200)}function Uc(t,e,a){var u,f,p,m;const s={},i={};for(const g of a)s[g]=[],i[g]=new Map;const r=new Set(a);for(const g of e){if((u=g.metadata)!=null&&u.isReference)continue;const v=g.id||((f=g.metadata)==null?void 0:f.name)||"unknown";for(const y of((p=g.geojson)==null?void 0:p.features)||[]){const b=(m=y.properties)==null?void 0:m.province;if(b&&r.has(b)){s[b].push(y);let _=i[b].get(v);_||(_=[],i[b].set(v,_)),_.push(y)}}}const o=Ti(e,!0),n=Lt(),c=wa(n,t,{targets:[t],province:"All",category:"All",realm:"All",year:"All"}),h={};for(const g of a){const v={targets:[t],province:g,category:"All",realm:"All",year:"All"};h[g]=wa(n,t,v)}const d=Ci(t);return{provinceFeatures:s,provinceFeaturesPerLayer:i,legendHtml:o,nationalMetrics:c,provinceMetrics:h,expected:d,layers:e}}async function Vc(){ce();const t=jt.targets.map(n=>n.code);await Qe(t),Kt();const e=xs(t);document.body.appendChild(e),document.body.classList.add("print-mode");const a=e.querySelector("#print-pages"),s=V(),i=[];for(const n of t){const l=bs(n);if(!l)continue;const c=Hn(a,n,l,!0);i.push({mapId:c,code:n,layers:Ta(n)})}let r=0;function o(){if(r>=i.length)return;const{mapId:n,code:l,layers:c}=i[r];r++,_s(n,l,c,s.provincesGeojson),setTimeout(()=>requestAnimationFrame(o),600)}requestAnimationFrame(o),e.querySelector("#print-close-btn").addEventListener("click",ce),e.querySelector("#print-print-btn").addEventListener("click",()=>window.print())}function ce(){const t=document.getElementById(jn);t&&t.remove(),document.body.classList.remove("print-mode")}function xs(t,e){const a=document.createElement("div");a.id=jn,a.className="print-overlay";const s=e?`Print Maps: ${e}`:t.length===1?`Print Map: ${t[0]}`:`Print All Target Maps (${t.length})`;return a.innerHTML=`
  ...
  `,C=(c==null?void 0:c.provinceBreakdown)||[];let M="";if(C.length>0){const K=C.map(it=>{const vt=it.province||"Unknown",Nt=it.terrestrial_ha??0,Ht=it.marine_ha??0,Ut=it.total_ha??0,J=it.features??0;return`<tr><td>${vt}</td><td class="r">${z(Nt)}</td><td class="r">${z(Ht)}</td><td class="r"><b>${z(Ut)}</b></td><td class="r">${J}</td></tr>`}).join(""),W=C.reduce((it,vt)=>it+(vt.terrestrial_ha||0),0),at=C.reduce((it,vt)=>it+(vt.marine_ha||0),0),Pt=C.reduce((it,vt)=>it+(vt.total_ha||0),0),bt=C.reduce((it,vt)=>it+(vt.features||0),0);M=`
      <div class="print-detail-table">
        ...
        <table>
          ...
          <tbody>${K}</tbody>
          <tfoot><tr class="total-row"><td><b>TOTAL</b></td><td class="r"><b>${z(W)}</b></td><td class="r"><b>${z(at)}</b></td><td class="r"><b>${z(Pt)}</b></td><td class="r"><b>${bt}</b></td></tr></tfoot>
        </table>
      </div>
    `}const E=(c==null?void 0:c.categoryBreakdown)||[];let S="";E.length>0&&(S=`
      <div class="print-detail-table">
        ...
        <table>
          ...
          <tbody>${E.map(W=>{const at=mt(W.category),Pt=Y[W.category]||{label:W.category};return`<tr><td><span class="cat-dot" style="background:${at.fill};border-color:${at.stroke}"></span>${Pt.label}</td><td class="r">${z(W.area_ha)}</td><td class="r">${W.features}</td></tr>`}).join("")}</tbody>
        </table>
      </div>
    `);const A=o.map(K=>{var Ht,Ut,J,rt;const W=K.metadata||{},at=W.name||K.id,Pt=((Ht=Y[W.category])==null?void 0:Ht.label)||W.category||"-",bt=W.realm||"terrestrial",it=((J=(Ut=K.geojson)==null?void 0:Ut.features)==null?void 0:J.length)||0;(((rt=K.geojson)==null?void 0:rt.features)||[]).reduce((fe,It)=>{var $t;return fe+((($t=It.properties)==null?void 0:$t.area_ha)||0)},0);const vt=W.uploadTimestamp?new Date(W.uploadTimestamp).toLocaleDateString("en-GB"):"-",Nt=W.isReference?'<span class="ref-badge">REF</span>':"";return`<tr><td>${at} ${Nt}</td><td>${Pt}</td><td>${bt}</td><td class="r">${it}</td><td>${vt}</td></tr>`}).join("");o.length>0&&`${A}`;const $=`Total area: ${z(y)} ha | ${h} records across ${o.filter(K=>{var W;return!((W=K.metadata)!=null&&W.isReference)}).length} dataset${o.filter(K=>{var W;return!((W=K.metadata)!=null&&W.isReference)}).length!==1?"s":""}`;x.innerHTML=`
    <div class="print-title-block">
      <div class="print-title-left">
        <div class="print-title-brand">
          ${Ca}
  ...
  `,w=(h==null?void 0:h.categoryBreakdown)||[];let k="";w.length>0&&(k=`
      <div class="print-detail-table">
        <div class="print-section-title">Category Breakdown</div>
        <table>
          <thead><tr><th>Category</th><th class="r">Area (ha)</th><th class="r">Records</th></tr></thead>
    ...
    `),o.filter(N=>{var I;return!((I=N.metadata)!=null&&I.isReference)}).map(N=>{var W,at,Pt,bt;const I=N.metadata||{},O=I.name||N.id,F=((W=Y[I.category])==null?void 0:W.label)||I.category||"-",H=N.id||I.name||"unknown",st=((Pt=(at=i==null?void 0:i.provinceFeaturesPerLayer)==null?void 0:at[s])==null?void 0:Pt.get(H))||(((bt=N.geojson)==null?void 0:bt.features)||[]).filter(it=>it.properties.province===s),K=st.reduce((it,vt)=>{var Nt;return it+(((Nt=vt.properties)==null?void 0:Nt.area_ha)||0)},0);return st.length===0?"":`<tr><td>${O}</td><td>${F}</td><td class="r">${st.length}</td><td class="r">${z(K)}</td></tr>`}).filter(Boolean).join("");const P=m>0?((1-p/m)*100).toFixed(1):"0.0",C=`Net area: ${z(p)} ha | Gross area: ${z(m)} ha | Overlap removed: ${P}%`;y.innerHTML=`
    <div class="print-title-block">
      <div class="print-title-left">
        <div class="print-title-brand">
          ${Ca}
...
<div class="sidebar-section-title" style="margin-top:4px">Last Updated</div>
        ...
        <div class="export-toolbar">
          <button class="btn btn-sm btn-outline" id="btn-export-csv" title="${At()?"Export filtered data as CSV":"Request data access"}" style="position:relative">
  ...
  `,setTimeout(()=>{_c("map"),ws()},50),document.getElementById("btn-export-csv").addEventListener("click",()=>{At()?Rc():Ye(`CSV data download is restricted.

To request data access, please email:
${rd.join(`
`)}`,{title:"Access Restricted"})}),document.getElementById("btn-export-json").addEventListener("click",Bc),document.getElementById("btn-export-png").addEventListener("click",Dc),document.getElementById("btn-print-all").addEventListener("click",Vc),document.getElementById("btn-print-target").addEventListener("click",()=>{const e=V();e.filters.targets.length===1&&qn(e.filters.targets[0])}),document.getElementById("btn-print-province").addEventListener("click",()=>{const e=V();e.filters.targets.length===1&&Fc(e.filters.targets[0])}),document.getElementById("btn-print-species").addEventListener("click",()=>{const e=V();e.filters.targets.length===1&&e.filters.targets[0]==="T4"&&jc("T4")})}function ws(){Li=!1;const t=V(),e=document.getElementById("exec-summary-container");e&&ad(e);const a=document.getElementById("last-updated-text");if(a){const g=new Date,v=g.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),y=g.toLocaleDateString([],{day:"numeric",month:"short"});a.textContent=`${y}, ${v}`;const b=a.closest(".last-updated-badge");b&&b.classList.add("synced")}const s=document.getElementById("filter-panel-container");s&&jl(s);const i=document.getElementById("kpi-container");i&&(i.style.opacity="0",i.style.pointerEvents="none",setTimeout(()=>{i.innerHTML=`
        <div class="kpi-computing">
          <div class="loading-spinner" style="width:20px;height:20px;border-width:2px"></div>
          <span>Recalculating&hellip;</span>
        </div>`,i.style.opacity="1",requestAnimationFrame(()=>{setTimeout(()=>{Xl(i),nc(i),i.style.pointerEvents=""},0)})},120)),_a();const r=t.filters,o=r.targets,n=Lt(),l=document.getElementById("target-header-container"),c=document.getElementById("btn-print-target"),h=document.getElementById("btn-print-province"),d=document.getElementById("btn-print-species");if(l)if(o.length===1){const g=o[0],v=nd[g]||{title:g,desc:""};l.innerHTML=`
      ...
      `,document.getElementById("btn-print-header").addEventListener("click",()=>qn(g)),c&&(c.disabled=!1,c.title=`Print map for ${g}`),h&&(h.disabled=!1,h.title=`Print ${g} maps by province`),d&&(g==="T4"?(d.style.display="",d.disabled=!1,d.title="Print species distribution maps"):(d.style.display="none",d.disabled=!0))}else l.innerHTML="",c&&(c.disabled=!0,c.title="Select a single target first"),h&&(h.disabled=!0,h.title="Select a single target first"),d&&(d.style.display="none",d.disabled=!0);const u=document.getElementById("province-table-container"),f=document.getElementById("province-chart-container"),p=document.getElementById("category-breakdown-container");if(o.length===1){const g=o[0],v=g==="T3"?We(n,r):g==="T1"?ys(n,r):le(n,g,r);u&&hr(u,v.provinceBreakdown),f&&dr(f,v.provinceBreakdown),p&&ld(p,v)}else{if(o.length===0||o.includes("T3")){const v=We(n,r);u&&hr(u,v.provinceBreakdown),f&&dr(f,v.provinceBreakdown)}else u&&(u.innerHTML='<p style="color:var(--text-tertiary);font-size:13px;padding:12px 0">Select a target to see provincial breakdown</p>'),f&&(f.innerHTML="");p&&cd(p)}const m=document.getElementById("context-panel-container");m&&dd(m)}function ld(t,e){if(!e.categoryBreakdown||e.categoryBreakdown.length===0){t.innerHTML="";return}const a=e.categoryBreakdown.map(s=>{const i=Y[s.category]||{label:s.category,color:"#95a5a6"};return`
      <tr>
        <td>
  ...
  `}function dd(t){!t||t.dataset.rendered||(t.dataset.rendered="1",t.innerHTML=`
  ...
  `,document.body.appendChild(t),Se=t,t.querySelector("#fe-close").addEventListener("click",qe),t.addEventListener("click",e=>{e.target===t&&qe()})}function qe(){Se==null||Se.classList.remove("active")}function Wn(t,{onSave:e,onDelete:a}={}){var s;Vn(),document.getElementById("fe-title").textContent="Edit Feature",Kn(t.properties||{},((s=t.geometry)==null?void 0:s.type)||"Unknown",!1,e,a),Se.classList.add("active")}function mr(t,{onSave:e}={}){Vn(),document.getElementById("fe-title").textContent="Add New Feature",Kn({},t,!0,e,null),Se.classList.add("active")}function Kn(t,e,a,s,i){const r=document.getElementById("fe-body"),o=Object.entries(t).filter(([l])=>!md.has(l)&&!gr.has(l));let n='<div style="padding:16px">';n+=`<div style="font-size:12px;color:var(--text-secondary);margin-bottom:14px;padding:5px 10px;background:var(--gray-50,#f8f9fa);border-radius:4px;display:inline-flex;align-items:center;gap:6px">
  ...
  </div>`,n+='<form id="fe-form">',n+='<div style="font-weight:700;font-size:11px;color:var(--text-secondary);text-transform:uppercase;letter-spacing:.6px;margin-bottom:10px">NBSAP Standard Fields</div>';for(const l of fr){const c=t[l.key]??"",h=l.required?' <span style="color:var(--danger)">*</span>':"";n+=`<div style="margin-bottom:10px">
  ...
  </div></form></div>`,r.innerHTML=n,document.getElementById("fe-cancel").addEventListener("click",qe),!a&&i&&document.getElementById("fe-delete").addEventListener("click",async()=>{await Je("Delete this feature? This cannot be undone.",{title:"Delete Feature",okLabel:"Delete",danger:!0})&&(qe(),i())}),document.getElementById("fe-form").addEventListener("submit",l=>{l.preventDefault();const c=l.target,h={};for(const d of fr){const u=c.elements[d.key];if(!u)continue;const f=u.value.trim();h[d.key]=d.type==="number"&&f!==""?Number(f):f||null}h.targets=t.targets??[];for(const d of gr)t[d]!=null&&(h[d]=t[d]);for(const[d]of o){const u=c.elements[`__custom__${d}`];u&&(h[d]=u.value)}qe(),s==null||s(h)})}function vr(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function za(t){return String(t).replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;")}let Hs="",Us="All",Vs="All",Ws="All",He=null;function vd(){const t=document.getElementById("page-portal");t.innerHTML=`
    <div class="portal-layout">
      <div class="portal-main">
        <div class="portal-toolbar">
          ...
          ${At()?`<button class="btn btn-sm btn-outline" id="btn-metadata-report" title="Download metadata report for all datasets" style="margin-left:auto;white-space:nowrap">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
            Metadata Report
          </button>`:""}
        </div>
    ...
    <div class="modal-overlay" id="preview-modal">
      <div class="modal" style="max-width:900px;width:95vw;height:90vh;max-height:90vh;display:flex;flex-direction:column;overflow:hidden">
        ...
        ${At()?`<div id="preview-draw-toolbar" style="display:none;gap:6px;padding:6px 16px;border-bottom:1px solid var(--border);background:var(--gray-50,#f8f9fa);flex-shrink:0;align-items:center;flex-wrap:wrap">
  ...
  `;const e=document.getElementById("portal-filter-target"),a=jt.targets||[];for(const i of a){const r=document.createElement("option");r.value=i.code,r.textContent=i.code,e.appendChild(r)}document.getElementById("portal-search").addEventListener("input",i=>{Hs=i.target.value.toLowerCase(),Ct()}),document.getElementById("portal-filter-target").addEventListener("change",i=>{Us=i.target.value,Ct()}),document.getElementById("portal-filter-category").addEventListener("change",i=>{Vs=i.target.value,Ct()}),document.getElementById("portal-filter-status").addEventListener("change",i=>{Ws=i.target.value,Ct()});const s=document.getElementById("btn-metadata-report");s&&s.addEventListener("click",Zn),document.getElementById("meta-editor-close").addEventListener("click",rs),document.getElementById("metadata-editor-modal").addEventListener("click",i=>{i.target===i.currentTarget&&rs()}),document.getElementById("preview-modal-close").addEventListener("click",xr),document.getElementById("preview-modal").addEventListener("click",i=>{i.target===i.currentTarget&&xr()}),document.getElementById("preview-tab-map").addEventListener("click",()=>Ks("map")),document.getElementById("preview-tab-table").addEventListener("click",()=>Ks("table")),document.getElementById("portal-table-container").addEventListener("click",i=>{const r=i.target.closest("button");if(r){const n=r.dataset.id;r.classList.contains("action-preview")?_d(n):r.classList.contains("action-view")?(He=n,is(n),Ct()):r.classList.contains("action-rename")?Yn(n):r.classList.contains("action-download")?wd(n):r.classList.contains("action-remove")&&Md(n);return}const o=i.target.closest("tr[data-layer-id]");o&&(He=o.dataset.layerId,is(He),Ct())}),Ct()}function yd(t){const e=Ms(t);return e.complete?'<span class="badge badge-success" title="All required metadata filled" style="font-size:10px">META OK</span>':`<span class="badge" style="font-size:10px;background:#fff3cd;color:#856404;border:1px solid #ffc107" title="Missing: ${e.missing.join(", ")}">${e.pct}%</span>`}function bd(t){const e=Ms(t),a=e.pct||0,s=a===100?"complete":a>=60?"partial":"poor";return`
    ...
    </div>`}function xd(t){if(!t)return'<span class="freshness-badge unknown">Unknown</span>';const e=Math.floor((Date.now()-new Date(t).getTime())/864e5);return e<=30?`<span class="freshness-badge fresh" title="${e}d ago">Fresh</span>`:e<=180?`<span class="freshness-badge recent" title="${e}d ago">${Math.floor(e/30)}mo</span>`:`<span class="freshness-badge stale" title="${e}d ago">${Math.floor(e/30)}mo old</span>`}function yr(t){var n;const e=t.metadata,a=Y[e.category]||{},s=e.isReference===!0,i=At();let r;if(s){const l=lt.nationalBaselines,c=e.realm==="marine"?l.marine_ha:l.terrestrial_ha;r=`<span style="font-weight:600">${(c>0?(e.totalAreaHa||0)/c*100:0).toFixed(1)}%</span>`}else r=`${e.featureCount}`;const o=i;return`
    <tr data-layer-id="${t.id}" class="${He===t.id?"selected":""}" style="cursor:pointer">
      <td>
      ...
      <td><span style="font-size:12px;color:var(--text-secondary);display:inline-flex;align-items:center;gap:4px"><span style="color:${a.color||"#78909C"}">${ta(e.category,14)}</span>${((n=Y[e.category])==null?void 0:n.label)||e.category}</span></td>
      <td style="text-transform:capitalize">${e.realm}</td>
      <td>${r}</td>
      <td><span class="badge badge-${e.status.toLowerCase()}">${e.status}</span></td>
      <td>${bd(e)}</td>
      <td style="font-size:12px;color:var(--text-secondary)">${xd(e.uploadTimestamp)}</td>
      <td class="actions">
  ...
  `}function Ct(){var c;const t=V(),e=document.getElementById("portal-table-container");if(!e)return;let a=t.layers||[];if(a=a.filter(h=>{const d=h.metadata;return!(Hs&&!`${d.name} ${d.category} ${(d.targets||[]).join(" ")} ${d.originalFilename}`.toLowerCase().includes(Hs)||Us!=="All"&&!(d.targets||[]).includes(Us)||Vs!=="All"&&d.category!==Vs||Ws!=="All"&&d.status!==Ws)}),a.length===0){e.innerHTML=`
      <div class="empty-state">
        ...
        <div class="empty-state-text">${At()?"Go to the Admin tab to upload shapefiles":"No data available yet"}</div>
      </div>
    ...
    <thead>
      ...
      <div class="portal-target-group">
        <div class="portal-group-header" style="display:flex;align-items:center;gap:10px;padding:10px 14px;background:${h.color||"#0072BC"}0A;border:1px solid ${h.color||"#0072BC"}30;border-radius:8px 8px 0 0;margin-top:16px">
          <span class="badge" style="font-size:13px;font-weight:700;padding:3px 10px;background:${h.color||"#0072BC"};color:#fff;border-radius:20px;display:inline-flex;align-items:center;gap:4px">${_i(h.code,14)} ${h.code}</span>
    ...
    `),e.innerHTML=n;const l=e.querySelector("#btn-download-metadata-report");l&&l.addEventListener("click",Zn)}function is(t){var c;const e=V(),a=document.getElementById("portal-sidebar"),s=e.layers.find(h=>h.id===t);if(!s){a.style.display="none",a.innerHTML="";return}a.style.display="";const i=s.metadata,r=Un(i,s.geojson),o=Y[i.category]||{},n=Ms(i),l=At();if(a.innerHTML=`
    ...
    <div class="card" style="margin-bottom:14px">
      ...
      <div class="card-body">
        <table class="metadata-table">
          ...
          <tr><td>Category</td><td><span style="display:inline-flex;align-items:center;gap:4px"><span style="color:${o.color||"#78909C"}">${ta(i.category,14)}</span>${((c=Y[i.category])==null?void 0:c.label)||i.category}</span></td></tr>
          <tr><td>Targets</td><td>${i.targets.map(h=>{const d=(jt.targets||[]).find(u=>u.code===h);return`<span class="badge" style="margin-right:3px;background:${(d==null?void 0:d.color)||"#0072BC"}20;color:${(d==null?void 0:d.color)||"#0072BC"};border:1px solid ${(d==null?void 0:d.color)||"#0072BC"}40;display:inline-flex;align-items:center;gap:3px">${_i(h,12)} ${h}</span>`}).join("")}</td></tr>
    ...
    `:""}
  `,a.querySelector("#btn-close-sidebar").addEventListener("click",()=>{He=null,a.style.display="none",a.innerHTML="",Ct()}),l){const h=a.querySelector("#btn-edit-metadata");h&&h.addEventListener("click",()=>br(t));const d=a.querySelector("#btn-rename-layer");d&&d.addEventListener("click",()=>Yn(t));const u=a.querySelector("#btn-fill-metadata");u&&u.addEventListener("click",()=>br(t))}}async function Yn(t){const a=V().layers.find(r=>r.id===t);if(!a)return;const s=await Ic("Enter new layer name:",a.metadata.name,{title:"Rename Layer"});if(!s||s.trim()===""||s===a.metadata.name)return;const i={...a.metadata,name:s.trim(),dateUpdated:new Date().toISOString().split("T")[0]};hn(t,i),await on(t,i),is(t),Ct()}function br(t){const a=V().layers.find(o=>o.id===t);if(!a)return;const s=a.metadata,i=document.getElementById("meta-editor-body");let r='<form id="meta-editor-form" style="padding:16px">';for(const o of Ze){const n=s[o.key]||"",l=o.required?'<span style="color:var(--danger);font-weight:700">*</span>':"";r+=`<div class="form-group" style="margin-bottom:12px">
  ...
  </div></form>`,i.innerHTML=r,document.getElementById("metadata-editor-modal").classList.add("active"),i.querySelector("#meta-editor-cancel").addEventListener("click",rs),i.querySelector("#meta-editor-form").addEventListener("submit",async o=>{o.preventDefault();const n=o.target,l={};for(const h of Ze){const d=n.elements[h.key];d&&(l[h.key]=d.value.trim())}l.dateUpdated=new Date().toISOString().split("T")[0];const c={...s,...l};hn(t,c),await on(t,c),rs(),is(t),Ct()})}function rs(){document.getElementById("metadata-editor-modal").classList.remove("active")}function Jn(t){return String(t).replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;")}function Zn(){const e=V().layers||[];if(e.length===0){Ye("No datasets to export.");return}const a=Ze.map(l=>l.label);a.push("Targets","Realm","Feature Count","Total Area (ha)","Status","Upload Date","Completeness %");const s=[a];for(const l of e){const c=l.metadata,h=Ms(c),d=Ze.map(u=>{const f=c[u.key];return f!=null&&String(f).trim()!==""?String(f):"(empty)"});d.push((c.targets||[]).length>0?c.targets.join("; "):"(empty)",c.realm||"(empty)",String(c.featureCount||0),(c.totalAreaHa||0).toFixed(2),c.status||"(empty)",c.uploadTimestamp?new Date(c.uploadTimestamp).toLocaleDateString():"(empty)",String(h.pct)),s.push(d)}const i=s.map(l=>l.map(c=>`"${String(c).replace(/"/g,'""')}"`).join(",")).join(`
`),r=new Blob([i],{type:"text/csv"}),o=URL.createObjectURL(r),n=document.createElement("a");n.href=o,n.download=`metadata-report-${new Date().toISOString().slice(0,10)}.csv`,n.click(),URL.revokeObjectURL(o)}let X=null,Bt=null,Rt=[],_e=null,Ee=!1;async function _d(t){const e=V();let a=e.layers.find(h=>h.id===t);if(!a)return;Bt=t;const s=document.getElementById("preview-modal"),i=document.getElementById("preview-loading"),r=document.getElementById("preview-map-panel"),o=document.getElementById("preview-table-panel"),n=document.getElementById("preview-no-data");if(document.getElementById("preview-modal-title").textContent=a.metadata.name,document.getElementById("preview-feature-count").textContent="",i.style.display="block",r.style.display="none",o.style.display="none",n.style.display="none",Ks("map"),s.classList.add("active"),!a.geojson)try{const h=await hi(t);if(h&&h.geojson){const d=e.layers.findIndex(u=>u.id===t);d>=0&&(e.layers[d]={...e.layers[d],geojson:h.geojson},a=e.layers[d])}}catch(h){console.error("Preview: failed to load GeoJSON",h)}if(i.style.display="none",!a.geojson||!(a.geojson.features||[]).length){n.style.display="block";return}const l=(a.geojson.features||[]).length;document.getElementById("preview-feature-count").textContent=`${l.toLocaleString()} feature${l!==1?"s":""}`,r.style.display="flex",Xn(a),Qn(a);const c=document.getElementById("preview-draw-toolbar");c&&(c.style.display="flex",eo())}function xr(){fa(),qe(),document.getElementById("preview-modal").classList.remove("active"),X&&(X.remove(),X=null),Bt=null}function Ks(t){const e=document.getElementById("preview-map-panel"),a=document.getElementById("preview-table-panel"),s=document.getElementById("preview-tab-map"),i=document.getElementById("preview-tab-table");t==="map"?(e.style.display="flex",a.style.display="none",s.className="btn btn-sm btn-primary",i.className="btn btn-sm btn-outline",X&&setTimeout(()=>X.invalidateSize(),50)):(e.style.display="none",a.style.display="block",s.className="btn btn-sm btn-outline",i.className="btn btn-sm btn-primary")}function Xn(t){const e=document.getElementById("preview-map"),s=(Y[t.metadata.category]||{}).color||"#006B3F";X&&(X.remove(),X=null),X=D.map(e,{zoomControl:!0}),D.tileLayer("https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}{r}.png",{attribution:"&copy; OpenStreetMap contributors &copy; CARTO",subdomains:"abcd",maxZoom:19}).addTo(X);const i=D.geoJSON(t.geojson,{style:()=>({color:s,weight:1.5,opacity:.9,fillColor:s,fillOpacity:.25}),pointToLayer:(r,o)=>D.circleMarker(o,{radius:6,fillColor:s,color:"#fff",weight:1,opacity:1,fillOpacity:.8}),onEachFeature:(r,o)=>{if(r.properties)if(At())o.on("click",n=>{if(Ee)return;D.DomEvent.stopPropagation(n);const l=V().layers.find(h=>h.id===Bt);if(!(l!=null&&l.geojson))return;const c=l.geojson.features.indexOf(r);c<0||Wn(r,{onSave:h=>to(c,h),onDelete:()=>Ys(c)})}),o.on("mouseover",()=>{var n;Ee||(n=o.setStyle)==null||n.call(o,{weight:3,fillOpacity:.5})}),o.on("mouseout",()=>{var n;Ee||(n=o.setStyle)==null||n.call(o,{weight:1.5,fillOpacity:.25})});else{const n=Object.entries(r.properties).filter(([,l])=>l!=null&&String(l).trim()!=="").map(([l,c])=>`<tr><td style="font-weight:600;padding:2px 8px 2px 0;white-space:nowrap">${l}</td><td style="padding:2px 0">${c}</td></tr>`).join("");n&&o.bindPopup(`<table style="font-size:12px;border-collapse:collapse">${n}</table>`,{maxWidth:280})}}}).addTo(X);try{X.fitBounds(i.getBounds(),{padding:[20,20]})}catch{X.setView([-15.3767,166.9592],7)}}function Qn(t){const e=document.getElementById("preview-table-body"),a=t.geojson.features||[],s=200,i=new Set,r=a.slice(0,s);for(const u of r)u.properties&&Object.keys(u.properties).forEach(f=>i.add(f));const o=[...i];if(o.length===0){e.innerHTML='<div style="padding:24px;color:var(--text-secondary);text-align:center">No attribute data found.</div>';return}const n=At(),l=n?'<th style="padding:6px 10px;background:var(--gray-50,#f8f9fa);font-weight:600;font-size:12px;border-bottom:2px solid var(--border);white-space:nowrap">Actions</th>':"",c=o.map(u=>`<th style="white-space:nowrap;padding:6px 10px;background:var(--gray-50,#f8f9fa);font-weight:600;font-size:12px;border-bottom:2px solid var(--border)">${u}</th>`).join("")+l,h=r.map((u,f)=>{const p=u.properties||{},m=o.map(v=>`<td style="padding:5px 10px;font-size:12px;white-space:nowrap;max-width:200px;overflow:hidden;text-overflow:ellipsis" title="${Jn(String(p[v]??""))}">${p[v]??""}</td>`).join(""),g=n?`<td style="padding:4px 8px;white-space:nowrap">
          <button class="btn btn-sm btn-outline tbl-edit-feat" data-idx="${f}" style="padding:2px 8px;font-size:11px">Edit</button>
          <button class="btn btn-sm btn-danger tbl-del-feat" data-idx="${f}" style="padding:2px 8px;font-size:11px;margin-left:4px">Del</button>
        </td>`:"";return`<tr style="background:${f%2===0?"#fff":"var(--gray-50,#f8f9fa)"}">${m}${g}</tr>`}).join(""),d=a.length>s?`<div style="padding:8px 12px;font-size:12px;color:var(--text-secondary);background:var(--gray-50,#f8f9fa);border-top:1px solid var(--border)">Showing first ${s} of ${a.length.toLocaleString()} features.</div>`:"";e.innerHTML=`
    ...
    ${d}
  `,n&&(e.querySelectorAll(".tbl-edit-feat").forEach(u=>{u.addEventListener("click",()=>{var g,v;const f=parseInt(u.dataset.idx,10),p=V().layers.find(y=>y.id===Bt),m=(v=(g=p==null?void 0:p.geojson)==null?void 0:g.features)==null?void 0:v[f];m&&Wn(m,{onSave:y=>to(f,y),onDelete:()=>Ys(f)})})}),e.querySelectorAll(".tbl-del-feat").forEach(u=>{u.addEventListener("click",()=>{const f=parseInt(u.dataset.idx,10);Ys(f)})}))}function wd(t){const a=V().layers.find(n=>n.id===t);if(!a||!a.geojson)return;const s=JSON.stringify(a.geojson),i=new Blob([s],{type:"application/json"}),r=URL.createObjectURL(i),o=document.createElement("a");o.href=r,o.download=`${a.metadata.name.replace(/\s+/g,"_")}.geojson`,o.click(),URL.revokeObjectURL(r)}async function Md(t){var i,r,o;if(!await Je("Remove this layer? This cannot be undone.",{title:"Delete Layer",okLabel:"Delete",danger:!0}))return;const a=V().layers.find(n=>n.id===t);try{await ms(t)}catch(n){console.error("Failed to delete layer from storage:",n),Ye("Failed to delete layer. Please try again.",{title:"Error"});return}mi(t);try{await xe("layerTracker",V().layerTracker)}catch(n){console.warn("Failed to save tracker after deletion:",n)}await je({action:"delete",layer_id:t,filename:((i=a==null?void 0:a.metadata)==null?void 0:i.originalFilename)||"",targets:((r=a==null?void 0:a.metadata)==null?void 0:r.targets)||[],category:((o=a==null?void 0:a.metadata)==null?void 0:o.category)||"",result:"deleted"}).catch(()=>{}),He=null;const s=document.getElementById("portal-sidebar");s.style.display="none",s.innerHTML="",Ct()}async function Ni(t,e="edit_feature"){var l,c,h;const a=V(),s=a.layers.find(d=>d.id===Bt);if(!s)return;const i={...s.geojson,features:t},r={...s.metadata,featureCount:t.length},o=a.layers.findIndex(d=>d.id===Bt);o>=0&&(a.layers[o]={...a.layers[o],geojson:i,metadata:r});try{await nn({id:Bt,metadata:r,geojson:i})}catch(d){console.error("Failed to save feature changes:",d),Ye("Failed to save changes. Please try again.",{title:"Error"});return}await je({action:e,layer_id:Bt,filename:((l=s.metadata)==null?void 0:l.originalFilename)||"",targets:((c=s.metadata)==null?void 0:c.targets)||[],category:((h=s.metadata)==null?void 0:h.category)||"",result:"success"}).catch(()=>{});const n=a.layers.find(d=>d.id===Bt);n&&(document.getElementById("preview-feature-count").textContent=`${t.length.toLocaleString()} feature${t.length!==1?"s":""}`,Xn(n),Qn(n),document.getElementById("preview-draw-toolbar")&&eo()),Ct()}function to(t,e){const s=V().layers.find(r=>r.id===Bt);if(!(s!=null&&s.geojson))return;const i=[...s.geojson.features];i[t]={...i[t],properties:e},Ni(i,"edit_feature")}async function Ys(t){const a=V().layers.find(r=>r.id===Bt);if(!(a!=null&&a.geojson)||!await Je("Delete this feature? This cannot be undone.",{title:"Delete Feature",okLabel:"Delete",danger:!0}))return;const i=a.geojson.features.filter((r,o)=>o!==t);Ni(i,"delete_feature")}function _r(t,e){const s=V().layers.find(o=>o.id===Bt);if(!(s!=null&&s.geojson))return;const i={type:"Feature",geometry:t,properties:e},r=[...s.geojson.features,i];Ni(r,"add_feature")}function eo(t){const e=document.getElementById("draw-point-btn"),a=document.getElementById("draw-polygon-btn"),s=document.getElementById("draw-line-btn"),i=document.getElementById("draw-cancel-btn");e&&(e.onclick=()=>Is("Point"),a.onclick=()=>Is("Polygon"),s.onclick=()=>Is("LineString"),i.onclick=()=>fa())}function Is(t){if(!X)return;fa(),Ee=!0,Rt=[];const e=X.getContainer();e.style.cursor="crosshair";const a=document.getElementById("draw-hint"),s=document.getElementById("draw-cancel-btn");a&&(a.textContent=t==="Point"?"Click to place point":"Click vertices — double-click to finish"),s&&(s.style.display="");function i(n){if(Ee){if(t==="Point"){const l={type:"Point",coordinates:[n.latlng.lng,n.latlng.lat]};fa(),mr(t,{onSave:c=>_r(l,c)});return}Rt.push([n.latlng.lng,n.latlng.lat]),wr(n.latlng,t)}}function r(n){if(!Ee||t==="Point")return;Rt.length>0&&Rt.pop();const l=t==="Polygon"?3:2;if(Rt.length<l){const h=document.getElementById("draw-hint");h&&(h.textContent=`Need at least ${l} vertices`);return}let c;t==="Polygon"?c={type:"Polygon",coordinates:[[...Rt,Rt[0]]]}:c={type:"LineString",coordinates:[...Rt]},fa(),mr(t,{onSave:h=>_r(c,h)})}function o(n){Rt.length>0&&wr(n.latlng,t)}X.on("click",i),X.on("dblclick",r),X.on("mousemove",o),Ka=()=>{X==null||X.off("click",i),X==null||X.off("dblclick",r),X==null||X.off("mousemove",o),e&&(e.style.cursor="");const n=document.getElementById("draw-hint"),l=document.getElementById("draw-cancel-btn");n&&(n.textContent=""),l&&(l.style.display="none")}}let Ka=null;function fa(){Ee=!1,Rt=[],_e&&X&&(X.removeLayer(_e),_e=null),Ka&&(Ka(),Ka=null)}function wr(t,e){if(_e&&X&&X.removeLayer(_e),Rt.length===0)return;const a=[...Rt,[t.lng,t.lat]],s=a.map(([i,r])=>[r,i]);e==="Polygon"&&a.length>=3?_e=D.polygon(s,{color:"#0072BC",weight:2,fillOpacity:.15,dashArray:"6,4"}).addTo(X):_e=D.polyline(s,{color:"#0072BC",weight:2,dashArray:"6,4"}).addTo(X)}function ao(){Ct()}const Sd="modulepreload",Ed=function(t,e){return new URL(t,e).href},Mr={},Sr=function(e,a,s){let i=Promise.resolve();if(a&&a.length>0){const o=document.getElementsByTagName("link"),n=document.querySelector("meta[property=csp-nonce]"),l=(n==null?void 0:n.nonce)||(n==null?void 0:n.getAttribute("nonce"));i=Promise.allSettled(a.map(c=>{if(c=Ed(c,s),c in Mr)return;Mr[c]=!0;const h=c.endsWith(".css"),d=h?'[rel="stylesheet"]':"";if(!!s)for(let p=o.length-1;p>=0;p--){const m=o[p];if(m.href===c&&(!h||m.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${c}"]${d}`))return;const f=document.createElement("link");if(f.rel=h?"stylesheet":Sd,h||(f.as="script"),f.crossOrigin="",f.href=c,l&&f.setAttribute("nonce",l),document.head.appendChild(f),h)return new Promise((p,m)=>{f.addEventListener("load",p),f.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${c}`)))})}))}function r(o){const n=new Event("vite:preloadError",{cancelable:!0});if(n.payload=o,window.dispatchEvent(n),!n.defaultPrevented)throw o}return i.then(o=>{for(const n of o||[])n.status==="rejected"&&r(n.reason);return e().catch(r)})};function Ad(t){t("EPSG:4326","+title=WGS 84 (long/lat) +proj=longlat +ellps=WGS84 +datum=WGS84 +units=degrees"),t("EPSG:4269","+title=NAD83 (long/lat) +proj=longlat +a=6378137.0 +b=6356752.31414036 +ellps=GRS80 +datum=NAD83 +units=degrees"),t("EPSG:3857","+title=WGS 84 / Pseudo-Mercator +proj=merc +a=6378137 +b=6378137 +lat_ts=0.0 +lon_0=0.0 +x_0=0.0 +y_0=0 +k=1.0 +units=m +nadgrids=@null +no_defs");for(var e=1;e<=60;++e)t("EPSG:"+(32600+e),"+proj=utm +zone="+e+" +datum=WGS84 +units=m"),t("EPSG:"+(32700+e),"+proj=utm +zone="+e+" +south +datum=WGS84 +units=m");t("EPSG:5041","+title=WGS 84 / UPS North (E,N) +proj=stere +lat_0=90 +lon_0=0 +k=0.994 +x_0=2000000 +y_0=2000000 +datum=WGS84 +units=m"),t("EPSG:5042","+title=WGS 84 / UPS South (E,N) +proj=stere +lat_0=-90 +lon_0=0 +k=0.994 +x_0=2000000 +y_0=2000000 +datum=WGS84 +units=m"),t.WGS84=t["EPSG:4326"],t["EPSG:3785"]=t["EPSG:3857"],t.GOOGLE=t["EPSG:3857"],t["EPSG:900913"]=t["EPSG:3857"],t["EPSG:102113"]=t["EPSG:3857"]}var Ae=1,ke=2,Ue=3,kd=4,Js=5,Er=6378137,Pd=6356752314e-3,Ar=.0066943799901413165,ga=484813681109536e-20,L=Math.PI/2,$d=.16666666666666666,Cd=.04722222222222222,Td=.022156084656084655,G=1e-10,ut=.017453292519943295,Et=57.29577951308232,Q=Math.PI/4,Ma=Math.PI*2,gt=3.14159265359,kt={};kt.greenwich=0;kt.lisbon=-9.131906111111;kt.paris=2.337229166667;kt.bogota=-74.080916666667;kt.madrid=-3.687938888889;kt.rome=12.452333333333;kt.bern=7.439583333333;kt.jakarta=106.807719444444;kt.ferro=-17.666666666667;kt.brussels=4.367975;kt.stockholm=18.058277777778;kt.athens=23.7163375;kt.oslo=10.722916666667;const Ld={mm:{to_meter:.001},cm:{to_meter:.01},ft:{to_meter:.3048},"us-ft":{to_meter:1200/3937},fath:{to_meter:1.8288},kmi:{to_meter:1852},"us-ch":{to_meter:20.1168402336805},"us-mi":{to_meter:1609.34721869444},km:{to_meter:1e3},"ind-ft":{to_meter:.30479841},"ind-yd":{to_meter:.91439523},mi:{to_meter:1609.344},yd:{to_meter:.9144},ch:{to_meter:20.1168},link:{to_meter:.201168},dm:{to_meter:.1},in:{to_meter:.0254},"ind-ch":{to_meter:20.11669506},"us-in":{to_meter:.025400050800101},"us-yd":{to_meter:.914401828803658}};var kr=/[\s_\-\/\(\)]/g;function de(t,e){if(t[e])return t[e];for(var a=Object.keys(t),s=e.toLowerCase().replace(kr,""),i=-1,r,o;++i<a.length;)if(r=a[i],o=r.toLowerCase().replace(kr,""),o===s)return t[r]}function Zs(t){var e={},a=t.split("+").map(function(n){return n.trim()}).filter(function(n){return n}).reduce(function(n,l){var c=l.split("=");return c.push(!0),n[c[0].toLowerCase()]=c[1],n},{}),s,i,r,o={proj:"projName",datum:"datumCode",rf:function(n){e.rf=parseFloat(n)},lat_0:function(n){e.lat0=n*ut},lat_1:function(n){e.lat1=n*ut},lat_2:function(n){e.lat2=n*ut},lat_ts:function(n){e.lat_ts=n*ut},lon_0:function(n){e.long0=n*ut},lon_1:function(n){e.long1=n*ut},lon_2:function(n){e.long2=n*ut},alpha:function(n){e.alpha=parseFloat(n)*ut},gamma:function(n){e.rectified_grid_angle=parseFloat(n)*ut},lonc:function(n){e.longc=n*ut},x_0:function(n){e.x0=parseFloat(n)},y_0:function(n){e.y0=parseFloat(n)},k_0:function(n){e.k0=parseFloat(n)},k:function(n){e.k0=parseFloat(n)},a:function(n){e.a=parseFloat(n)},b:function(n){e.b=parseFloat(n)},r:function(n){e.a=e.b=parseFloat(n)},r_a:function(){e.R_A=!0},zone:function(n){e.zone=parseInt(n,10)},south:function(){e.utmSouth=!0},towgs84:function(n){e.datum_params=n.split(",").map(function(l){return parseFloat(l)})},to_meter:function(n){e.to_meter=parseFloat(n)},units:function(n){e.units=n;var l=de(Ld,n);l&&(e.to_meter=l.to_meter)},from_greenwich:function(n){e.from_greenwich=n*ut},pm:function(n){var l=de(kt,n);e.from_greenwich=(l||parseFloat(n))*ut},nadgrids:function(n){n==="@null"?e.datumCode="none":e.nadgrids=n},axis:function(n){var l="ewnsud";n.length===3&&l.indexOf(n.substr(0,1))!==-1&&l.indexOf(n.substr(1,1))!==-1&&l.indexOf(n.substr(2,1))!==-1&&(e.axis=n)},approx:function(){e.approx=!0},over:function(){e.over=!0}};for(s in a)i=a[s],s in o?(r=o[s],typeof r=="function"?r(i):e[r]=i):e[s]=i;return typeof e.datumCode=="string"&&e.datumCode!=="WGS84"&&(e.datumCode=e.datumCode.toLowerCase()),e.projStr=t,e}class so{static getId(e){const a=e.find(s=>Array.isArray(s)&&s[0]==="ID");return a&&a.length>=3?{authority:a[1],code:parseInt(a[2],10)}:null}static convertUnit(e,a="unit"){if(!e||e.length<3)return{type:a,name:"unknown",conversion_factor:null};const s=e[1],i=parseFloat(e[2])||null,r=e.find(n=>Array.isArray(n)&&n[0]==="ID"),o=r?{authority:r[1],code:parseInt(r[2],10)}:null;return{type:a,name:s,conversion_factor:i,id:o}}static convertAxis(e){const a=e[1]||"Unknown";let s;const i=a.match(/^\((.)\)$/);if(i){const c=i[1].toUpperCase();if(c==="E")s="east";else if(c==="N")s="north";else if(c==="U")s="up";else throw new Error(`Unknown axis abbreviation: ${c}`)}else s=e[2]?e[2].toLowerCase():"unknown";const r=e.find(c=>Array.isArray(c)&&c[0]==="ORDER"),o=r?parseInt(r[1],10):null,n=e.find(c=>Array.isArray(c)&&(c[0]==="LENGTHUNIT"||c[0]==="ANGLEUNIT"||c[0]==="SCALEUNIT")),l=this.convertUnit(n);return{name:a,direction:s,unit:l,order:o}}static extractAxes(e){return e.filter(a=>Array.isArray(a)&&a[0]==="AXIS").map(a=>this.convertAxis(a)).sort((a,s)=>(a.order||0)-(s.order||0))}static convert(e,a={}){switch(e[0]){case"PROJCRS":a.type="ProjectedCRS",a.name=e[1],a.base_crs=e.find(u=>Array.isArray(u)&&u[0]==="BASEGEOGCRS")?this.convert(e.find(u=>Array.isArray(u)&&u[0]==="BASEGEOGCRS")):null,a.conversion=e.find(u=>Array.isArray(u)&&u[0]==="CONVERSION")?this.convert(e.find(u=>Array.isArray(u)&&u[0]==="CONVERSION")):null;const s=e.find(u=>Array.isArray(u)&&u[0]==="CS");s&&(a.coordinate_system={type:s[1],axis:this.extractAxes(e)});const i=e.find(u=>Array.isArray(u)&&u[0]==="LENGTHUNIT");if(i){const u=this.convertUnit(i);a.coordinate_system.unit=u}a.id=this.getId(e);break;case"BASEGEOGCRS":case"GEOGCRS":a.type="GeographicCRS",a.name=e[1];const r=e.find(u=>Array.isArray(u)&&(u[0]==="DATUM"||u[0]==="ENSEMBLE"));if(r){const u=this.convert(r);r[0]==="ENSEMBLE"?a.datum_ensemble=u:a.datum=u;const f=e.find(p=>Array.isArray(p)&&p[0]==="PRIMEM");f&&f[1]!=="Greenwich"&&(u.prime_meridian={name:f[1],longitude:parseFloat(f[2])})}a.coordinate_system={type:"ellipsoidal",axis:this.extractAxes(e)},a.id=this.getId(e);break;case"DATUM":a.type="GeodeticReferenceFrame",a.name=e[1],a.ellipsoid=e.find(u=>Array.isArray(u)&&u[0]==="ELLIPSOID")?this.convert(e.find(u=>Array.isArray(u)&&u[0]==="ELLIPSOID")):null;break;case"ENSEMBLE":a.type="DatumEnsemble",a.name=e[1],a.members=e.filter(u=>Array.isArray(u)&&u[0]==="MEMBER").map(u=>({type:"DatumEnsembleMember",name:u[1],id:this.getId(u)}));const o=e.find(u=>Array.isArray(u)&&u[0]==="ENSEMBLEACCURACY");o&&(a.accuracy=parseFloat(o[1]));const n=e.find(u=>Array.isArray(u)&&u[0]==="ELLIPSOID");n&&(a.ellipsoid=this.convert(n)),a.id=this.getId(e);break;case"ELLIPSOID":a.type="Ellipsoid",a.name=e[1],a.semi_major_axis=parseFloat(e[2]),a.inverse_flattening=parseFloat(e[3]),e.find(u=>Array.isArray(u)&&u[0]==="LENGTHUNIT")&&this.convert(e.find(u=>Array.isArray(u)&&u[0]==="LENGTHUNIT"),a);break;case"CONVERSION":a.type="Conversion",a.name=e[1],a.method=e.find(u=>Array.isArray(u)&&u[0]==="METHOD")?this.convert(e.find(u=>Array.isArray(u)&&u[0]==="METHOD")):null,a.parameters=e.filter(u=>Array.isArray(u)&&u[0]==="PARAMETER").map(u=>this.convert(u));break;case"METHOD":a.type="Method",a.name=e[1],a.id=this.getId(e);break;case"PARAMETER":a.type="Parameter",a.name=e[1],a.value=parseFloat(e[2]),a.unit=this.convertUnit(e.find(u=>Array.isArray(u)&&(u[0]==="LENGTHUNIT"||u[0]==="ANGLEUNIT"||u[0]==="SCALEUNIT"))),a.id=this.getId(e);break;case"BOUNDCRS":a.type="BoundCRS";const l=e.find(u=>Array.isArray(u)&&u[0]==="SOURCECRS");if(l){const u=l.find(f=>Array.isArray(f));a.source_crs=u?this.convert(u):null}const c=e.find(u=>Array.isArray(u)&&u[0]==="TARGETCRS");if(c){const u=c.find(f=>Array.isArray(f));a.target_crs=u?this.convert(u):null}const h=e.find(u=>Array.isArray(u)&&u[0]==="ABRIDGEDTRANSFORMATION");h?a.transformation=this.convert(h):a.transformation=null;break;case"ABRIDGEDTRANSFORMATION":if(a.type="Transformation",a.name=e[1],a.method=e.find(u=>Array.isArray(u)&&u[0]==="METHOD")?this.convert(e.find(u=>Array.isArray(u)&&u[0]==="METHOD")):null,a.parameters=e.filter(u=>Array.isArray(u)&&(u[0]==="PARAMETER"||u[0]==="PARAMETERFILE")).map(u=>{if(u[0]==="PARAMETER")return this.convert(u);if(u[0]==="PARAMETERFILE")return{name:u[1],value:u[2],id:{authority:"EPSG",code:8656}}}),a.parameters.length===7){const u=a.parameters[6];u.name==="Scale difference"&&(u.value=Math.round((u.value-1)*1e12)/1e6)}a.id=this.getId(e);break;case"AXIS":a.coordinate_system||(a.coordinate_system={type:"unspecified",axis:[]}),a.coordinate_system.axis.push(this.convertAxis(e));break;case"LENGTHUNIT":const d=this.convertUnit(e,"LinearUnit");a.coordinate_system&&a.coordinate_system.axis&&a.coordinate_system.axis.forEach(u=>{u.unit||(u.unit=d)}),d.conversion_factor&&d.conversion_factor!==1&&a.semi_major_axis&&(a.semi_major_axis={value:a.semi_major_axis,unit:d});break;default:a.keyword=e[0];break}return a}}class Nd extends so{static convert(e,a={}){return super.convert(e,a),a.coordinate_system&&a.coordinate_system.subtype==="Cartesian"&&delete a.coordinate_system,a.usage&&delete a.usage,a}}class Id extends so{static convert(e,a={}){super.convert(e,a);const s=e.find(r=>Array.isArray(r)&&r[0]==="CS");s&&(a.coordinate_system={subtype:s[1],axis:this.extractAxes(e)});const i=e.find(r=>Array.isArray(r)&&r[0]==="USAGE");if(i){const r=i.find(l=>Array.isArray(l)&&l[0]==="SCOPE"),o=i.find(l=>Array.isArray(l)&&l[0]==="AREA"),n=i.find(l=>Array.isArray(l)&&l[0]==="BBOX");a.usage={},r&&(a.usage.scope=r[1]),o&&(a.usage.area=o[1]),n&&(a.usage.bbox=n.slice(1))}return a}}function Gd(t){return t.find(e=>Array.isArray(e)&&e[0]==="USAGE")?"2019":(t.find(e=>Array.isArray(e)&&e[0]==="CS")||t[0]==="BOUNDCRS"||t[0]==="PROJCRS"||t[0]==="GEOGCRS","2015")}function Rd(t){return(Gd(t)==="2019"?Id:Nd).convert(t)}function Bd(t){const e=t.toUpperCase();return e.includes("PROJCRS")||e.includes("GEOGCRS")||e.includes("BOUNDCRS")||e.includes("VERTCRS")||e.includes("LENGTHUNIT")||e.includes("ANGLEUNIT")||e.includes("SCALEUNIT")?"WKT2":(e.includes("PROJCS")||e.includes("GEOGCS")||e.includes("LOCAL_CS")||e.includes("VERT_CS")||e.includes("UNIT"),"WKT1")}var Sa=1,io=2,ro=3,ns=4,no=5,Ii=-1,Dd=/\s/,Od=/[A-Za-z]/,Fd=/[A-Za-z84_]/,Ss=/[,\]]/,oo=/[\d\.E\-\+]/;function ee(t){if(typeof t!="string")throw new Error("not a string");this.text=t.trim(),this.level=0,this.place=0,this.root=null,this.stack=[],this.currentObject=null,this.state=Sa}ee.prototype.readCharicter=function(){var t=this.text[this.place++];if(this.state!==ns)for(;Dd.test(t);){if(this.place>=this.text.length)return;t=this.text[this.place++]}switch(this.state){case Sa:return this.neutral(t);case io:return this.keyword(t);case ns:return this.quoted(t);case no:return this.afterquote(t);case ro:return this.number(t);case Ii:return}};ee.prototype.afterquote=function(t){if(t==='"'){this.word+='"',this.state=ns;return}if(Ss.test(t)){this.word=this.word.trim(),this.afterItem(t);return}throw new Error(`havn't handled "`+t+'" in afterquote yet, index '+this.place)};ee.prototype.afterItem=function(t){if(t===","){this.word!==null&&this.currentObject.push(this.word),this.word=null,this.state=Sa;return}if(t==="]"){this.level--,this.word!==null&&(this.currentObject.push(this.word),this.word=null),this.state=Sa,this.currentObject=this.stack.pop(),this.currentObject||(this.state=Ii);return}};ee.prototype.number=function(t){if(oo.test(t)){this.word+=t;return}if(Ss.test(t)){this.word=parseFloat(this.word),this.afterItem(t);return}throw new Error(`havn't handled "`+t+'" in number yet, index '+this.place)};ee.prototype.quoted=function(t){if(t==='"'){this.state=no;return}this.word+=t};ee.prototype.keyword=function(t){if(Fd.test(t)){this.word+=t;return}if(t==="["){var e=[];e.push(this.word),this.level++,this.root===null?this.root=e:this.currentObject.push(e),this.stack.push(this.currentObject),this.currentObject=e,this.state=Sa;return}if(Ss.test(t)){this.afterItem(t);return}throw new Error(`havn't handled "`+t+'" in keyword yet, index '+this.place)};ee.prototype.neutral=function(t){if(Od.test(t)){this.word=t,this.state=io;return}if(t==='"'){this.word="",this.state=ns;return}if(oo.test(t)){this.word=t,this.state=ro;return}if(Ss.test(t)){this.afterItem(t);return}throw new Error(`havn't handled "`+t+'" in neutral yet, index '+this.place)};ee.prototype.output=function(){for(;this.place<this.text.length;)this.readCharicter();if(this.state===Ii)return this.root;throw new Error('unable to parse string "'+this.text+'". State is '+this.state)};function zd(t){var e=new ee(t);return e.output()}function Gs(t,e,a){Array.isArray(e)&&(a.unshift(e),e=null);var s=e?{}:t,i=a.reduce(function(r,o){return Be(o,r),r},s);e&&(t[e]=i)}function Be(t,e){if(!Array.isArray(t)){e[t]=!0;return}var a=t.shift();if(a==="PARAMETER"&&(a=t.shift()),t.length===1){if(Array.isArray(t[0])){e[a]={},Be(t[0],e[a]);return}e[a]=t[0];return}if(!t.length){e[a]=!0;return}if(a==="TOWGS84"){e[a]=t;return}if(a==="AXIS"){a in e||(e[a]=[]),e[a].push(t);return}Array.isArray(a)||(e[a]={});var s;switch(a){case"UNIT":case"PRIMEM":case"VERT_DATUM":e[a]={name:t[0].toLowerCase(),convert:t[1]},t.length===3&&Be(t[2],e[a]);return;case"SPHEROID":case"ELLIPSOID":e[a]={name:t[0],a:t[1],rf:t[2]},t.length===4&&Be(t[3],e[a]);return;case"EDATUM":case"ENGINEERINGDATUM":case"LOCAL_DATUM":case"DATUM":case"VERT_CS":case"VERTCRS":case"VERTICALCRS":t[0]=["name",t[0]],Gs(e,a,t);return;case"COMPD_CS":case"COMPOUNDCRS":case"FITTED_CS":case"PROJECTEDCRS":case"PROJCRS":case"GEOGCS":case"GEOCCS":case"PROJCS":case"LOCAL_CS":case"GEODCRS":case"GEODETICCRS":case"GEODETICDATUM":case"ENGCRS":case"ENGINEERINGCRS":t[0]=["name",t[0]],Gs(e,a,t),e[a].type=a;return;default:for(s=-1;++s<t.length;)if(!Array.isArray(t[s]))return Be(t,e[a]);return Gs(e,a,t)}}var jd=.017453292519943295;function Ot(t){return t*jd}function lo(t){const e=(t.projName||"").toLowerCase().replace(/_/g," ");!t.long0&&t.longc&&(e==="albers conic equal area"||e==="lambert azimuthal equal area")&&(t.long0=t.longc),!t.lat_ts&&t.lat1&&(e==="stereographic south pole"||e==="polar stereographic (variant b)")?(t.lat0=Ot(t.lat1>0?90:-90),t.lat_ts=t.lat1,delete t.lat1):!t.lat_ts&&t.lat0&&(e==="polar stereographic"||e==="polar stereographic (variant a)")&&(t.lat_ts=t.lat0,t.lat0=Ot(t.lat0>0?90:-90),delete t.lat1)}function Pr(t){let e={units:null,to_meter:void 0};return typeof t=="string"?(e.units=t.toLowerCase(),e.units==="metre"&&(e.units="meter"),e.units==="meter"&&(e.to_meter=1)):t&&t.name&&(e.units=t.name.toLowerCase(),e.units==="metre"&&(e.units="meter"),e.to_meter=t.conversion_factor),e}function $r(t){return typeof t=="object"?t.value*t.unit.conversion_factor:t}function Cr(t,e){t.ellipsoid.radius?(e.a=t.ellipsoid.radius,e.rf=0):(e.a=$r(t.ellipsoid.semi_major_axis),t.ellipsoid.inverse_flattening!==void 0?e.rf=t.ellipsoid.inverse_flattening:t.ellipsoid.semi_major_axis!==void 0&&t.ellipsoid.semi_minor_axis!==void 0&&(e.rf=e.a/(e.a-$r(t.ellipsoid.semi_minor_axis))))}function os(t,e={}){return!t||typeof t!="object"?t:t.type==="BoundCRS"?(os(t.source_crs,e),t.transformation&&(t.transformation.method&&t.transformation.method.name==="NTv2"?e.nadgrids=t.transformation.parameters[0].value:e.datum_params=t.transformation.parameters.map(a=>a.value)),e):(Object.keys(t).forEach(a=>{const s=t[a];if(s!==null)switch(a){case"name":if(e.srsCode)break;e.name=s,e.srsCode=s;break;case"type":s==="GeographicCRS"?e.projName="longlat":s==="ProjectedCRS"&&t.conversion&&t.conversion.method&&(e.projName=t.conversion.method.name);break;case"datum":case"datum_ensemble":s.ellipsoid&&(e.ellps=s.ellipsoid.name,Cr(s,e)),s.prime_meridian&&(e.from_greenwich=s.prime_meridian.longitude*Math.PI/180);break;case"ellipsoid":e.ellps=s.name,Cr(s,e);break;case"prime_meridian":e.long0=(s.longitude||0)*Math.PI/180;break;case"coordinate_system":if(s.axis){if(e.axis=s.axis.map(i=>{const r=i.direction;if(r==="east")return"e";if(r==="north")return"n";if(r==="west")return"w";if(r==="south")return"s";throw new Error(`Unknown axis direction: ${r}`)}).join("")+"u",s.unit){const{units:i,to_meter:r}=Pr(s.unit);e.units=i,e.to_meter=r}else if(s.axis[0]&&s.axis[0].unit){const{units:i,to_meter:r}=Pr(s.axis[0].unit);e.units=i,e.to_meter=r}}break;case"id":s.authority&&s.code&&(e.title=s.authority+":"+s.code);break;case"conversion":s.method&&s.method.name&&(e.projName=s.method.name),s.parameters&&s.parameters.forEach(i=>{const r=i.name.toLowerCase().replace(/\s+/g,"_"),o=i.value;i.unit&&i.unit.conversion_factor?e[r]=o*i.unit.conversion_factor:i.unit==="degree"?e[r]=o*Math.PI/180:e[r]=o});break;case"unit":s.name&&(e.units=s.name.toLowerCase(),e.units==="metre"&&(e.units="meter")),s.conversion_factor&&(e.to_meter=s.conversion_factor);break;case"base_crs":os(s,e),e.datumCode=s.id?s.id.authority+"_"+s.id.code:s.name;break}}),e.latitude_of_false_origin!==void 0&&(e.lat0=e.latitude_of_false_origin),e.longitude_of_false_origin!==void 0&&(e.long0=e.longitude_of_false_origin),e.latitude_of_standard_parallel!==void 0&&(e.lat0=e.latitude_of_standard_parallel,e.lat1=e.latitude_of_standard_parallel),e.latitude_of_1st_standard_parallel!==void 0&&(e.lat1=e.latitude_of_1st_standard_parallel),e.latitude_of_2nd_standard_parallel!==void 0&&(e.lat2=e.latitude_of_2nd_standard_parallel),e.latitude_of_projection_centre!==void 0&&(e.lat0=e.latitude_of_projection_centre),e.longitude_of_projection_centre!==void 0&&(e.longc=e.longitude_of_projection_centre),e.easting_at_false_origin!==void 0&&(e.x0=e.easting_at_false_origin),e.northing_at_false_origin!==void 0&&(e.y0=e.northing_at_false_origin),e.latitude_of_natural_origin!==void 0&&(e.lat0=e.latitude_of_natural_origin),e.longitude_of_natural_origin!==void 0&&(e.long0=e.longitude_of_natural_origin),e.longitude_of_origin!==void 0&&(e.long0=e.longitude_of_origin),e.false_easting!==void 0&&(e.x0=e.false_easting),e.easting_at_projection_centre&&(e.x0=e.easting_at_projection_centre),e.false_northing!==void 0&&(e.y0=e.false_northing),e.northing_at_projection_centre&&(e.y0=e.northing_at_projection_centre),e.standard_parallel_1!==void 0&&(e.lat1=e.standard_parallel_1),e.standard_parallel_2!==void 0&&(e.lat2=e.standard_parallel_2),e.scale_factor_at_natural_origin!==void 0&&(e.k0=e.scale_factor_at_natural_origin),e.scale_factor_at_projection_centre!==void 0&&(e.k0=e.scale_factor_at_projection_centre),e.scale_factor_on_pseudo_standard_parallel!==void 0&&(e.k0=e.scale_factor_on_pseudo_standard_parallel),e.azimuth!==void 0&&(e.alpha=e.azimuth),e.azimuth_at_projection_centre!==void 0&&(e.alpha=e.azimuth_at_projection_centre),e.angle_from_rectified_to_skew_grid&&(e.rectified_grid_angle=e.angle_from_rectified_to_skew_grid),lo(e),e)}var qd=["PROJECTEDCRS","PROJCRS","GEOGCS","GEOCCS","PROJCS","LOCAL_CS","GEODCRS","GEODETICCRS","GEODETICDATUM","ENGCRS","ENGINEERINGCRS"];function Hd(t,e){var a=e[0],s=e[1];!(a in t)&&s in t&&(t[a]=t[s],e.length===3&&(t[a]=e[2](t[a])))}function co(t){for(var e=Object.keys(t),a=0,s=e.length;a<s;++a){var i=e[a];qd.indexOf(i)!==-1&&Ud(t[i]),typeof t[i]=="object"&&co(t[i])}}function Ud(t){if(t.AUTHORITY){var e=Object.keys(t.AUTHORITY)[0];e&&e in t.AUTHORITY&&(t.title=e+":"+t.AUTHORITY[e])}if(t.type==="GEOGCS"?t.projName="longlat":t.type==="LOCAL_CS"?(t.projName="identity",t.local=!0):typeof t.PROJECTION=="object"?t.projName=Object.keys(t.PROJECTION)[0]:t.projName=t.PROJECTION,t.AXIS){for(var a="",s=0,i=t.AXIS.length;s<i;++s){var r=[t.AXIS[s][0].toLowerCase(),t.AXIS[s][1].toLowerCase()];r[0].indexOf("north")!==-1||(r[0]==="y"||r[0]==="lat")&&r[1]==="north"?a+="n":r[0].indexOf("south")!==-1||(r[0]==="y"||r[0]==="lat")&&r[1]==="south"?a+="s":r[0].indexOf("east")!==-1||(r[0]==="x"||r[0]==="lon")&&r[1]==="east"?a+="e":(r[0].indexOf("west")!==-1||(r[0]==="x"||r[0]==="lon")&&r[1]==="west")&&(a+="w")}a.length===2&&(a+="u"),a.length===3&&(t.axis=a)}t.UNIT&&(t.units=t.UNIT.name.toLowerCase(),t.units==="metre"&&(t.units="meter"),t.UNIT.convert&&(t.type==="GEOGCS"?t.DATUM&&t.DATUM.SPHEROID&&(t.to_meter=t.UNIT.convert*t.DATUM.SPHEROID.a):t.to_meter=t.UNIT.convert));var o=t.GEOGCS;t.type==="GEOGCS"&&(o=t),o&&(o.DATUM?t.datumCode=o.DATUM.name.toLowerCase():t.datumCode=o.name.toLowerCase(),t.datumCode.slice(0,2)==="d_"&&(t.datumCode=t.datumCode.slice(2)),t.datumCode==="new_zealand_1949"&&(t.datumCode="nzgd49"),(t.datumCode==="wgs_1984"||t.datumCode==="world_geodetic_system_1984")&&(t.PROJECTION==="Mercator_Auxiliary_Sphere"&&(t.sphere=!0),t.datumCode="wgs84"),t.datumCode==="belge_1972"&&(t.datumCode="rnb72"),o.DATUM&&o.DATUM.SPHEROID&&(t.ellps=o.DATUM.SPHEROID.name.replace("_19","").replace(/[Cc]larke\_18/,"clrk"),t.ellps.toLowerCase().slice(0,13)==="international"&&(t.ellps="intl"),t.a=o.DATUM.SPHEROID.a,t.rf=parseFloat(o.DATUM.SPHEROID.rf,10)),o.DATUM&&o.DATUM.TOWGS84&&(t.datum_params=o.DATUM.TOWGS84),~t.datumCode.indexOf("osgb_1936")&&(t.datumCode="osgb36"),~t.datumCode.indexOf("osni_1952")&&(t.datumCode="osni52"),(~t.datumCode.indexOf("tm65")||~t.datumCode.indexOf("geodetic_datum_of_1965"))&&(t.datumCode="ire65"),t.datumCode==="ch1903+"&&(t.datumCode="ch1903"),~t.datumCode.indexOf("israel")&&(t.datumCode="isr93")),t.b&&!isFinite(t.b)&&(t.b=t.a),t.rectified_grid_angle&&(t.rectified_grid_angle=Ot(t.rectified_grid_angle));function n(h){var d=t.to_meter||1;return h*d}var l=function(h){return Hd(t,h)},c=[["standard_parallel_1","Standard_Parallel_1"],["standard_parallel_1","Latitude of 1st standard parallel"],["standard_parallel_2","Standard_Parallel_2"],["standard_parallel_2","Latitude of 2nd standard parallel"],["false_easting","False_Easting"],["false_easting","False easting"],["false-easting","Easting at false origin"],["false_northing","False_Northing"],["false_northing","False northing"],["false_northing","Northing at false origin"],["central_meridian","Central_Meridian"],["central_meridian","Longitude of natural origin"],["central_meridian","Longitude of false origin"],["latitude_of_origin","Latitude_Of_Origin"],["latitude_of_origin","Central_Parallel"],["latitude_of_origin","Latitude of natural origin"],["latitude_of_origin","Latitude of false origin"],["scale_factor","Scale_Factor"],["k0","scale_factor"],["latitude_of_center","Latitude_Of_Center"],["latitude_of_center","Latitude_of_center"],["lat0","latitude_of_center",Ot],["longitude_of_center","Longitude_Of_Center"],["longitude_of_center","Longitude_of_center"],["longc","longitude_of_center",Ot],["x0","false_easting",n],["y0","false_northing",n],["long0","central_meridian",Ot],["lat0","latitude_of_origin",Ot],["lat0","standard_parallel_1",Ot],["lat1","standard_parallel_1",Ot],["lat2","standard_parallel_2",Ot],["azimuth","Azimuth"],["alpha","azimuth",Ot],["srsCode","name"]];c.forEach(l),lo(t)}function ls(t){if(typeof t=="object")return os(t);const e=Bd(t);var a=zd(t);if(e==="WKT2"){const r=Rd(a);return os(r)}var s=a[0],i={};return Be(a,i),co(i),i[s]}function xt(t){var e=this;if(arguments.length===2){var a=arguments[1];typeof a=="string"?a.charAt(0)==="+"?xt[t]=Zs(arguments[1]):xt[t]=ls(arguments[1]):a&&typeof a=="object"&&!("projName"in a)?xt[t]=ls(arguments[1]):(xt[t]=a,a||delete xt[t])}else if(arguments.length===1){if(Array.isArray(t))return t.map(function(s){return Array.isArray(s)?xt.apply(e,s):xt(s)});if(typeof t=="string"){if(t in xt)return xt[t]}else"EPSG"in t?xt["EPSG:"+t.EPSG]=t:"ESRI"in t?xt["ESRI:"+t.ESRI]=t:"IAU2000"in t?xt["IAU2000:"+t.IAU2000]=t:console.log(t);return}}Ad(xt);function Vd(t){return typeof t=="string"}function Wd(t){return t in xt}function Kd(t){return t.indexOf("+")!==0&&t.indexOf("[")!==-1||typeof t=="object"&&!("srsCode"in t)}var Yd=["3857","900913","3785","102113"];function Jd(t){var e=de(t,"authority");if(e){var a=de(e,"epsg");return a&&Yd.indexOf(a)>-1}}function Zd(t){var e=de(t,"extension");if(e)return de(e,"proj4")}function Xd(t){return t[0]==="+"}function Qd(t){if(Vd(t)){if(Wd(t))return xt[t];if(Kd(t)){var e=ls(t);if(Jd(e))return xt["EPSG:3857"];var a=Zd(e);return a?Zs(a):e}if(Xd(t))return Zs(t)}else return"projName"in t?t:ls(t)}function Tr(t,e){t=t||{};var a,s;if(!e)return t;for(s in e)a=e[s],a!==void 0&&(t[s]=a);return t}function Wt(t,e,a){var s=t*e;return a/Math.sqrt(1-s*s)}function La(t){return t<0?-1:1}function B(t,e){return e||Math.abs(t)<=gt?t:t-La(t)*Ma}function Ft(t,e,a){var s=t*a,i=.5*t;return s=Math.pow((1-s)/(1+s),i),Math.tan(.5*(L-e))/s}function Ea(t,e){for(var a=.5*t,s,i,r=L-2*Math.atan(e),o=0;o<=15;o++)if(s=t*Math.sin(r),i=L-2*Math.atan(e*Math.pow((1-s)/(1+s),a))-r,r+=i,Math.abs(i)<=1e-10)return r;return-9999}function th(){var t=this.b/this.a;this.es=1-t*t,"x0"in this||(this.x0=0),"y0"in this||(this.y0=0),this.e=Math.sqrt(this.es),this.lat_ts?this.sphere?this.k0=Math.cos(this.lat_ts):this.k0=Wt(this.e,Math.sin(this.lat_ts),Math.cos(this.lat_ts)):this.k0||(this.k?this.k0=this.k:this.k0=1)}function eh(t){var e=t.x,a=t.y;if(a*Et>90&&a*Et<-90&&e*Et>180&&e*Et<-180)return null;var s,i;if(Math.abs(Math.abs(a)-L)<=G)return null;if(this.sphere)s=this.x0+this.a*this.k0*B(e-this.long0,this.over),i=this.y0+this.a*this.k0*Math.log(Math.tan(Q+.5*a));else{var r=Math.sin(a),o=Ft(this.e,a,r);s=this.x0+this.a*this.k0*B(e-this.long0,this.over),i=this.y0-this.a*this.k0*Math.log(o)}return t.x=s,t.y=i,t}function ah(t){var e=t.x-this.x0,a=t.y-this.y0,s,i;if(this.sphere)i=L-2*Math.atan(Math.exp(-a/(this.a*this.k0)));else{var r=Math.exp(-a/(this.a*this.k0));if(i=Ea(this.e,r),i===-9999)return null}return s=B(this.long0+e/(this.a*this.k0),this.over),t.x=s,t.y=i,t}var sh=["Mercator","Popular Visualisation Pseudo Mercator","Mercator_1SP","Mercator_Auxiliary_Sphere","Mercator_Variant_A","merc"];const ih={init:th,forward:eh,inverse:ah,names:sh};function rh(){}function Lr(t){return t}var ho=["longlat","identity"];const nh={init:rh,forward:Lr,inverse:Lr,names:ho};var oh=[ih,nh],be={},De=[];function uo(t,e){var a=De.length;return t.names?(De[a]=t,t.names.forEach(function(s){be[s.toLowerCase()]=a}),this):(console.log(e),!0)}function po(t){return t.replace(/[-\(\)\s]+/g," ").trim().replace(/ /g,"_")}function lh(t){if(!t)return!1;var e=t.toLowerCase();if(typeof be[e]<"u"&&De[be[e]]||(e=po(e),e in be&&De[be[e]]))return De[be[e]]}function ch(){oh.forEach(uo)}const dh={start:ch,add:uo,get:lh};var fo={MERIT:{a:6378137,rf:298.257,ellipseName:"MERIT 1983"},SGS85:{a:6378136,rf:298.257,ellipseName:"Soviet Geodetic System 85"},GRS80:{a:6378137,rf:298.257222101,ellipseName:"GRS 1980(IUGG, 1980)"},IAU76:{a:6378140,rf:298.257,ellipseName:"IAU 1976"},airy:{a:6377563396e-3,b:635625691e-2,ellipseName:"Airy 1830"},APL4:{a:6378137,rf:298.25,ellipseName:"Appl. Physics. 1965"},NWL9D:{a:6378145,rf:298.25,ellipseName:"Naval Weapons Lab., 1965"},mod_airy:{a:6377340189e-3,b:6356034446e-3,ellipseName:"Modified Airy"},andrae:{a:637710443e-2,rf:300,ellipseName:"Andrae 1876 (Den., Iclnd.)"},aust_SA:{a:6378160,rf:298.25,ellipseName:"Australian Natl & S. Amer. 1969"},GRS67:{a:6378160,rf:298.247167427,ellipseName:"GRS 67(IUGG 1967)"},bessel:{a:6377397155e-3,rf:299.1528128,ellipseName:"Bessel 1841"},bess_nam:{a:6377483865e-3,rf:299.1528128,ellipseName:"Bessel 1841 (Namibia)"},clrk66:{a:63782064e-1,b:63565838e-1,ellipseName:"Clarke 1866"},clrk80:{a:6378249145e-3,rf:293.4663,ellipseName:"Clarke 1880 mod."},clrk80ign:{a:63782492e-1,b:6356515,rf:293.4660213,ellipseName:"Clarke 1880 (IGN)"},clrk58:{a:6378293645208759e-9,rf:294.2606763692654,ellipseName:"Clarke 1858"},CPM:{a:63757387e-1,rf:334.29,ellipseName:"Comm. des Poids et Mesures 1799"},delmbr:{a:6376428,rf:311.5,ellipseName:"Delambre 1810 (Belgium)"},engelis:{a:637813605e-2,rf:298.2566,ellipseName:"Engelis 1985"},evrst30:{a:6377276345e-3,rf:300.8017,ellipseName:"Everest 1830"},evrst48:{a:6377304063e-3,rf:300.8017,ellipseName:"Everest 1948"},evrst56:{a:6377301243e-3,rf:300.8017,ellipseName:"Everest 1956"},evrst69:{a:6377295664e-3,rf:300.8017,ellipseName:"Everest 1969"},evrstSS:{a:6377298556e-3,rf:300.8017,ellipseName:"Everest (Sabah & Sarawak)"},fschr60:{a:6378166,rf:298.3,ellipseName:"Fischer (Mercury Datum) 1960"},fschr60m:{a:6378155,rf:298.3,ellipseName:"Fischer 1960"},fschr68:{a:6378150,rf:298.3,ellipseName:"Fischer 1968"},helmert:{a:6378200,rf:298.3,ellipseName:"Helmert 1906"},hough:{a:6378270,rf:297,ellipseName:"Hough"},intl:{a:6378388,rf:297,ellipseName:"International 1909 (Hayford)"},kaula:{a:6378163,rf:298.24,ellipseName:"Kaula 1961"},lerch:{a:6378139,rf:298.257,ellipseName:"Lerch 1979"},mprts:{a:6397300,rf:191,ellipseName:"Maupertius 1738"},new_intl:{a:63781575e-1,b:63567722e-1,ellipseName:"New International 1967"},plessis:{a:6376523,rf:6355863,ellipseName:"Plessis 1817 (France)"},krass:{a:6378245,rf:298.3,ellipseName:"Krassovsky, 1942"},SEasia:{a:6378155,b:63567733205e-4,ellipseName:"Southeast Asia"},walbeck:{a:6376896,b:63558348467e-4,ellipseName:"Walbeck"},WGS60:{a:6378165,rf:298.3,ellipseName:"WGS 60"},WGS66:{a:6378145,rf:298.25,ellipseName:"WGS 66"},WGS7:{a:6378135,rf:298.26,ellipseName:"WGS 72"},WGS84:{a:6378137,rf:298.257223563,ellipseName:"WGS 84"},sphere:{a:6370997,b:6370997,ellipseName:"Normal Sphere (r=6370997)"}};const hh=fo.WGS84;function uh(t,e,a,s){var i=t*t,r=e*e,o=(i-r)/i,n=0;s?(t*=1-o*($d+o*(Cd+o*Td)),i=t*t,o=0):n=Math.sqrt(o);var l=(i-r)/r;return{es:o,e:n,ep2:l}}function ph(t,e,a,s,i){if(!t){var r=de(fo,s);r||(r=hh),t=r.a,e=r.b,a=r.rf}return a&&!e&&(e=(1-1/a)*t),(a===0||Math.abs(t-e)<G)&&(i=!0,e=t),{a:t,b:e,rf:a,sphere:i}}var Ya={wgs84:{towgs84:"0,0,0",ellipse:"WGS84",datumName:"WGS84"},ch1903:{towgs84:"674.374,15.056,405.346",ellipse:"bessel",datumName:"swiss"},ggrs87:{towgs84:"-199.87,74.79,246.62",ellipse:"GRS80",datumName:"Greek_Geodetic_Reference_System_1987"},nad83:{towgs84:"0,0,0",ellipse:"GRS80",datumName:"North_American_Datum_1983"},nad27:{nadgrids:"@conus,@alaska,@ntv2_0.gsb,@ntv1_can.dat",ellipse:"clrk66",datumName:"North_American_Datum_1927"},potsdam:{towgs84:"598.1,73.7,418.2,0.202,0.045,-2.455,6.7",ellipse:"bessel",datumName:"Potsdam Rauenberg 1950 DHDN"},carthage:{towgs84:"-263.0,6.0,431.0",ellipse:"clark80",datumName:"Carthage 1934 Tunisia"},hermannskogel:{towgs84:"577.326,90.129,463.919,5.137,1.474,5.297,2.4232",ellipse:"bessel",datumName:"Hermannskogel"},mgi:{towgs84:"577.326,90.129,463.919,5.137,1.474,5.297,2.4232",ellipse:"bessel",datumName:"Militar-Geographische Institut"},osni52:{towgs84:"482.530,-130.596,564.557,-1.042,-0.214,-0.631,8.15",ellipse:"airy",datumName:"Irish National"},ire65:{towgs84:"482.530,-130.596,564.557,-1.042,-0.214,-0.631,8.15",ellipse:"mod_airy",datumName:"Ireland 1965"},rassadiran:{towgs84:"-133.63,-157.5,-158.62",ellipse:"intl",datumName:"Rassadiran"},nzgd49:{towgs84:"59.47,-5.04,187.44,0.47,-0.1,1.024,-4.5993",ellipse:"intl",datumName:"New Zealand Geodetic Datum 1949"},osgb36:{towgs84:"446.448,-125.157,542.060,0.1502,0.2470,0.8421,-20.4894",ellipse:"airy",datumName:"Ordnance Survey of Great Britain 1936"},s_jtsk:{towgs84:"589,76,480",ellipse:"bessel",datumName:"S-JTSK (Ferro)"},beduaram:{towgs84:"-106,-87,188",ellipse:"clrk80",datumName:"Beduaram"},gunung_segara:{towgs84:"-403,684,41",ellipse:"bessel",datumName:"Gunung Segara Jakarta"},rnb72:{towgs84:"106.869,-52.2978,103.724,-0.33657,0.456955,-1.84218,1",ellipse:"intl",datumName:"Reseau National Belge 1972"},EPSG_5451:{towgs84:"6.41,-49.05,-11.28,1.5657,0.5242,6.9718,-5.7649"},IGNF_LURESG:{towgs84:"-192.986,13.673,-39.309,-0.4099,-2.9332,2.6881,0.43"},EPSG_4614:{towgs84:"-119.4248,-303.65872,-11.00061,1.164298,0.174458,1.096259,3.657065"},EPSG_4615:{towgs84:"-494.088,-312.129,279.877,-1.423,-1.013,1.59,-0.748"},ESRI_37241:{towgs84:"-76.822,257.457,-12.817,2.136,-0.033,-2.392,-0.031"},ESRI_37249:{towgs84:"-440.296,58.548,296.265,1.128,10.202,4.559,-0.438"},ESRI_37245:{towgs84:"-511.151,-181.269,139.609,1.05,2.703,1.798,3.071"},EPSG_4178:{towgs84:"24.9,-126.4,-93.2,-0.063,-0.247,-0.041,1.01"},EPSG_4622:{towgs84:"-472.29,-5.63,-304.12,0.4362,-0.8374,0.2563,1.8984"},EPSG_4625:{towgs84:"126.93,547.94,130.41,-2.7867,5.1612,-0.8584,13.8227"},EPSG_5252:{towgs84:"0.023,0.036,-0.068,0.00176,0.00912,-0.01136,0.00439"},EPSG_4314:{towgs84:"597.1,71.4,412.1,0.894,0.068,-1.563,7.58"},EPSG_4282:{towgs84:"-178.3,-316.7,-131.5,5.278,6.077,10.979,19.166"},EPSG_4231:{towgs84:"-83.11,-97.38,-117.22,0.0276,-0.2167,0.2147,0.1218"},EPSG_4274:{towgs84:"-230.994,102.591,25.199,0.633,-0.239,0.9,1.95"},EPSG_4134:{towgs84:"-180.624,-225.516,173.919,-0.81,-1.898,8.336,16.71006"},EPSG_4254:{towgs84:"18.38,192.45,96.82,0.056,-0.142,-0.2,-0.0013"},EPSG_4159:{towgs84:"-194.513,-63.978,-25.759,-3.4027,3.756,-3.352,-0.9175"},EPSG_4687:{towgs84:"0.072,-0.507,-0.245,0.0183,-0.0003,0.007,-0.0093"},EPSG_4227:{towgs84:"-83.58,-397.54,458.78,-17.595,-2.847,4.256,3.225"},EPSG_4746:{towgs84:"599.4,72.4,419.2,-0.062,-0.022,-2.723,6.46"},EPSG_4745:{towgs84:"612.4,77,440.2,-0.054,0.057,-2.797,2.55"},EPSG_6311:{towgs84:"8.846,-4.394,-1.122,-0.00237,-0.146528,0.130428,0.783926"},EPSG_4289:{towgs84:"565.7381,50.4018,465.2904,-1.91514,1.60363,-9.09546,4.07244"},EPSG_4230:{towgs84:"-68.863,-134.888,-111.49,-0.53,-0.14,0.57,-3.4"},EPSG_4154:{towgs84:"-123.02,-158.95,-168.47"},EPSG_4156:{towgs84:"570.8,85.7,462.8,4.998,1.587,5.261,3.56"},EPSG_4299:{towgs84:"482.5,-130.6,564.6,-1.042,-0.214,-0.631,8.15"},EPSG_4179:{towgs84:"33.4,-146.6,-76.3,-0.359,-0.053,0.844,-0.84"},EPSG_4313:{towgs84:"-106.8686,52.2978,-103.7239,0.3366,-0.457,1.8422,-1.2747"},EPSG_4194:{towgs84:"163.511,127.533,-159.789"},EPSG_4195:{towgs84:"105,326,-102.5"},EPSG_4196:{towgs84:"-45,417,-3.5"},EPSG_4611:{towgs84:"-162.619,-276.959,-161.764,0.067753,-2.243649,-1.158827,-1.094246"},EPSG_4633:{towgs84:"137.092,131.66,91.475,-1.9436,-11.5993,-4.3321,-7.4824"},EPSG_4641:{towgs84:"-408.809,366.856,-412.987,1.8842,-0.5308,2.1655,-121.0993"},EPSG_4643:{towgs84:"-480.26,-438.32,-643.429,16.3119,20.1721,-4.0349,-111.7002"},EPSG_4300:{towgs84:"482.5,-130.6,564.6,-1.042,-0.214,-0.631,8.15"},EPSG_4188:{towgs84:"482.5,-130.6,564.6,-1.042,-0.214,-0.631,8.15"},EPSG_4660:{towgs84:"982.6087,552.753,-540.873,32.39344,-153.25684,-96.2266,16.805"},EPSG_4662:{towgs84:"97.295,-263.247,310.882,-1.5999,0.8386,3.1409,13.3259"},EPSG_3906:{towgs84:"577.88891,165.22205,391.18289,4.9145,-0.94729,-13.05098,7.78664"},EPSG_4307:{towgs84:"-209.3622,-87.8162,404.6198,0.0046,3.4784,0.5805,-1.4547"},EPSG_6892:{towgs84:"-76.269,-16.683,68.562,-6.275,10.536,-4.286,-13.686"},EPSG_4690:{towgs84:"221.597,152.441,176.523,2.403,1.3893,0.884,11.4648"},EPSG_4691:{towgs84:"218.769,150.75,176.75,3.5231,2.0037,1.288,10.9817"},EPSG_4629:{towgs84:"72.51,345.411,79.241,-1.5862,-0.8826,-0.5495,1.3653"},EPSG_4630:{towgs84:"165.804,216.213,180.26,-0.6251,-0.4515,-0.0721,7.4111"},EPSG_4692:{towgs84:"217.109,86.452,23.711,0.0183,-0.0003,0.007,-0.0093"},EPSG_9333:{towgs84:"0,0,0,-8.393,0.749,-10.276,0"},EPSG_9059:{towgs84:"0,0,0"},EPSG_4312:{towgs84:"601.705,84.263,485.227,4.7354,1.3145,5.393,-2.3887"},EPSG_4123:{towgs84:"-96.062,-82.428,-121.753,4.801,0.345,-1.376,1.496"},EPSG_4309:{towgs84:"-124.45,183.74,44.64,-0.4384,0.5446,-0.9706,-2.1365"},ESRI_104106:{towgs84:"-283.088,-70.693,117.445,-1.157,0.059,-0.652,-4.058"},EPSG_4281:{towgs84:"-219.247,-73.802,269.529"},EPSG_4322:{towgs84:"0,0,4.5"},EPSG_4324:{towgs84:"0,0,1.9"},EPSG_4284:{towgs84:"43.822,-108.842,-119.585,1.455,-0.761,0.737,0.549"},EPSG_4277:{towgs84:"446.448,-125.157,542.06,0.15,0.247,0.842,-20.489"},EPSG_4207:{towgs84:"-282.1,-72.2,120,-1.529,0.145,-0.89,-4.46"},EPSG_4688:{towgs84:"347.175,1077.618,2623.677,33.9058,-70.6776,9.4013,186.0647"},EPSG_4689:{towgs84:"410.793,54.542,80.501,-2.5596,-2.3517,-0.6594,17.3218"},EPSG_4720:{towgs84:"0,0,4.5"},EPSG_4273:{towgs84:"278.3,93,474.5,7.889,0.05,-6.61,6.21"},EPSG_4240:{towgs84:"204.64,834.74,293.8"},EPSG_4817:{towgs84:"278.3,93,474.5,7.889,0.05,-6.61,6.21"},ESRI_104131:{towgs84:"426.62,142.62,460.09,4.98,4.49,-12.42,-17.1"},EPSG_4265:{towgs84:"-104.1,-49.1,-9.9,0.971,-2.917,0.714,-11.68"},EPSG_4263:{towgs84:"-111.92,-87.85,114.5,1.875,0.202,0.219,0.032"},EPSG_4298:{towgs84:"-689.5937,623.84046,-65.93566,-0.02331,1.17094,-0.80054,5.88536"},EPSG_4270:{towgs84:"-253.4392,-148.452,386.5267,0.15605,0.43,-0.1013,-0.0424"},EPSG_4229:{towgs84:"-121.8,98.1,-10.7"},EPSG_4220:{towgs84:"-55.5,-348,-229.2"},EPSG_4214:{towgs84:"12.646,-155.176,-80.863"},EPSG_4232:{towgs84:"-345,3,223"},EPSG_4238:{towgs84:"-1.977,-13.06,-9.993,0.364,0.254,0.689,-1.037"},EPSG_4168:{towgs84:"-170,33,326"},EPSG_4131:{towgs84:"199,931,318.9"},EPSG_4152:{towgs84:"-0.9102,2.0141,0.5602,0.029039,0.010065,0.010101,0"},EPSG_5228:{towgs84:"572.213,85.334,461.94,4.9732,1.529,5.2484,3.5378"},EPSG_8351:{towgs84:"485.021,169.465,483.839,7.786342,4.397554,4.102655,0"},EPSG_4683:{towgs84:"-127.62,-67.24,-47.04,-3.068,4.903,1.578,-1.06"},EPSG_4133:{towgs84:"0,0,0"},EPSG_7373:{towgs84:"0.819,-0.5762,-1.6446,-0.00378,-0.03317,0.00318,0.0693"},EPSG_9075:{towgs84:"-0.9102,2.0141,0.5602,0.029039,0.010065,0.010101,0"},EPSG_9072:{towgs84:"-0.9102,2.0141,0.5602,0.029039,0.010065,0.010101,0"},EPSG_9294:{towgs84:"1.16835,-1.42001,-2.24431,-0.00822,-0.05508,0.01818,0.23388"},EPSG_4212:{towgs84:"-267.434,173.496,181.814,-13.4704,8.7154,7.3926,14.7492"},EPSG_4191:{towgs84:"-44.183,-0.58,-38.489,2.3867,2.7072,-3.5196,-8.2703"},EPSG_4237:{towgs84:"52.684,-71.194,-13.975,-0.312,-0.1063,-0.3729,1.0191"},EPSG_4740:{towgs84:"-1.08,-0.27,-0.9"},EPSG_4124:{towgs84:"419.3836,99.3335,591.3451,0.850389,1.817277,-7.862238,-0.99496"},EPSG_5681:{towgs84:"584.9636,107.7175,413.8067,1.1155,0.2824,-3.1384,7.9922"},EPSG_4141:{towgs84:"23.772,17.49,17.859,-0.3132,-1.85274,1.67299,-5.4262"},EPSG_4204:{towgs84:"-85.645,-273.077,-79.708,2.289,-1.421,2.532,3.194"},EPSG_4319:{towgs84:"226.702,-193.337,-35.371,-2.229,-4.391,9.238,0.9798"},EPSG_4200:{towgs84:"24.82,-131.21,-82.66"},EPSG_4130:{towgs84:"0,0,0"},EPSG_4127:{towgs84:"-82.875,-57.097,-156.768,-2.158,1.524,-0.982,-0.359"},EPSG_4149:{towgs84:"674.374,15.056,405.346"},EPSG_4617:{towgs84:"-0.991,1.9072,0.5129,1.25033e-7,4.6785e-8,5.6529e-8,0"},EPSG_4663:{towgs84:"-210.502,-66.902,-48.476,2.094,-15.067,-5.817,0.485"},EPSG_4664:{towgs84:"-211.939,137.626,58.3,-0.089,0.251,0.079,0.384"},EPSG_4665:{towgs84:"-105.854,165.589,-38.312,-0.003,-0.026,0.024,-0.048"},EPSG_4666:{towgs84:"631.392,-66.551,481.442,1.09,-4.445,-4.487,-4.43"},EPSG_4756:{towgs84:"-192.873,-39.382,-111.202,-0.00205,-0.0005,0.00335,0.0188"},EPSG_4723:{towgs84:"-179.483,-69.379,-27.584,-7.862,8.163,6.042,-13.925"},EPSG_4726:{towgs84:"8.853,-52.644,180.304,-0.393,-2.323,2.96,-24.081"},EPSG_4267:{towgs84:"-8.0,160.0,176.0"},EPSG_5365:{towgs84:"-0.16959,0.35312,0.51846,0.03385,-0.16325,0.03446,0.03693"},EPSG_4218:{towgs84:"304.5,306.5,-318.1"},EPSG_4242:{towgs84:"-33.722,153.789,94.959,-8.581,-4.478,4.54,8.95"},EPSG_4216:{towgs84:"-292.295,248.758,429.447,4.9971,2.99,6.6906,1.0289"},ESRI_104105:{towgs84:"631.392,-66.551,481.442,1.09,-4.445,-4.487,-4.43"},ESRI_104129:{towgs84:"0,0,0"},EPSG_4673:{towgs84:"174.05,-25.49,112.57"},EPSG_4202:{towgs84:"-124,-60,154"},EPSG_4203:{towgs84:"-117.763,-51.51,139.061,0.292,0.443,0.277,-0.191"},EPSG_3819:{towgs84:"595.48,121.69,515.35,4.115,-2.9383,0.853,-3.408"},EPSG_8694:{towgs84:"-93.799,-132.737,-219.073,-1.844,0.648,-6.37,-0.169"},EPSG_4145:{towgs84:"275.57,676.78,229.6"},EPSG_4283:{towgs84:"61.55,-10.87,-40.19,39.4924,32.7221,32.8979,-9.994"},EPSG_4317:{towgs84:"2.3287,-147.0425,-92.0802,-0.3092483,0.32482185,0.49729934,5.68906266"},EPSG_4272:{towgs84:"59.47,-5.04,187.44,0.47,-0.1,1.024,-4.5993"},EPSG_4248:{towgs84:"-307.7,265.3,-363.5"},EPSG_5561:{towgs84:"24,-121,-76"},EPSG_5233:{towgs84:"-0.293,766.95,87.713,0.195704,1.695068,3.473016,-0.039338"},ESRI_104130:{towgs84:"-86,-98,-119"},ESRI_104102:{towgs84:"682,-203,480"},ESRI_37207:{towgs84:"7,-10,-26"},EPSG_4675:{towgs84:"59.935,118.4,-10.871"},ESRI_104109:{towgs84:"-89.121,-348.182,260.871"},ESRI_104112:{towgs84:"-185.583,-230.096,281.361"},ESRI_104113:{towgs84:"25.1,-275.6,222.6"},IGNF_WGS72G:{towgs84:"0,12,6"},IGNF_NTFG:{towgs84:"-168,-60,320"},IGNF_EFATE57G:{towgs84:"-127,-769,472"},IGNF_PGP50G:{towgs84:"324.8,153.6,172.1"},IGNF_REUN47G:{towgs84:"94,-948,-1262"},IGNF_CSG67G:{towgs84:"-186,230,110"},IGNF_GUAD48G:{towgs84:"-467,-16,-300"},IGNF_TAHI51G:{towgs84:"162,117,154"},IGNF_TAHAAG:{towgs84:"65,342,77"},IGNF_NUKU72G:{towgs84:"84,274,65"},IGNF_PETRELS72G:{towgs84:"365,194,166"},IGNF_WALL78G:{towgs84:"253,-133,-127"},IGNF_MAYO50G:{towgs84:"-382,-59,-262"},IGNF_TANNAG:{towgs84:"-139,-967,436"},IGNF_IGN72G:{towgs84:"-13,-348,292"},IGNF_ATIGG:{towgs84:"1118,23,66"},IGNF_FANGA84G:{towgs84:"150.57,158.33,118.32"},IGNF_RUSAT84G:{towgs84:"202.13,174.6,-15.74"},IGNF_KAUE70G:{towgs84:"126.74,300.1,-75.49"},IGNF_MOP90G:{towgs84:"-10.8,-1.8,12.77"},IGNF_MHPF67G:{towgs84:"338.08,212.58,-296.17"},IGNF_TAHI79G:{towgs84:"160.61,116.05,153.69"},IGNF_ANAA92G:{towgs84:"1.5,3.84,4.81"},IGNF_MARQUI72G:{towgs84:"330.91,-13.92,58.56"},IGNF_APAT86G:{towgs84:"143.6,197.82,74.05"},IGNF_TUBU69G:{towgs84:"237.17,171.61,-77.84"},IGNF_STPM50G:{towgs84:"11.363,424.148,373.13"},EPSG_4150:{towgs84:"674.374,15.056,405.346"},EPSG_4754:{towgs84:"-208.4058,-109.8777,-2.5764"},ESRI_104101:{towgs84:"374,150,588"},EPSG_4693:{towgs84:"0,-0.15,0.68"},EPSG_6207:{towgs84:"293.17,726.18,245.36"},EPSG_4153:{towgs84:"-133.63,-157.5,-158.62"},EPSG_4132:{towgs84:"-241.54,-163.64,396.06"},EPSG_4221:{towgs84:"-154.5,150.7,100.4"},EPSG_4266:{towgs84:"-80.7,-132.5,41.1"},EPSG_4193:{towgs84:"-70.9,-151.8,-41.4"},EPSG_5340:{towgs84:"-0.41,0.46,-0.35"},EPSG_4246:{towgs84:"-294.7,-200.1,525.5"},EPSG_4318:{towgs84:"-3.2,-5.7,2.8"},EPSG_4121:{towgs84:"-199.87,74.79,246.62"},EPSG_4223:{towgs84:"-260.1,5.5,432.2"},EPSG_4158:{towgs84:"-0.465,372.095,171.736"},EPSG_4285:{towgs84:"-128.16,-282.42,21.93"},EPSG_4613:{towgs84:"-404.78,685.68,45.47"},EPSG_4607:{towgs84:"195.671,332.517,274.607"},EPSG_4475:{towgs84:"-381.788,-57.501,-256.673"},EPSG_4208:{towgs84:"-157.84,308.54,-146.6"},EPSG_4743:{towgs84:"70.995,-335.916,262.898"},EPSG_4710:{towgs84:"-323.65,551.39,-491.22"},EPSG_7881:{towgs84:"-0.077,0.079,0.086"},EPSG_4682:{towgs84:"283.729,735.942,261.143"},EPSG_4739:{towgs84:"-156,-271,-189"},EPSG_4679:{towgs84:"-80.01,253.26,291.19"},EPSG_4750:{towgs84:"-56.263,16.136,-22.856"},EPSG_4644:{towgs84:"-10.18,-350.43,291.37"},EPSG_4695:{towgs84:"-103.746,-9.614,-255.95"},EPSG_4292:{towgs84:"-355,21,72"},EPSG_4302:{towgs84:"-61.702,284.488,472.052"},EPSG_4143:{towgs84:"-124.76,53,466.79"},EPSG_4606:{towgs84:"-153,153,307"},EPSG_4699:{towgs84:"-770.1,158.4,-498.2"},EPSG_4247:{towgs84:"-273.5,110.6,-357.9"},EPSG_4160:{towgs84:"8.88,184.86,106.69"},EPSG_4161:{towgs84:"-233.43,6.65,173.64"},EPSG_9251:{towgs84:"-9.5,122.9,138.2"},EPSG_9253:{towgs84:"-78.1,101.6,133.3"},EPSG_4297:{towgs84:"-198.383,-240.517,-107.909"},EPSG_4269:{towgs84:"0,0,0"},EPSG_4301:{towgs84:"-147,506,687"},EPSG_4618:{towgs84:"-59,-11,-52"},EPSG_4612:{towgs84:"0,0,0"},EPSG_4678:{towgs84:"44.585,-131.212,-39.544"},EPSG_4250:{towgs84:"-130,29,364"},EPSG_4144:{towgs84:"214,804,268"},EPSG_4147:{towgs84:"-17.51,-108.32,-62.39"},EPSG_4259:{towgs84:"-254.1,-5.36,-100.29"},EPSG_4164:{towgs84:"-76,-138,67"},EPSG_4211:{towgs84:"-378.873,676.002,-46.255"},EPSG_4182:{towgs84:"-422.651,-172.995,84.02"},EPSG_4224:{towgs84:"-143.87,243.37,-33.52"},EPSG_4225:{towgs84:"-205.57,168.77,-4.12"},EPSG_5527:{towgs84:"-67.35,3.88,-38.22"},EPSG_4752:{towgs84:"98,390,-22"},EPSG_4310:{towgs84:"-30,190,89"},EPSG_9248:{towgs84:"-192.26,65.72,132.08"},EPSG_4680:{towgs84:"124.5,-63.5,-281"},EPSG_4701:{towgs84:"-79.9,-158,-168.9"},EPSG_4706:{towgs84:"-146.21,112.63,4.05"},EPSG_4805:{towgs84:"682,-203,480"},EPSG_4201:{towgs84:"-165,-11,206"},EPSG_4210:{towgs84:"-157,-2,-299"},EPSG_4183:{towgs84:"-104,167,-38"},EPSG_4139:{towgs84:"11,72,-101"},EPSG_4668:{towgs84:"-86,-98,-119"},EPSG_4717:{towgs84:"-2,151,181"},EPSG_4732:{towgs84:"102,52,-38"},EPSG_4280:{towgs84:"-377,681,-50"},EPSG_4209:{towgs84:"-138,-105,-289"},EPSG_4261:{towgs84:"31,146,47"},EPSG_4658:{towgs84:"-73,46,-86"},EPSG_4721:{towgs84:"265.025,384.929,-194.046"},EPSG_4222:{towgs84:"-136,-108,-292"},EPSG_4601:{towgs84:"-255,-15,71"},EPSG_4602:{towgs84:"725,685,536"},EPSG_4603:{towgs84:"72,213.7,93"},EPSG_4605:{towgs84:"9,183,236"},EPSG_4621:{towgs84:"137,248,-430"},EPSG_4657:{towgs84:"-28,199,5"},EPSG_4316:{towgs84:"103.25,-100.4,-307.19"},EPSG_4642:{towgs84:"-13,-348,292"},EPSG_4698:{towgs84:"145,-187,103"},EPSG_4192:{towgs84:"-206.1,-174.7,-87.7"},EPSG_4311:{towgs84:"-265,120,-358"},EPSG_4135:{towgs84:"58,-283,-182"},ESRI_104138:{towgs84:"198,-226,-347"},EPSG_4245:{towgs84:"-11,851,5"},EPSG_4142:{towgs84:"-125,53,467"},EPSG_4213:{towgs84:"-106,-87,188"},EPSG_4253:{towgs84:"-133,-77,-51"},EPSG_4129:{towgs84:"-132,-110,-335"},EPSG_4713:{towgs84:"-77,-128,142"},EPSG_4239:{towgs84:"217,823,299"},EPSG_4146:{towgs84:"295,736,257"},EPSG_4155:{towgs84:"-83,37,124"},EPSG_4165:{towgs84:"-173,253,27"},EPSG_4672:{towgs84:"175,-38,113"},EPSG_4236:{towgs84:"-637,-549,-203"},EPSG_4251:{towgs84:"-90,40,88"},EPSG_4271:{towgs84:"-2,374,172"},EPSG_4175:{towgs84:"-88,4,101"},EPSG_4716:{towgs84:"298,-304,-375"},EPSG_4315:{towgs84:"-23,259,-9"},EPSG_4744:{towgs84:"-242.2,-144.9,370.3"},EPSG_4244:{towgs84:"-97,787,86"},EPSG_4293:{towgs84:"616,97,-251"},EPSG_4714:{towgs84:"-127,-769,472"},EPSG_4736:{towgs84:"260,12,-147"},EPSG_6883:{towgs84:"-235,-110,393"},EPSG_6894:{towgs84:"-63,176,185"},EPSG_4205:{towgs84:"-43,-163,45"},EPSG_4256:{towgs84:"41,-220,-134"},EPSG_4262:{towgs84:"639,405,60"},EPSG_4604:{towgs84:"174,359,365"},EPSG_4169:{towgs84:"-115,118,426"},EPSG_4620:{towgs84:"-106,-129,165"},EPSG_4184:{towgs84:"-203,141,53"},EPSG_4616:{towgs84:"-289,-124,60"},EPSG_9403:{towgs84:"-307,-92,127"},EPSG_4684:{towgs84:"-133,-321,50"},EPSG_4708:{towgs84:"-491,-22,435"},EPSG_4707:{towgs84:"114,-116,-333"},EPSG_4709:{towgs84:"145,75,-272"},EPSG_4712:{towgs84:"-205,107,53"},EPSG_4711:{towgs84:"124,-234,-25"},EPSG_4718:{towgs84:"230,-199,-752"},EPSG_4719:{towgs84:"211,147,111"},EPSG_4724:{towgs84:"208,-435,-229"},EPSG_4725:{towgs84:"189,-79,-202"},EPSG_4735:{towgs84:"647,1777,-1124"},EPSG_4722:{towgs84:"-794,119,-298"},EPSG_4728:{towgs84:"-307,-92,127"},EPSG_4734:{towgs84:"-632,438,-609"},EPSG_4727:{towgs84:"912,-58,1227"},EPSG_4729:{towgs84:"185,165,42"},EPSG_4730:{towgs84:"170,42,84"},EPSG_4733:{towgs84:"276,-57,149"},ESRI_37218:{towgs84:"230,-199,-752"},ESRI_37240:{towgs84:"-7,215,225"},ESRI_37221:{towgs84:"252,-209,-751"},ESRI_4305:{towgs84:"-123,-206,219"},ESRI_104139:{towgs84:"-73,-247,227"},EPSG_4748:{towgs84:"51,391,-36"},EPSG_4219:{towgs84:"-384,664,-48"},EPSG_4255:{towgs84:"-333,-222,114"},EPSG_4257:{towgs84:"-587.8,519.75,145.76"},EPSG_4646:{towgs84:"-963,510,-359"},EPSG_6881:{towgs84:"-24,-203,268"},EPSG_6882:{towgs84:"-183,-15,273"},EPSG_4715:{towgs84:"-104,-129,239"},IGNF_RGF93GDD:{towgs84:"0,0,0"},IGNF_RGM04GDD:{towgs84:"0,0,0"},IGNF_RGSPM06GDD:{towgs84:"0,0,0"},IGNF_RGTAAF07GDD:{towgs84:"0,0,0"},IGNF_RGFG95GDD:{towgs84:"0,0,0"},IGNF_RGNCG:{towgs84:"0,0,0"},IGNF_RGPFGDD:{towgs84:"0,0,0"},IGNF_ETRS89G:{towgs84:"0,0,0"},IGNF_RGR92GDD:{towgs84:"0,0,0"},EPSG_4173:{towgs84:"0,0,0"},EPSG_4180:{towgs84:"0,0,0"},EPSG_4619:{towgs84:"0,0,0"},EPSG_4667:{towgs84:"0,0,0"},EPSG_4075:{towgs84:"0,0,0"},EPSG_6706:{towgs84:"0,0,0"},EPSG_7798:{towgs84:"0,0,0"},EPSG_4661:{towgs84:"0,0,0"},EPSG_4669:{towgs84:"0,0,0"},EPSG_8685:{towgs84:"0,0,0"},EPSG_4151:{towgs84:"0,0,0"},EPSG_9702:{towgs84:"0,0,0"},EPSG_4758:{towgs84:"0,0,0"},EPSG_4761:{towgs84:"0,0,0"},EPSG_4765:{towgs84:"0,0,0"},EPSG_8997:{towgs84:"0,0,0"},EPSG_4023:{towgs84:"0,0,0"},EPSG_4670:{towgs84:"0,0,0"},EPSG_4694:{towgs84:"0,0,0"},EPSG_4148:{towgs84:"0,0,0"},EPSG_4163:{towgs84:"0,0,0"},EPSG_4167:{towgs84:"0,0,0"},EPSG_4189:{towgs84:"0,0,0"},EPSG_4190:{towgs84:"0,0,0"},EPSG_4176:{towgs84:"0,0,0"},EPSG_4659:{towgs84:"0,0,0"},EPSG_3824:{towgs84:"0,0,0"},EPSG_3889:{towgs84:"0,0,0"},EPSG_4046:{towgs84:"0,0,0"},EPSG_4081:{towgs84:"0,0,0"},EPSG_4558:{towgs84:"0,0,0"},EPSG_4483:{towgs84:"0,0,0"},EPSG_5013:{towgs84:"0,0,0"},EPSG_5264:{towgs84:"0,0,0"},EPSG_5324:{towgs84:"0,0,0"},EPSG_5354:{towgs84:"0,0,0"},EPSG_5371:{towgs84:"0,0,0"},EPSG_5373:{towgs84:"0,0,0"},EPSG_5381:{towgs84:"0,0,0"},EPSG_5393:{towgs84:"0,0,0"},EPSG_5489:{towgs84:"0,0,0"},EPSG_5593:{towgs84:"0,0,0"},EPSG_6135:{towgs84:"0,0,0"},EPSG_6365:{towgs84:"0,0,0"},EPSG_5246:{towgs84:"0,0,0"},EPSG_7886:{towgs84:"0,0,0"},EPSG_8431:{towgs84:"0,0,0"},EPSG_8427:{towgs84:"0,0,0"},EPSG_8699:{towgs84:"0,0,0"},EPSG_8818:{towgs84:"0,0,0"},EPSG_4757:{towgs84:"0,0,0"},EPSG_9140:{towgs84:"0,0,0"},EPSG_8086:{towgs84:"0,0,0"},EPSG_4686:{towgs84:"0,0,0"},EPSG_4737:{towgs84:"0,0,0"},EPSG_4702:{towgs84:"0,0,0"},EPSG_4747:{towgs84:"0,0,0"},EPSG_4749:{towgs84:"0,0,0"},EPSG_4674:{towgs84:"0,0,0"},EPSG_4755:{towgs84:"0,0,0"},EPSG_4759:{towgs84:"0,0,0"},EPSG_4762:{towgs84:"0,0,0"},EPSG_4763:{towgs84:"0,0,0"},EPSG_4764:{towgs84:"0,0,0"},EPSG_4166:{towgs84:"0,0,0"},EPSG_4170:{towgs84:"0,0,0"},EPSG_5546:{towgs84:"0,0,0"},EPSG_7844:{towgs84:"0,0,0"},EPSG_4818:{towgs84:"589,76,480"}};for(var fh in Ya){var Rs=Ya[fh];Rs.datumName&&(Ya[Rs.datumName]=Rs)}function gh(t,e,a,s,i,r,o){var n={};return t===void 0||t==="none"?n.datum_type=Js:n.datum_type=kd,e&&(n.datum_params=e.map(parseFloat),(n.datum_params[0]!==0||n.datum_params[1]!==0||n.datum_params[2]!==0)&&(n.datum_type=Ae),n.datum_params.length>3&&(n.datum_params[3]!==0||n.datum_params[4]!==0||n.datum_params[5]!==0||n.datum_params[6]!==0)&&(n.datum_type=ke,n.datum_params[3]*=ga,n.datum_params[4]*=ga,n.datum_params[5]*=ga,n.datum_params[6]=n.datum_params[6]/1e6+1)),o&&(n.datum_type=Ue,n.grids=o),n.a=a,n.b=s,n.es=i,n.ep2=r,n}var Gi={};function mh(t,e,a){return e instanceof ArrayBuffer?vh(t,e,a):{ready:yh(t,e)}}function vh(t,e,a){var s=!0;a!==void 0&&a.includeErrorFields===!1&&(s=!1);var i=new DataView(e),r=_h(i),o=wh(i,r),n=Mh(i,o,r,s),l={header:o,subgrids:n};return Gi[t]=l,l}async function yh(t,e){for(var a=[],s=await e.getImageCount(),i=s-1;i>=0;i--){var r=await e.getImage(i),o=await r.readRasters(),n=o,l=[r.getWidth(),r.getHeight()],c=r.getBoundingBox().map(Nr),h=[r.fileDirectory.ModelPixelScale[0],r.fileDirectory.ModelPixelScale[1]].map(Nr),d=c[0]+(l[0]-1)*h[0],u=c[3]-(l[1]-1)*h[1],f=n[0],p=n[1],m=[];for(let y=l[1]-1;y>=0;y--)for(let b=l[0]-1;b>=0;b--){var g=y*l[0]+b;m.push([-re(p[g]),re(f[g])])}a.push({del:h,lim:l,ll:[-d,u],cvs:m})}var v={header:{nSubgrids:s},subgrids:a};return Gi[t]=v,v}function bh(t){if(t===void 0)return null;var e=t.split(",");return e.map(xh)}function xh(t){if(t.length===0)return null;var e=t[0]==="@";return e&&(t=t.slice(1)),t==="null"?{name:"null",mandatory:!e,grid:null,isNull:!0}:{name:t,mandatory:!e,grid:Gi[t]||null,isNull:!1}}function Nr(t){return t*Math.PI/180}function re(t){return t/3600*Math.PI/180}function _h(t){var e=t.getInt32(8,!1);return e===11?!1:(e=t.getInt32(8,!0),e!==11&&console.warn("Failed to detect nadgrid endian-ness, defaulting to little-endian"),!0)}function wh(t,e){return{nFields:t.getInt32(8,e),nSubgridFields:t.getInt32(24,e),nSubgrids:t.getInt32(40,e),shiftType:Xs(t,56,64).trim(),fromSemiMajorAxis:t.getFloat64(120,e),fromSemiMinorAxis:t.getFloat64(136,e),toSemiMajorAxis:t.getFloat64(152,e),toSemiMinorAxis:t.getFloat64(168,e)}}function Xs(t,e,a){return String.fromCharCode.apply(null,new Uint8Array(t.buffer.slice(e,a)))}function Mh(t,e,a,s){for(var i=176,r=[],o=0;o<e.nSubgrids;o++){var n=Eh(t,i,a),l=Ah(t,i,n,a,s),c=Math.round(1+(n.upperLongitude-n.lowerLongitude)/n.longitudeInterval),h=Math.round(1+(n.upperLatitude-n.lowerLatitude)/n.latitudeInterval);r.push({ll:[re(n.lowerLongitude),re(n.lowerLatitude)],del:[re(n.longitudeInterval),re(n.latitudeInterval)],lim:[c,h],count:n.gridNodeCount,cvs:Sh(l)});var d=16;s===!1&&(d=8),i+=176+n.gridNodeCount*d}return r}function Sh(t){return t.map(function(e){return[re(e.longitudeShift),re(e.latitudeShift)]})}function Eh(t,e,a){return{name:Xs(t,e+8,e+16).trim(),parent:Xs(t,e+24,e+24+8).trim(),lowerLatitude:t.getFloat64(e+72,a),upperLatitude:t.getFloat64(e+88,a),lowerLongitude:t.getFloat64(e+104,a),upperLongitude:t.getFloat64(e+120,a),latitudeInterval:t.getFloat64(e+136,a),longitudeInterval:t.getFloat64(e+152,a),gridNodeCount:t.getInt32(e+168,a)}}function Ah(t,e,a,s,i){var r=e+176,o=16;i===!1&&(o=8);for(var n=[],l=0;l<a.gridNodeCount;l++){var c={latitudeShift:t.getFloat32(r+l*o,s),longitudeShift:t.getFloat32(r+l*o+4,s)};i!==!1&&(c.latitudeAccuracy=t.getFloat32(r+l*o+8,s),c.longitudeAccuracy=t.getFloat32(r+l*o+12,s)),n.push(c)}return n}function Dt(t,e){if(!(this instanceof Dt))return new Dt(t);this.forward=null,this.inverse=null,this.init=null,this.name,this.names=null,this.title,e=e||function(c){if(c)throw c};var a=Qd(t);if(typeof a!="object"){e("Could not parse to valid json: "+t);return}var s=Dt.projections.get(a.projName);if(!s){e("Could not get projection name from: "+t);return}if(a.datumCode&&a.datumCode!=="none"){var i=de(Ya,a.datumCode);i&&(a.datum_params=a.datum_params||(i.towgs84?i.towgs84.split(","):null),a.ellps=i.ellipse,a.datumName=i.datumName?i.datumName:a.datumCode)}a.k0=a.k0||1,a.axis=a.axis||"enu",a.ellps=a.ellps||"wgs84",a.lat1=a.lat1||a.lat0;var r=ph(a.a,a.b,a.rf,a.ellps,a.sphere),o=uh(r.a,r.b,r.rf,a.R_A),n=bh(a.nadgrids),l=a.datum||gh(a.datumCode,a.datum_params,r.a,r.b,o.es,o.ep2,n);Tr(this,a),Tr(this,s),this.a=r.a,this.b=r.b,this.rf=r.rf,this.sphere=r.sphere,this.es=o.es,this.e=o.e,this.ep2=o.ep2,this.datum=l,"init"in this&&typeof this.init=="function"&&this.init(),e(null,this)}Dt.projections=dh;Dt.projections.start();function kh(t,e){return t.datum_type!==e.datum_type||t.a!==e.a||Math.abs(t.es-e.es)>5e-11?!1:t.datum_type===Ae?t.datum_params[0]===e.datum_params[0]&&t.datum_params[1]===e.datum_params[1]&&t.datum_params[2]===e.datum_params[2]:t.datum_type===ke?t.datum_params[0]===e.datum_params[0]&&t.datum_params[1]===e.datum_params[1]&&t.datum_params[2]===e.datum_params[2]&&t.datum_params[3]===e.datum_params[3]&&t.datum_params[4]===e.datum_params[4]&&t.datum_params[5]===e.datum_params[5]&&t.datum_params[6]===e.datum_params[6]:!0}function go(t,e,a){var s=t.x,i=t.y,r=t.z?t.z:0,o,n,l,c;if(i<-L&&i>-1.001*L)i=-L;else if(i>L&&i<1.001*L)i=L;else{if(i<-L)return{x:-1/0,y:-1/0,z:t.z};if(i>L)return{x:1/0,y:1/0,z:t.z}}return s>Math.PI&&(s-=2*Math.PI),n=Math.sin(i),c=Math.cos(i),l=n*n,o=a/Math.sqrt(1-e*l),{x:(o+r)*c*Math.cos(s),y:(o+r)*c*Math.sin(s),z:(o*(1-e)+r)*n}}function mo(t,e,a,s){var i=1e-12,r=i*i,o=30,n,l,c,h,d,u,f,p,m,g,v,y,b,_=t.x,x=t.y,w=t.z?t.z:0,k,P,C;if(n=Math.sqrt(_*_+x*x),l=Math.sqrt(_*_+x*x+w*w),n/a<i){if(k=0,l/a<i)return P=L,C=-s,{x:t.x,y:t.y,z:t.z}}else k=Math.atan2(x,_);c=w/l,h=n/l,d=1/Math.sqrt(1-e*(2-e)*h*h),p=h*(1-e)*d,m=c*d,b=0;do b++,f=a/Math.sqrt(1-e*m*m),C=n*p+w*m-f*(1-e*m*m),u=e*f/(f+C),d=1/Math.sqrt(1-u*(2-u)*h*h),g=h*(1-u)*d,v=c*d,y=v*p-g*m,p=g,m=v;while(y*y>r&&b<o);return P=Math.atan(v/Math.abs(g)),{x:k,y:P,z:C}}function Ph(t,e,a){if(e===Ae)return{x:t.x+a[0],y:t.y+a[1],z:t.z+a[2]};if(e===ke){var s=a[0],i=a[1],r=a[2],o=a[3],n=a[4],l=a[5],c=a[6];return{x:c*(t.x-l*t.y+n*t.z)+s,y:c*(l*t.x+t.y-o*t.z)+i,z:c*(-n*t.x+o*t.y+t.z)+r}}}function $h(t,e,a){if(e===Ae)return{x:t.x-a[0],y:t.y-a[1],z:t.z-a[2]};if(e===ke){var s=a[0],i=a[1],r=a[2],o=a[3],n=a[4],l=a[5],c=a[6],h=(t.x-s)/c,d=(t.y-i)/c,u=(t.z-r)/c;return{x:h+l*d-n*u,y:-l*h+d+o*u,z:n*h-o*d+u}}}function ja(t){return t===Ae||t===ke}function Ch(t,e,a){if(kh(t,e)||t.datum_type===Js||e.datum_type===Js)return a;var s=t.a,i=t.es;if(t.datum_type===Ue){var r=Ir(t,!1,a);if(r!==0)return;s=Er,i=Ar}var o=e.a,n=e.b,l=e.es;if(e.datum_type===Ue&&(o=Er,n=Pd,l=Ar),i===l&&s===o&&!ja(t.datum_type)&&!ja(e.datum_type))return a;if(a=go(a,i,s),ja(t.datum_type)&&(a=Ph(a,t.datum_type,t.datum_params)),ja(e.datum_type)&&(a=$h(a,e.datum_type,e.datum_params)),a=mo(a,l,o,n),e.datum_type===Ue){var c=Ir(e,!0,a);if(c!==0)return}return a}function Ir(t,e,a){if(t.grids===null||t.grids.length===0)return console.log("Grid shift grids not found"),-1;var s={x:-a.x,y:a.y},i={x:Number.NaN,y:Number.NaN},r=[];t:for(var o=0;o<t.grids.length;o++){var n=t.grids[o];if(r.push(n.name),n.isNull){i=s;break}if(n.grid===null){if(n.mandatory)return console.log("Unable to find mandatory grid '"+n.name+"'"),-1;continue}for(var l=n.grid.subgrids,c=0,h=l.length;c<h;c++){var d=l[c],u=(Math.abs(d.del[1])+Math.abs(d.del[0]))/1e4,f=d.ll[0]-u,p=d.ll[1]-u,m=d.ll[0]+(d.lim[0]-1)*d.del[0]+u,g=d.ll[1]+(d.lim[1]-1)*d.del[1]+u;if(!(p>s.y||f>s.x||g<s.y||m<s.x)&&(i=Th(s,e,d),!isNaN(i.x)))break t}}return isNaN(i.x)?(console.log("Failed to find a grid shift table for location '"+-s.x*Et+" "+s.y*Et+" tried: '"+r+"'"),-1):(a.x=-i.x,a.y=i.y,0)}function Th(t,e,a){var s={x:Number.NaN,y:Number.NaN};if(isNaN(t.x))return s;var i={x:t.x,y:t.y};i.x-=a.ll[0],i.y-=a.ll[1],i.x=B(i.x-Math.PI)+Math.PI;var r=Gr(i,a);if(e){if(isNaN(r.x))return s;r.x=i.x-r.x,r.y=i.y-r.y;var o=9,n=1e-12,l,c;do{if(c=Gr(r,a),isNaN(c.x)){console.log("Inverse grid shift iteration failed, presumably at grid edge.  Using first approximation.");break}l={x:i.x-(c.x+r.x),y:i.y-(c.y+r.y)},r.x+=l.x,r.y+=l.y}while(o--&&Math.abs(l.x)>n&&Math.abs(l.y)>n);if(o<0)return console.log("Inverse grid shift iterator failed to converge."),s;s.x=B(r.x+a.ll[0]),s.y=r.y+a.ll[1]}else isNaN(r.x)||(s.x=t.x+r.x,s.y=t.y+r.y);return s}function Gr(t,e){var a={x:t.x/e.del[0],y:t.y/e.del[1]},s={x:Math.floor(a.x),y:Math.floor(a.y)},i={x:a.x-1*s.x,y:a.y-1*s.y},r={x:Number.NaN,y:Number.NaN},o;if(s.x<0||s.x>=e.lim[0]||s.y<0||s.y>=e.lim[1])return r;o=s.y*e.lim[0]+s.x;var n={x:e.cvs[o][0],y:e.cvs[o][1]};o++;var l={x:e.cvs[o][0],y:e.cvs[o][1]};o+=e.lim[0];var c={x:e.cvs[o][0],y:e.cvs[o][1]};o--;var h={x:e.cvs[o][0],y:e.cvs[o][1]},d=i.x*i.y,u=i.x*(1-i.y),f=(1-i.x)*(1-i.y),p=(1-i.x)*i.y;return r.x=f*n.x+u*l.x+p*h.x+d*c.x,r.y=f*n.y+u*l.y+p*h.y+d*c.y,r}function Rr(t,e,a){var s=a.x,i=a.y,r=a.z||0,o,n,l,c={};for(l=0;l<3;l++)if(!(e&&l===2&&a.z===void 0))switch(l===0?(o=s,"ew".indexOf(t.axis[l])!==-1?n="x":n="y"):l===1?(o=i,"ns".indexOf(t.axis[l])!==-1?n="y":n="x"):(o=r,n="z"),t.axis[l]){case"e":c[n]=o;break;case"w":c[n]=-o;break;case"n":c[n]=o;break;case"s":c[n]=-o;break;case"u":a[n]!==void 0&&(c.z=o);break;case"d":a[n]!==void 0&&(c.z=-o);break;default:return null}return c}function vo(t){var e={x:t[0],y:t[1]};return t.length>2&&(e.z=t[2]),t.length>3&&(e.m=t[3]),e}function Lh(t){Br(t.x),Br(t.y)}function Br(t){if(typeof Number.isFinite=="function"){if(Number.isFinite(t))return;throw new TypeError("coordinates must be finite numbers")}if(typeof t!="number"||t!==t||!isFinite(t))throw new TypeError("coordinates must be finite numbers")}function Nh(t,e){return(t.datum.datum_type===Ae||t.datum.datum_type===ke||t.datum.datum_type===Ue)&&e.datumCode!=="WGS84"||(e.datum.datum_type===Ae||e.datum.datum_type===ke||e.datum.datum_type===Ue)&&t.datumCode!=="WGS84"}function cs(t,e,a,s){var i;Array.isArray(a)?a=vo(a):a={x:a.x,y:a.y,z:a.z,m:a.m};var r=a.z!==void 0;if(Lh(a),t.datum&&e.datum&&Nh(t,e)&&(i=new Dt("WGS84"),a=cs(t,i,a,s),t=i),s&&t.axis!=="enu"&&(a=Rr(t,!1,a)),t.projName==="longlat")a={x:a.x*ut,y:a.y*ut,z:a.z||0};else if(t.to_meter&&(a={x:a.x*t.to_meter,y:a.y*t.to_meter,z:a.z||0}),a=t.inverse(a),!a)return;if(t.from_greenwich&&(a.x+=t.from_greenwich),a=Ch(t.datum,e.datum,a),!!a)return a=a,e.from_greenwich&&(a={x:a.x-e.from_greenwich,y:a.y,z:a.z||0}),e.projName==="longlat"?a={x:a.x*Et,y:a.y*Et,z:a.z||0}:(a=e.forward(a),e.to_meter&&(a={x:a.x/e.to_meter,y:a.y/e.to_meter,z:a.z||0})),s&&e.axis!=="enu"?Rr(e,!0,a):(a&&!r&&delete a.z,a)}var Dr=Dt("WGS84");function Bs(t,e,a,s){var i,r,o;return Array.isArray(a)?(i=cs(t,e,a,s)||{x:NaN,y:NaN},a.length>2?typeof t.name<"u"&&t.name==="geocent"||typeof e.name<"u"&&e.name==="geocent"?typeof i.z=="number"?[i.x,i.y,i.z].concat(a.slice(3)):[i.x,i.y,a[2]].concat(a.slice(3)):[i.x,i.y].concat(a.slice(2)):[i.x,i.y]):(r=cs(t,e,a,s),o=Object.keys(a),o.length===2||o.forEach(function(n){if(typeof t.name<"u"&&t.name==="geocent"||typeof e.name<"u"&&e.name==="geocent"){if(n==="x"||n==="y"||n==="z")return}else if(n==="x"||n==="y")return;r[n]=a[n]}),r)}function qa(t){return t instanceof Dt?t:typeof t=="object"&&"oProj"in t?t.oProj:Dt(t)}function Ih(t,e,a){var s,i,r=!1,o;return typeof e>"u"?(i=qa(t),s=Dr,r=!0):(typeof e.x<"u"||Array.isArray(e))&&(a=e,i=qa(t),s=Dr,r=!0),s||(s=qa(t)),i||(i=qa(e)),a?Bs(s,i,a):(o={forward:function(n,l){return Bs(s,i,n,l)},inverse:function(n,l){return Bs(i,s,n,l)}},r&&(o.oProj=i),o)}var Or=6,yo="AJSAJS",bo="AFAFAF",Oe=65,Mt=73,Gt=79,la=86,ca=90;const Gh={forward:xo,inverse:Rh,toPoint:_o};function xo(t,e){return e=e||5,Oh(Bh({lat:t[1],lon:t[0]}),e)}function Rh(t){var e=Ri(Mo(t.toUpperCase()));return e.lat&&e.lon?[e.lon,e.lat,e.lon,e.lat]:[e.left,e.bottom,e.right,e.top]}function _o(t){var e=Ri(Mo(t.toUpperCase()));return e.lat&&e.lon?[e.lon,e.lat]:[(e.left+e.right)/2,(e.top+e.bottom)/2]}function Ds(t){return t*(Math.PI/180)}function Fr(t){return 180*(t/Math.PI)}function Bh(t){var e=t.lat,a=t.lon,s=6378137,i=.00669438,r=.9996,o,n,l,c,h,d,u,f=Ds(e),p=Ds(a),m,g;g=Math.floor((a+180)/6)+1,a===180&&(g=60),e>=56&&e<64&&a>=3&&a<12&&(g=32),e>=72&&e<84&&(a>=0&&a<9?g=31:a>=9&&a<21?g=33:a>=21&&a<33?g=35:a>=33&&a<42&&(g=37)),o=(g-1)*6-180+3,m=Ds(o),n=i/(1-i),l=s/Math.sqrt(1-i*Math.sin(f)*Math.sin(f)),c=Math.tan(f)*Math.tan(f),h=n*Math.cos(f)*Math.cos(f),d=Math.cos(f)*(p-m),u=s*((1-i/4-3*i*i/64-5*i*i*i/256)*f-(3*i/8+3*i*i/32+45*i*i*i/1024)*Math.sin(2*f)+(15*i*i/256+45*i*i*i/1024)*Math.sin(4*f)-35*i*i*i/3072*Math.sin(6*f));var v=r*l*(d+(1-c+h)*d*d*d/6+(5-18*c+c*c+72*h-58*n)*d*d*d*d*d/120)+5e5,y=r*(u+l*Math.tan(f)*(d*d/2+(5-c+9*h+4*h*h)*d*d*d*d/24+(61-58*c+c*c+600*h-330*n)*d*d*d*d*d*d/720));return e<0&&(y+=1e7),{northing:Math.round(y),easting:Math.round(v),zoneNumber:g,zoneLetter:Dh(e)}}function Ri(t){var e=t.northing,a=t.easting,s=t.zoneLetter,i=t.zoneNumber;if(i<0||i>60)return null;var r=.9996,o=6378137,n=.00669438,l,c=(1-Math.sqrt(1-n))/(1+Math.sqrt(1-n)),h,d,u,f,p,m,g,v,y,b=a-5e5,_=e;s<"N"&&(_-=1e7),g=(i-1)*6-180+3,l=n/(1-n),m=_/r,v=m/(o*(1-n/4-3*n*n/64-5*n*n*n/256)),y=v+(3*c/2-27*c*c*c/32)*Math.sin(2*v)+(21*c*c/16-55*c*c*c*c/32)*Math.sin(4*v)+151*c*c*c/96*Math.sin(6*v),h=o/Math.sqrt(1-n*Math.sin(y)*Math.sin(y)),d=Math.tan(y)*Math.tan(y),u=l*Math.cos(y)*Math.cos(y),f=o*(1-n)/Math.pow(1-n*Math.sin(y)*Math.sin(y),1.5),p=b/(h*r);var x=y-h*Math.tan(y)/f*(p*p/2-(5+3*d+10*u-4*u*u-9*l)*p*p*p*p/24+(61+90*d+298*u+45*d*d-252*l-3*u*u)*p*p*p*p*p*p/720);x=Fr(x);var w=(p-(1+2*d+u)*p*p*p/6+(5-2*u+28*d-3*u*u+8*l+24*d*d)*p*p*p*p*p/120)/Math.cos(y);w=g+Fr(w);var k;if(t.accuracy){var P=Ri({northing:t.northing+t.accuracy,easting:t.easting+t.accuracy,zoneLetter:t.zoneLetter,zoneNumber:t.zoneNumber});k={top:P.lat,right:P.lon,bottom:x,left:w}}else k={lat:x,lon:w};return k}function Dh(t){var e="Z";return 84>=t&&t>=72?e="X":72>t&&t>=64?e="W":64>t&&t>=56?e="V":56>t&&t>=48?e="U":48>t&&t>=40?e="T":40>t&&t>=32?e="S":32>t&&t>=24?e="R":24>t&&t>=16?e="Q":16>t&&t>=8?e="P":8>t&&t>=0?e="N":0>t&&t>=-8?e="M":-8>t&&t>=-16?e="L":-16>t&&t>=-24?e="K":-24>t&&t>=-32?e="J":-32>t&&t>=-40?e="H":-40>t&&t>=-48?e="G":-48>t&&t>=-56?e="F":-56>t&&t>=-64?e="E":-64>t&&t>=-72?e="D":-72>t&&t>=-80&&(e="C"),e}function Oh(t,e){var a="00000"+t.easting,s="00000"+t.northing;return t.zoneNumber+t.zoneLetter+Fh(t.easting,t.northing,t.zoneNumber)+a.substr(a.length-5,e)+s.substr(s.length-5,e)}function Fh(t,e,a){var s=wo(a),i=Math.floor(t/1e5),r=Math.floor(e/1e5)%20;return zh(i,r,s)}function wo(t){var e=t%Or;return e===0&&(e=Or),e}function zh(t,e,a){var s=a-1,i=yo.charCodeAt(s),r=bo.charCodeAt(s),o=i+t-1,n=r+e,l=!1;o>ca&&(o=o-ca+Oe-1,l=!0),(o===Mt||i<Mt&&o>Mt||(o>Mt||i<Mt)&&l)&&o++,(o===Gt||i<Gt&&o>Gt||(o>Gt||i<Gt)&&l)&&(o++,o===Mt&&o++),o>ca&&(o=o-ca+Oe-1),n>la?(n=n-la+Oe-1,l=!0):l=!1,(n===Mt||r<Mt&&n>Mt||(n>Mt||r<Mt)&&l)&&n++,(n===Gt||r<Gt&&n>Gt||(n>Gt||r<Gt)&&l)&&(n++,n===Mt&&n++),n>la&&(n=n-la+Oe-1);var c=String.fromCharCode(o)+String.fromCharCode(n);return c}function Mo(t){if(t&&t.length===0)throw"MGRSPoint coverting from nothing";for(var e=t.length,a=null,s="",i,r=0;!/[A-Z]/.test(i=t.charAt(r));){if(r>=2)throw"MGRSPoint bad conversion from: "+t;s+=i,r++}var o=parseInt(s,10);if(r===0||r+3>e)throw"MGRSPoint bad conversion from: "+t;var n=t.charAt(r++);if(n<="A"||n==="B"||n==="Y"||n>="Z"||n==="I"||n==="O")throw"MGRSPoint zone letter "+n+" not handled: "+t;a=t.substring(r,r+=2);for(var l=wo(o),c=jh(a.charAt(0),l),h=qh(a.charAt(1),l);h<Hh(n);)h+=2e6;var d=e-r;if(d%2!==0)throw`MGRSPoint has to have an even number 
of digits after the zone letter and two 100km letters - front 
half for easting meters, second half for 
northing meters`+t;var u=d/2,f=0,p=0,m,g,v,y,b;return u>0&&(m=1e5/Math.pow(10,u),g=t.substring(r,r+u),f=parseFloat(g)*m,v=t.substring(r+u),p=parseFloat(v)*m),y=f+c,b=p+h,{easting:y,northing:b,zoneLetter:n,zoneNumber:o,accuracy:m}}function jh(t,e){for(var a=yo.charCodeAt(e-1),s=1e5,i=!1;a!==t.charCodeAt(0);){if(a++,a===Mt&&a++,a===Gt&&a++,a>ca){if(i)throw"Bad character: "+t;a=Oe,i=!0}s+=1e5}return s}function qh(t,e){if(t>"V")throw"MGRSPoint given invalid Northing "+t;for(var a=bo.charCodeAt(e-1),s=0,i=!1;a!==t.charCodeAt(0);){if(a++,a===Mt&&a++,a===Gt&&a++,a>la){if(i)throw"Bad character: "+t;a=Oe,i=!0}s+=1e5}return s}function Hh(t){var e;switch(t){case"C":e=11e5;break;case"D":e=2e6;break;case"E":e=28e5;break;case"F":e=37e5;break;case"G":e=46e5;break;case"H":e=55e5;break;case"J":e=64e5;break;case"K":e=73e5;break;case"L":e=82e5;break;case"M":e=91e5;break;case"N":e=0;break;case"P":e=8e5;break;case"Q":e=17e5;break;case"R":e=26e5;break;case"S":e=35e5;break;case"T":e=44e5;break;case"U":e=53e5;break;case"V":e=62e5;break;case"W":e=7e6;break;case"X":e=79e5;break;default:e=-1}if(e>=0)return e;throw"Invalid zone letter: "+t}function Xe(t,e,a){if(!(this instanceof Xe))return new Xe(t,e,a);if(Array.isArray(t))this.x=t[0],this.y=t[1],this.z=t[2]||0;else if(typeof t=="object")this.x=t.x,this.y=t.y,this.z=t.z||0;else if(typeof t=="string"&&typeof e>"u"){var s=t.split(",");this.x=parseFloat(s[0]),this.y=parseFloat(s[1]),this.z=parseFloat(s[2])||0}else this.x=t,this.y=e,this.z=a||0;console.warn("proj4.Point will be removed in version 3, use proj4.toPoint")}Xe.fromMGRS=function(t){return new Xe(_o(t))};Xe.prototype.toMGRS=function(t){return xo([this.x,this.y],t)};var Uh=1,Vh=.25,zr=.046875,jr=.01953125,qr=.01068115234375,Wh=.75,Kh=.46875,Yh=.013020833333333334,Jh=.007120768229166667,Zh=.3645833333333333,Xh=.005696614583333333,Qh=.3076171875;function Bi(t){var e=[];e[0]=Uh-t*(Vh+t*(zr+t*(jr+t*qr))),e[1]=t*(Wh-t*(zr+t*(jr+t*qr)));var a=t*t;return e[2]=a*(Kh-t*(Yh+t*Jh)),a*=t,e[3]=a*(Zh-t*Xh),e[4]=a*t*Qh,e}function aa(t,e,a,s){return a*=e,e*=e,s[0]*t-a*(s[1]+e*(s[2]+e*(s[3]+e*s[4])))}var tu=20;function Di(t,e,a){for(var s=1/(1-e),i=t,r=tu;r;--r){var o=Math.sin(i),n=1-e*o*o;if(n=(aa(i,o,Math.cos(i),a)-t)*(n*Math.sqrt(n))*s,i-=n,Math.abs(n)<G)return i}return i}function eu(){this.x0=this.x0!==void 0?this.x0:0,this.y0=this.y0!==void 0?this.y0:0,this.long0=this.long0!==void 0?this.long0:0,this.lat0=this.lat0!==void 0?this.lat0:0,this.es&&(this.en=Bi(this.es),this.ml0=aa(this.lat0,Math.sin(this.lat0),Math.cos(this.lat0),this.en))}function au(t){var e=t.x,a=t.y,s=B(e-this.long0,this.over),i,r,o,n=Math.sin(a),l=Math.cos(a);if(this.es){var h=l*s,d=Math.pow(h,2),u=this.ep2*Math.pow(l,2),f=Math.pow(u,2),p=Math.abs(l)>G?Math.tan(a):0,m=Math.pow(p,2),g=Math.pow(m,2);i=1-this.es*Math.pow(n,2),h=h/Math.sqrt(i);var v=aa(a,n,l,this.en);r=this.a*(this.k0*h*(1+d/6*(1-m+u+d/20*(5-18*m+g+14*u-58*m*u+d/42*(61+179*g-g*m-479*m)))))+this.x0,o=this.a*(this.k0*(v-this.ml0+n*s*h/2*(1+d/12*(5-m+9*u+4*f+d/30*(61+g-58*m+270*u-330*m*u+d/56*(1385+543*g-g*m-3111*m))))))+this.y0}else{var c=l*Math.sin(s);if(Math.abs(Math.abs(c)-1)<G)return 93;if(r=.5*this.a*this.k0*Math.log((1+c)/(1-c))+this.x0,o=l*Math.cos(s)/Math.sqrt(1-Math.pow(c,2)),c=Math.abs(o),c>=1){if(c-1>G)return 93;o=0}else o=Math.acos(o);a<0&&(o=-o),o=this.a*this.k0*(o-this.lat0)+this.y0}return t.x=r,t.y=o,t}function su(t){var e,a,s,i,r=(t.x-this.x0)*(1/this.a),o=(t.y-this.y0)*(1/this.a);if(this.es)if(e=this.ml0+o/this.k0,a=Di(e,this.es,this.en),Math.abs(a)<L){var d=Math.sin(a),u=Math.cos(a),f=Math.abs(u)>G?Math.tan(a):0,p=this.ep2*Math.pow(u,2),m=Math.pow(p,2),g=Math.pow(f,2),v=Math.pow(g,2);e=1-this.es*Math.pow(d,2);var y=r*Math.sqrt(e)/this.k0,b=Math.pow(y,2);e=e*f,s=a-e*b/(1-this.es)*.5*(1-b/12*(5+3*g-9*p*g+p-4*m-b/30*(61+90*g-252*p*g+45*v+46*p-b/56*(1385+3633*g+4095*v+1574*v*g)))),i=B(this.long0+y*(1-b/6*(1+2*g+p-b/20*(5+28*g+24*v+8*p*g+6*p-b/42*(61+662*g+1320*v+720*v*g))))/u,this.over)}else s=L*La(o),i=0;else{var n=Math.exp(r/this.k0),l=.5*(n-1/n),c=this.lat0+o/this.k0,h=Math.cos(c);e=Math.sqrt((1-Math.pow(h,2))/(1+Math.pow(l,2))),s=Math.asin(e),o<0&&(s=-s),l===0&&h===0?i=0:i=B(Math.atan2(l,h)+this.long0,this.over)}return t.x=i,t.y=s,t}var iu=["Fast_Transverse_Mercator","Fast Transverse Mercator"];const Ja={init:eu,forward:au,inverse:su,names:iu};function So(t){var e=Math.exp(t);return e=(e-1/e)/2,e}function St(t,e){t=Math.abs(t),e=Math.abs(e);var a=Math.max(t,e),s=Math.min(t,e)/(a||1);return a*Math.sqrt(1+Math.pow(s,2))}function ru(t){var e=1+t,a=e-1;return a===0?t:t*Math.log(e)/a}function nu(t){var e=Math.abs(t);return e=ru(e*(1+e/(St(1,e)+1))),t<0?-e:e}function Oi(t,e){for(var a=2*Math.cos(2*e),s=t.length-1,i=t[s],r=0,o;--s>=0;)o=-r+a*i+t[s],r=i,i=o;return e+o*Math.sin(2*e)}function ou(t,e){for(var a=2*Math.cos(e),s=t.length-1,i=t[s],r=0,o;--s>=0;)o=-r+a*i+t[s],r=i,i=o;return Math.sin(e)*o}function lu(t){var e=Math.exp(t);return e=(e+1/e)/2,e}function Eo(t,e,a){for(var s=Math.sin(e),i=Math.cos(e),r=So(a),o=lu(a),n=2*i*o,l=-2*s*r,c=t.length-1,h=t[c],d=0,u=0,f=0,p,m;--c>=0;)p=u,m=d,u=h,d=f,h=-p+n*u-l*d+t[c],f=-m+l*u+n*d;return n=s*o,l=i*r,[n*h-l*f,n*f+l*h]}function cu(){if(!this.approx&&(isNaN(this.es)||this.es<=0))throw new Error('Incorrect elliptical usage. Try using the +approx option in the proj string, or PROJECTION["Fast_Transverse_Mercator"] in the WKT.');this.approx&&(Ja.init.apply(this),this.forward=Ja.forward,this.inverse=Ja.inverse),this.x0=this.x0!==void 0?this.x0:0,this.y0=this.y0!==void 0?this.y0:0,this.long0=this.long0!==void 0?this.long0:0,this.lat0=this.lat0!==void 0?this.lat0:0,this.cgb=[],this.cbg=[],this.utg=[],this.gtu=[];var t=this.es/(1+Math.sqrt(1-this.es)),e=t/(2-t),a=e;this.cgb[0]=e*(2+e*(-2/3+e*(-2+e*(116/45+e*(26/45+e*(-2854/675)))))),this.cbg[0]=e*(-2+e*(2/3+e*(4/3+e*(-82/45+e*(32/45+e*(4642/4725)))))),a=a*e,this.cgb[1]=a*(7/3+e*(-8/5+e*(-227/45+e*(2704/315+e*(2323/945))))),this.cbg[1]=a*(5/3+e*(-16/15+e*(-13/9+e*(904/315+e*(-1522/945))))),a=a*e,this.cgb[2]=a*(56/15+e*(-136/35+e*(-1262/105+e*(73814/2835)))),this.cbg[2]=a*(-26/15+e*(34/21+e*(8/5+e*(-12686/2835)))),a=a*e,this.cgb[3]=a*(4279/630+e*(-332/35+e*(-399572/14175))),this.cbg[3]=a*(1237/630+e*(-12/5+e*(-24832/14175))),a=a*e,this.cgb[4]=a*(4174/315+e*(-144838/6237)),this.cbg[4]=a*(-734/315+e*(109598/31185)),a=a*e,this.cgb[5]=a*(601676/22275),this.cbg[5]=a*(444337/155925),a=Math.pow(e,2),this.Qn=this.k0/(1+e)*(1+a*(1/4+a*(1/64+a/256))),this.utg[0]=e*(-.5+e*(2/3+e*(-37/96+e*(1/360+e*(81/512+e*(-96199/604800)))))),this.gtu[0]=e*(.5+e*(-2/3+e*(5/16+e*(41/180+e*(-127/288+e*(7891/37800)))))),this.utg[1]=a*(-1/48+e*(-1/15+e*(437/1440+e*(-46/105+e*(1118711/3870720))))),this.gtu[1]=a*(13/48+e*(-3/5+e*(557/1440+e*(281/630+e*(-1983433/1935360))))),a=a*e,this.utg[2]=a*(-17/480+e*(37/840+e*(209/4480+e*(-5569/90720)))),this.gtu[2]=a*(61/240+e*(-103/140+e*(15061/26880+e*(167603/181440)))),a=a*e,this.utg[3]=a*(-4397/161280+e*(11/504+e*(830251/7257600))),this.gtu[3]=a*(49561/161280+e*(-179/168+e*(6601661/7257600))),a=a*e,this.utg[4]=a*(-4583/161280+e*(108847/3991680)),this.gtu[4]=a*(34729/80640+e*(-3418889/1995840)),a=a*e,this.utg[5]=a*(-20648693/638668800),this.gtu[5]=a*(212378941/319334400);var s=Oi(this.cbg,this.lat0);this.Zb=-this.Qn*(s+ou(this.gtu,2*s))}function du(t){var e=B(t.x-this.long0,this.over),a=t.y;a=Oi(this.cbg,a);var s=Math.sin(a),i=Math.cos(a),r=Math.sin(e),o=Math.cos(e);a=Math.atan2(s,o*i),e=Math.atan2(r*i,St(s,i*o)),e=nu(Math.tan(e));var n=Eo(this.gtu,2*a,2*e);a=a+n[0],e=e+n[1];var l,c;return Math.abs(e)<=2.623395162778?(l=this.a*(this.Qn*e)+this.x0,c=this.a*(this.Qn*a+this.Zb)+this.y0):(l=1/0,c=1/0),t.x=l,t.y=c,t}function hu(t){var e=(t.x-this.x0)*(1/this.a),a=(t.y-this.y0)*(1/this.a);a=(a-this.Zb)/this.Qn,e=e/this.Qn;var s,i;if(Math.abs(e)<=2.623395162778){var r=Eo(this.utg,2*a,2*e);a=a+r[0],e=e+r[1],e=Math.atan(So(e));var o=Math.sin(a),n=Math.cos(a),l=Math.sin(e),c=Math.cos(e);a=Math.atan2(o*c,St(l,c*n)),e=Math.atan2(l,c*n),s=B(e+this.long0,this.over),i=Oi(this.cgb,a)}else s=1/0,i=1/0;return t.x=s,t.y=i,t}var uu=["Extended_Transverse_Mercator","Extended Transverse Mercator","etmerc","Transverse_Mercator","Transverse Mercator","Gauss Kruger","Gauss_Kruger","tmerc"];const Za={init:cu,forward:du,inverse:hu,names:uu};function pu(t,e){if(t===void 0){if(t=Math.floor((B(e)+Math.PI)*30/Math.PI)+1,t<0)return 0;if(t>60)return 60}return t}var fu="etmerc";function gu(){var t=pu(this.zone,this.long0);if(t===void 0)throw new Error("unknown utm zone");this.lat0=0,this.long0=(6*Math.abs(t)-183)*ut,this.x0=5e5,this.y0=this.utmSouth?1e7:0,this.k0=.9996,Za.init.apply(this),this.forward=Za.forward,this.inverse=Za.inverse}var mu=["Universal Transverse Mercator System","utm"];const vu={init:gu,names:mu,dependsOn:fu};function Fi(t,e){return Math.pow((1-t)/(1+t),e)}var yu=20;function bu(){var t=Math.sin(this.lat0),e=Math.cos(this.lat0);e*=e,this.rc=Math.sqrt(1-this.es)/(1-this.es*t*t),this.C=Math.sqrt(1+this.es*e*e/(1-this.es)),this.phic0=Math.asin(t/this.C),this.ratexp=.5*this.C*this.e,this.K=Math.tan(.5*this.phic0+Q)/(Math.pow(Math.tan(.5*this.lat0+Q),this.C)*Fi(this.e*t,this.ratexp))}function xu(t){var e=t.x,a=t.y;return t.y=2*Math.atan(this.K*Math.pow(Math.tan(.5*a+Q),this.C)*Fi(this.e*Math.sin(a),this.ratexp))-L,t.x=this.C*e,t}function _u(t){for(var e=1e-14,a=t.x/this.C,s=t.y,i=Math.pow(Math.tan(.5*s+Q)/this.K,1/this.C),r=yu;r>0&&(s=2*Math.atan(i*Fi(this.e*Math.sin(t.y),-.5*this.e))-L,!(Math.abs(s-t.y)<e));--r)t.y=s;return r?(t.x=a,t.y=s,t):null}const zi={init:bu,forward:xu,inverse:_u};function wu(){zi.init.apply(this),this.rc&&(this.sinc0=Math.sin(this.phic0),this.cosc0=Math.cos(this.phic0),this.R2=2*this.rc,this.title||(this.title="Oblique Stereographic Alternative"))}function Mu(t){var e,a,s,i;return t.x=B(t.x-this.long0,this.over),zi.forward.apply(this,[t]),e=Math.sin(t.y),a=Math.cos(t.y),s=Math.cos(t.x),i=this.k0*this.R2/(1+this.sinc0*e+this.cosc0*a*s),t.x=i*a*Math.sin(t.x),t.y=i*(this.cosc0*e-this.sinc0*a*s),t.x=this.a*t.x+this.x0,t.y=this.a*t.y+this.y0,t}function Su(t){var e,a,s,i,r;if(t.x=(t.x-this.x0)/this.a,t.y=(t.y-this.y0)/this.a,t.x/=this.k0,t.y/=this.k0,r=St(t.x,t.y)){var o=2*Math.atan2(r,this.R2);e=Math.sin(o),a=Math.cos(o),i=Math.asin(a*this.sinc0+t.y*e*this.cosc0/r),s=Math.atan2(t.x*e,r*this.cosc0*a-t.y*this.sinc0*e)}else i=this.phic0,s=0;return t.x=s,t.y=i,zi.inverse.apply(this,[t]),t.x=B(t.x+this.long0,this.over),t}var Eu=["Stereographic_North_Pole","Oblique_Stereographic","sterea","Oblique Stereographic Alternative","Double_Stereographic"];const Au={init:wu,forward:Mu,inverse:Su,names:Eu};function ji(t,e,a){return e*=a,Math.tan(.5*(L+t))*Math.pow((1-e)/(1+e),.5*a)}function ku(){this.x0=this.x0||0,this.y0=this.y0||0,this.lat0=this.lat0||0,this.long0=this.long0||0,this.coslat0=Math.cos(this.lat0),this.sinlat0=Math.sin(this.lat0),this.sphere?this.k0===1&&!isNaN(this.lat_ts)&&Math.abs(this.coslat0)<=G&&(this.k0=.5*(1+La(this.lat0)*Math.sin(this.lat_ts))):(Math.abs(this.coslat0)<=G&&(this.lat0>0?this.con=1:this.con=-1),this.cons=Math.sqrt(Math.pow(1+this.e,1+this.e)*Math.pow(1-this.e,1-this.e)),this.k0===1&&!isNaN(this.lat_ts)&&Math.abs(this.coslat0)<=G&&Math.abs(Math.cos(this.lat_ts))>G&&(this.k0=.5*this.cons*Wt(this.e,Math.sin(this.lat_ts),Math.cos(this.lat_ts))/Ft(this.e,this.con*this.lat_ts,this.con*Math.sin(this.lat_ts))),this.ms1=Wt(this.e,this.sinlat0,this.coslat0),this.X0=2*Math.atan(ji(this.lat0,this.sinlat0,this.e))-L,this.cosX0=Math.cos(this.X0),this.sinX0=Math.sin(this.X0))}function Pu(t){var e=t.x,a=t.y,s=Math.sin(a),i=Math.cos(a),r,o,n,l,c,h,d=B(e-this.long0,this.over);return Math.abs(Math.abs(e-this.long0)-Math.PI)<=G&&Math.abs(a+this.lat0)<=G?(t.x=NaN,t.y=NaN,t):this.sphere?(r=2*this.k0/(1+this.sinlat0*s+this.coslat0*i*Math.cos(d)),t.x=this.a*r*i*Math.sin(d)+this.x0,t.y=this.a*r*(this.coslat0*s-this.sinlat0*i*Math.cos(d))+this.y0,t):(o=2*Math.atan(ji(a,s,this.e))-L,l=Math.cos(o),n=Math.sin(o),Math.abs(this.coslat0)<=G?(c=Ft(this.e,a*this.con,this.con*s),h=2*this.a*this.k0*c/this.cons,t.x=this.x0+h*Math.sin(e-this.long0),t.y=this.y0-this.con*h*Math.cos(e-this.long0),t):(Math.abs(this.sinlat0)<G?(r=2*this.a*this.k0/(1+l*Math.cos(d)),t.y=r*n):(r=2*this.a*this.k0*this.ms1/(this.cosX0*(1+this.sinX0*n+this.cosX0*l*Math.cos(d))),t.y=r*(this.cosX0*n-this.sinX0*l*Math.cos(d))+this.y0),t.x=r*l*Math.sin(d)+this.x0,t))}function $u(t){t.x-=this.x0,t.y-=this.y0;var e,a,s,i,r,o=Math.sqrt(t.x*t.x+t.y*t.y);if(this.sphere){var n=2*Math.atan(o/(2*this.a*this.k0));return e=this.long0,a=this.lat0,o<=G?(t.x=e,t.y=a,t):(a=Math.asin(Math.cos(n)*this.sinlat0+t.y*Math.sin(n)*this.coslat0/o),Math.abs(this.coslat0)<G?this.lat0>0?e=B(this.long0+Math.atan2(t.x,-1*t.y),this.over):e=B(this.long0+Math.atan2(t.x,t.y),this.over):e=B(this.long0+Math.atan2(t.x*Math.sin(n),o*this.coslat0*Math.cos(n)-t.y*this.sinlat0*Math.sin(n)),this.over),t.x=e,t.y=a,t)}else if(Math.abs(this.coslat0)<=G){if(o<=G)return a=this.lat0,e=this.long0,t.x=e,t.y=a,t;t.x*=this.con,t.y*=this.con,s=o*this.cons/(2*this.a*this.k0),a=this.con*Ea(this.e,s),e=this.con*B(this.con*this.long0+Math.atan2(t.x,-1*t.y),this.over)}else i=2*Math.atan(o*this.cosX0/(2*this.a*this.k0*this.ms1)),e=this.long0,o<=G?r=this.X0:(r=Math.asin(Math.cos(i)*this.sinX0+t.y*Math.sin(i)*this.cosX0/o),e=B(this.long0+Math.atan2(t.x*Math.sin(i),o*this.cosX0*Math.cos(i)-t.y*this.sinX0*Math.sin(i)),this.over)),a=-1*Ea(this.e,Math.tan(.5*(L+r)));return t.x=e,t.y=a,t}var Cu=["stere","Stereographic_South_Pole","Polar_Stereographic_variant_A","Polar_Stereographic_variant_B","Polar_Stereographic"];const Tu={init:ku,forward:Pu,inverse:$u,names:Cu,ssfn_:ji};function Lu(){var t=this.lat0;this.lambda0=this.long0;var e=Math.sin(t),a=this.a,s=this.rf,i=1/s,r=2*i-Math.pow(i,2),o=this.e=Math.sqrt(r);this.R=this.k0*a*Math.sqrt(1-r)/(1-r*Math.pow(e,2)),this.alpha=Math.sqrt(1+r/(1-r)*Math.pow(Math.cos(t),4)),this.b0=Math.asin(e/this.alpha);var n=Math.log(Math.tan(Math.PI/4+this.b0/2)),l=Math.log(Math.tan(Math.PI/4+t/2)),c=Math.log((1+o*e)/(1-o*e));this.K=n-this.alpha*l+this.alpha*o/2*c}function Nu(t){var e=Math.log(Math.tan(Math.PI/4-t.y/2)),a=this.e/2*Math.log((1+this.e*Math.sin(t.y))/(1-this.e*Math.sin(t.y))),s=-this.alpha*(e+a)+this.K,i=2*(Math.atan(Math.exp(s))-Math.PI/4),r=this.alpha*(t.x-this.lambda0),o=Math.atan(Math.sin(r)/(Math.sin(this.b0)*Math.tan(i)+Math.cos(this.b0)*Math.cos(r))),n=Math.asin(Math.cos(this.b0)*Math.sin(i)-Math.sin(this.b0)*Math.cos(i)*Math.cos(r));return t.y=this.R/2*Math.log((1+Math.sin(n))/(1-Math.sin(n)))+this.y0,t.x=this.R*o+this.x0,t}function Iu(t){for(var e=t.x-this.x0,a=t.y-this.y0,s=e/this.R,i=2*(Math.atan(Math.exp(a/this.R))-Math.PI/4),r=Math.asin(Math.cos(this.b0)*Math.sin(i)+Math.sin(this.b0)*Math.cos(i)*Math.cos(s)),o=Math.atan(Math.sin(s)/(Math.cos(this.b0)*Math.cos(s)-Math.sin(this.b0)*Math.tan(i))),n=this.lambda0+o/this.alpha,l=0,c=r,h=-1e3,d=0;Math.abs(c-h)>1e-7;){if(++d>20)return;l=1/this.alpha*(Math.log(Math.tan(Math.PI/4+r/2))-this.K)+this.e*Math.log(Math.tan(Math.PI/4+Math.asin(this.e*Math.sin(c))/2)),h=c,c=2*Math.atan(Math.exp(l))-Math.PI/2}return t.x=n,t.y=c,t}var Gu=["somerc"];const Ru={init:Lu,forward:Nu,inverse:Iu,names:Gu};var Ie=1e-7;function Bu(t){var e=["Hotine_Oblique_Mercator","Hotine_Oblique_Mercator_variant_A","Hotine_Oblique_Mercator_Azimuth_Natural_Origin"],a=typeof t.projName=="object"?Object.keys(t.projName)[0]:t.projName;return"no_uoff"in t||"no_off"in t||e.indexOf(a)!==-1||e.indexOf(po(a))!==-1}function Du(){var t,e,a,s,i,r,o,n,l,c,h=0,d,u=0,f=0,p=0,m=0,g=0,v=0;this.no_off=Bu(this),this.no_rot="no_rot"in this;var y=!1;"alpha"in this&&(y=!0);var b=!1;if("rectified_grid_angle"in this&&(b=!0),y&&(v=this.alpha),b&&(h=this.rectified_grid_angle),y||b)u=this.longc;else if(f=this.long1,m=this.lat1,p=this.long2,g=this.lat2,Math.abs(m-g)<=Ie||(t=Math.abs(m))<=Ie||Math.abs(t-L)<=Ie||Math.abs(Math.abs(this.lat0)-L)<=Ie||Math.abs(Math.abs(g)-L)<=Ie)throw new Error;var _=1-this.es;e=Math.sqrt(_),Math.abs(this.lat0)>G?(n=Math.sin(this.lat0),a=Math.cos(this.lat0),t=1-this.es*n*n,this.B=a*a,this.B=Math.sqrt(1+this.es*this.B*this.B/_),this.A=this.B*this.k0*e/t,s=this.B*e/(a*Math.sqrt(t)),i=s*s-1,i<=0?i=0:(i=Math.sqrt(i),this.lat0<0&&(i=-i)),this.E=i+=s,this.E*=Math.pow(Ft(this.e,this.lat0,n),this.B)):(this.B=1/e,this.A=this.k0,this.E=s=i=1),y||b?(y?(d=Math.asin(Math.sin(v)/s),b||(h=v)):(d=h,v=Math.asin(s*Math.sin(d))),this.lam0=u-Math.asin(.5*(i-1/i)*Math.tan(d))/this.B):(r=Math.pow(Ft(this.e,m,Math.sin(m)),this.B),o=Math.pow(Ft(this.e,g,Math.sin(g)),this.B),i=this.E/r,l=(o-r)/(o+r),c=this.E*this.E,c=(c-o*r)/(c+o*r),t=f-p,t<-Math.PI?p-=Ma:t>Math.PI&&(p+=Ma),this.lam0=B(.5*(f+p)-Math.atan(c*Math.tan(.5*this.B*(f-p))/l)/this.B,this.over),d=Math.atan(2*Math.sin(this.B*B(f-this.lam0,this.over))/(i-1/i)),h=v=Math.asin(s*Math.sin(d))),this.singam=Math.sin(d),this.cosgam=Math.cos(d),this.sinrot=Math.sin(h),this.cosrot=Math.cos(h),this.rB=1/this.B,this.ArB=this.A*this.rB,this.BrA=1/this.ArB,this.no_off?this.u_0=0:(this.u_0=Math.abs(this.ArB*Math.atan(Math.sqrt(s*s-1)/Math.cos(v))),this.lat0<0&&(this.u_0=-this.u_0)),i=.5*d,this.v_pole_n=this.ArB*Math.log(Math.tan(Q-i)),this.v_pole_s=this.ArB*Math.log(Math.tan(Q+i))}function Ou(t){var e={},a,s,i,r,o,n,l,c;if(t.x=t.x-this.lam0,Math.abs(Math.abs(t.y)-L)>G){if(o=this.E/Math.pow(Ft(this.e,t.y,Math.sin(t.y)),this.B),n=1/o,a=.5*(o-n),s=.5*(o+n),r=Math.sin(this.B*t.x),i=(a*this.singam-r*this.cosgam)/s,Math.abs(Math.abs(i)-1)<G)throw new Error;c=.5*this.ArB*Math.log((1-i)/(1+i)),n=Math.cos(this.B*t.x),Math.abs(n)<Ie?l=this.A*t.x:l=this.ArB*Math.atan2(a*this.cosgam+r*this.singam,n)}else c=t.y>0?this.v_pole_n:this.v_pole_s,l=this.ArB*t.y;return this.no_rot?(e.x=l,e.y=c):(l-=this.u_0,e.x=c*this.cosrot+l*this.sinrot,e.y=l*this.cosrot-c*this.sinrot),e.x=this.a*e.x+this.x0,e.y=this.a*e.y+this.y0,e}function Fu(t){var e,a,s,i,r,o,n,l={};if(t.x=(t.x-this.x0)*(1/this.a),t.y=(t.y-this.y0)*(1/this.a),this.no_rot?(a=t.y,e=t.x):(a=t.x*this.cosrot-t.y*this.sinrot,e=t.y*this.cosrot+t.x*this.sinrot+this.u_0),s=Math.exp(-this.BrA*a),i=.5*(s-1/s),r=.5*(s+1/s),o=Math.sin(this.BrA*e),n=(o*this.cosgam+i*this.singam)/r,Math.abs(Math.abs(n)-1)<G)l.x=0,l.y=n<0?-L:L;else{if(l.y=this.E/Math.sqrt((1+n)/(1-n)),l.y=Ea(this.e,Math.pow(l.y,1/this.B)),l.y===1/0)throw new Error;l.x=-this.rB*Math.atan2(i*this.cosgam-o*this.singam,Math.cos(this.BrA*e))}return l.x+=this.lam0,l}var zu=["Hotine_Oblique_Mercator","Hotine Oblique Mercator","Hotine_Oblique_Mercator_variant_A","Hotine_Oblique_Mercator_Variant_B","Hotine_Oblique_Mercator_Azimuth_Natural_Origin","Hotine_Oblique_Mercator_Two_Point_Natural_Origin","Hotine_Oblique_Mercator_Azimuth_Center","Oblique_Mercator","omerc"];const ju={init:Du,forward:Ou,inverse:Fu,names:zu};function qu(){if(this.lat2||(this.lat2=this.lat1),this.k0||(this.k0=1),this.x0=this.x0||0,this.y0=this.y0||0,!(Math.abs(this.lat1+this.lat2)<G)){var t=this.b/this.a;this.e=Math.sqrt(1-t*t);var e=Math.sin(this.lat1),a=Math.cos(this.lat1),s=Wt(this.e,e,a),i=Ft(this.e,this.lat1,e),r=Math.sin(this.lat2),o=Math.cos(this.lat2),n=Wt(this.e,r,o),l=Ft(this.e,this.lat2,r),c=Math.abs(Math.abs(this.lat0)-L)<G?0:Ft(this.e,this.lat0,Math.sin(this.lat0));Math.abs(this.lat1-this.lat2)>G?this.ns=Math.log(s/n)/Math.log(i/l):this.ns=e,isNaN(this.ns)&&(this.ns=e),this.f0=s/(this.ns*Math.pow(i,this.ns)),this.rh=this.a*this.f0*Math.pow(c,this.ns),this.title||(this.title="Lambert Conformal Conic")}}function Hu(t){var e=t.x,a=t.y;Math.abs(2*Math.abs(a)-Math.PI)<=G&&(a=La(a)*(L-2*G));var s=Math.abs(Math.abs(a)-L),i,r;if(s>G)i=Ft(this.e,a,Math.sin(a)),r=this.a*this.f0*Math.pow(i,this.ns);else{if(s=a*this.ns,s<=0)return null;r=0}var o=this.ns*B(e-this.long0,this.over);return t.x=this.k0*(r*Math.sin(o))+this.x0,t.y=this.k0*(this.rh-r*Math.cos(o))+this.y0,t}function Uu(t){var e,a,s,i,r,o=(t.x-this.x0)/this.k0,n=this.rh-(t.y-this.y0)/this.k0;this.ns>0?(e=Math.sqrt(o*o+n*n),a=1):(e=-Math.sqrt(o*o+n*n),a=-1);var l=0;if(e!==0&&(l=Math.atan2(a*o,a*n)),e!==0||this.ns>0){if(a=1/this.ns,s=Math.pow(e/(this.a*this.f0),a),i=Ea(this.e,s),i===-9999)return null}else i=-L;return r=B(l/this.ns+this.long0,this.over),t.x=r,t.y=i,t}var Vu=["Lambert Tangential Conformal Conic Projection","Lambert_Conformal_Conic","Lambert_Conformal_Conic_1SP","Lambert_Conformal_Conic_2SP","lcc","Lambert Conic Conformal (1SP)","Lambert Conic Conformal (2SP)"];const Wu={init:qu,forward:Hu,inverse:Uu,names:Vu};function Ku(){this.a=6377397155e-3,this.es=.006674372230614,this.e=Math.sqrt(this.es),this.lat0||(this.lat0=.863937979737193),this.long0||(this.long0=.7417649320975901-.308341501185665),this.k0||(this.k0=.9999),this.s45=.785398163397448,this.s90=2*this.s45,this.fi0=this.lat0,this.e2=this.es,this.e=Math.sqrt(this.e2),this.alfa=Math.sqrt(1+this.e2*Math.pow(Math.cos(this.fi0),4)/(1-this.e2)),this.uq=1.04216856380474,this.u0=Math.asin(Math.sin(this.fi0)/this.alfa),this.g=Math.pow((1+this.e*Math.sin(this.fi0))/(1-this.e*Math.sin(this.fi0)),this.alfa*this.e/2),this.k=Math.tan(this.u0/2+this.s45)/Math.pow(Math.tan(this.fi0/2+this.s45),this.alfa)*this.g,this.k1=this.k0,this.n0=this.a*Math.sqrt(1-this.e2)/(1-this.e2*Math.pow(Math.sin(this.fi0),2)),this.s0=1.37008346281555,this.n=Math.sin(this.s0),this.ro0=this.k1*this.n0/Math.tan(this.s0),this.ad=this.s90-this.uq}function Yu(t){var e,a,s,i,r,o,n,l=t.x,c=t.y,h=B(l-this.long0,this.over);return e=Math.pow((1+this.e*Math.sin(c))/(1-this.e*Math.sin(c)),this.alfa*this.e/2),a=2*(Math.atan(this.k*Math.pow(Math.tan(c/2+this.s45),this.alfa)/e)-this.s45),s=-h*this.alfa,i=Math.asin(Math.cos(this.ad)*Math.sin(a)+Math.sin(this.ad)*Math.cos(a)*Math.cos(s)),r=Math.asin(Math.cos(a)*Math.sin(s)/Math.cos(i)),o=this.n*r,n=this.ro0*Math.pow(Math.tan(this.s0/2+this.s45),this.n)/Math.pow(Math.tan(i/2+this.s45),this.n),t.y=n*Math.cos(o)/1,t.x=n*Math.sin(o)/1,this.czech||(t.y*=-1,t.x*=-1),t}function Ju(t){var e,a,s,i,r,o,n,l,c=t.x;t.x=t.y,t.y=c,this.czech||(t.y*=-1,t.x*=-1),o=Math.sqrt(t.x*t.x+t.y*t.y),r=Math.atan2(t.y,t.x),i=r/Math.sin(this.s0),s=2*(Math.atan(Math.pow(this.ro0/o,1/this.n)*Math.tan(this.s0/2+this.s45))-this.s45),e=Math.asin(Math.cos(this.ad)*Math.sin(s)-Math.sin(this.ad)*Math.cos(s)*Math.cos(i)),a=Math.asin(Math.cos(s)*Math.sin(i)/Math.cos(e)),t.x=this.long0-a/this.alfa,n=e,l=0;var h=0;do t.y=2*(Math.atan(Math.pow(this.k,-1/this.alfa)*Math.pow(Math.tan(e/2+this.s45),1/this.alfa)*Math.pow((1+this.e*Math.sin(n))/(1-this.e*Math.sin(n)),this.e/2))-this.s45),Math.abs(n-t.y)<1e-10&&(l=1),n=t.y,h+=1;while(l===0&&h<15);return h>=15?null:t}var Zu=["Krovak","krovak"];const Xu={init:Ku,forward:Yu,inverse:Ju,names:Zu};function wt(t,e,a,s,i){return t*i-e*Math.sin(2*i)+a*Math.sin(4*i)-s*Math.sin(6*i)}function Na(t){return 1-.25*t*(1+t/16*(3+1.25*t))}function Ia(t){return .375*t*(1+.25*t*(1+.46875*t))}function Ga(t){return .05859375*t*t*(1+.75*t)}function Ra(t){return t*t*t*(35/3072)}function qi(t,e,a){var s=e*a;return t/Math.sqrt(1-s*s)}function pe(t){return Math.abs(t)<L?t:t-La(t)*Math.PI}function ds(t,e,a,s,i){var r,o;r=t/e;for(var n=0;n<15;n++)if(o=(t-(e*r-a*Math.sin(2*r)+s*Math.sin(4*r)-i*Math.sin(6*r)))/(e-2*a*Math.cos(2*r)+4*s*Math.cos(4*r)-6*i*Math.cos(6*r)),r+=o,Math.abs(o)<=1e-10)return r;return NaN}function Qu(){this.sphere||(this.e0=Na(this.es),this.e1=Ia(this.es),this.e2=Ga(this.es),this.e3=Ra(this.es),this.ml0=this.a*wt(this.e0,this.e1,this.e2,this.e3,this.lat0))}function tp(t){var e,a,s=t.x,i=t.y;if(s=B(s-this.long0,this.over),this.sphere)e=this.a*Math.asin(Math.cos(i)*Math.sin(s)),a=this.a*(Math.atan2(Math.tan(i),Math.cos(s))-this.lat0);else{var r=Math.sin(i),o=Math.cos(i),n=qi(this.a,this.e,r),l=Math.tan(i)*Math.tan(i),c=s*Math.cos(i),h=c*c,d=this.es*o*o/(1-this.es),u=this.a*wt(this.e0,this.e1,this.e2,this.e3,i);e=n*c*(1-h*l*(1/6-(8-l+8*d)*h/120)),a=u-this.ml0+n*r/o*h*(.5+(5-l+6*d)*h/24)}return t.x=e+this.x0,t.y=a+this.y0,t}function ep(t){t.x-=this.x0,t.y-=this.y0;var e=t.x/this.a,a=t.y/this.a,s,i;if(this.sphere){var r=a+this.lat0;s=Math.asin(Math.sin(r)*Math.cos(e)),i=Math.atan2(Math.tan(e),Math.cos(r))}else{var o=this.ml0/this.a+a,n=ds(o,this.e0,this.e1,this.e2,this.e3);if(Math.abs(Math.abs(n)-L)<=G)return t.x=this.long0,t.y=L,a<0&&(t.y*=-1),t;var l=qi(this.a,this.e,Math.sin(n)),c=l*l*l/this.a/this.a*(1-this.es),h=Math.pow(Math.tan(n),2),d=e*this.a/l,u=d*d;s=n-l*Math.tan(n)/c*d*d*(.5-(1+3*h)*d*d/24),i=d*(1-u*(h/3+(1+3*h)*h*u/15))/Math.cos(n)}return t.x=B(i+this.long0,this.over),t.y=pe(s),t}var ap=["Cassini","Cassini_Soldner","cass"];const sp={init:Qu,forward:tp,inverse:ep,names:ap};function oe(t,e){var a;return t>1e-7?(a=t*e,(1-t*t)*(e/(1-a*a)-.5/t*Math.log((1-a)/(1+a)))):2*e}var Qs=1,ti=2,ei=3,Xa=4;function ip(){var t=Math.abs(this.lat0);if(Math.abs(t-L)<G?this.mode=this.lat0<0?Qs:ti:Math.abs(t)<G?this.mode=ei:this.mode=Xa,this.es>0){var e;switch(this.qp=oe(this.e,1),this.mmf=.5/(1-this.es),this.apa=pp(this.es),this.mode){case ti:this.dd=1;break;case Qs:this.dd=1;break;case ei:this.rq=Math.sqrt(.5*this.qp),this.dd=1/this.rq,this.xmf=1,this.ymf=.5*this.qp;break;case Xa:this.rq=Math.sqrt(.5*this.qp),e=Math.sin(this.lat0),this.sinb1=oe(this.e,e)/this.qp,this.cosb1=Math.sqrt(1-this.sinb1*this.sinb1),this.dd=Math.cos(this.lat0)/(Math.sqrt(1-this.es*e*e)*this.rq*this.cosb1),this.ymf=(this.xmf=this.rq)/this.dd,this.xmf*=this.dd;break}}else this.mode===Xa&&(this.sinph0=Math.sin(this.lat0),this.cosph0=Math.cos(this.lat0))}function rp(t){var e,a,s,i,r,o,n,l,c,h,d=t.x,u=t.y;if(d=B(d-this.long0,this.over),this.sphere){if(r=Math.sin(u),h=Math.cos(u),s=Math.cos(d),this.mode===this.OBLIQ||this.mode===this.EQUIT){if(a=this.mode===this.EQUIT?1+h*s:1+this.sinph0*r+this.cosph0*h*s,a<=G)return null;a=Math.sqrt(2/a),e=a*h*Math.sin(d),a*=this.mode===this.EQUIT?r:this.cosph0*r-this.sinph0*h*s}else if(this.mode===this.N_POLE||this.mode===this.S_POLE){if(this.mode===this.N_POLE&&(s=-s),Math.abs(u+this.lat0)<G)return null;a=Q-u*.5,a=2*(this.mode===this.S_POLE?Math.cos(a):Math.sin(a)),e=a*Math.sin(d),a*=s}}else{switch(n=0,l=0,c=0,s=Math.cos(d),i=Math.sin(d),r=Math.sin(u),o=oe(this.e,r),(this.mode===this.OBLIQ||this.mode===this.EQUIT)&&(n=o/this.qp,l=Math.sqrt(1-n*n)),this.mode){case this.OBLIQ:c=1+this.sinb1*n+this.cosb1*l*s;break;case this.EQUIT:c=1+l*s;break;case this.N_POLE:c=L+u,o=this.qp-o;break;case this.S_POLE:c=u-L,o=this.qp+o;break}if(Math.abs(c)<G)return null;switch(this.mode){case this.OBLIQ:case this.EQUIT:c=Math.sqrt(2/c),this.mode===this.OBLIQ?a=this.ymf*c*(this.cosb1*n-this.sinb1*l*s):a=(c=Math.sqrt(2/(1+l*s)))*n*this.ymf,e=this.xmf*c*l*i;break;case this.N_POLE:case this.S_POLE:o>=0?(e=(c=Math.sqrt(o))*i,a=s*(this.mode===this.S_POLE?c:-c)):e=a=0;break}}return t.x=this.a*e+this.x0,t.y=this.a*a+this.y0,t}function np(t){t.x-=this.x0,t.y-=this.y0;var e=t.x/this.a,a=t.y/this.a,s,i,r,o,n,l,c;if(this.sphere){var h=0,d,u=0;if(d=Math.sqrt(e*e+a*a),i=d*.5,i>1)return null;switch(i=2*Math.asin(i),(this.mode===this.OBLIQ||this.mode===this.EQUIT)&&(u=Math.sin(i),h=Math.cos(i)),this.mode){case this.EQUIT:i=Math.abs(d)<=G?0:Math.asin(a*u/d),e*=u,a=h*d;break;case this.OBLIQ:i=Math.abs(d)<=G?this.lat0:Math.asin(h*this.sinph0+a*u*this.cosph0/d),e*=u*this.cosph0,a=(h-Math.sin(i)*this.sinph0)*d;break;case this.N_POLE:a=-a,i=L-i;break;case this.S_POLE:i-=L;break}s=a===0&&(this.mode===this.EQUIT||this.mode===this.OBLIQ)?0:Math.atan2(e,a)}else{if(c=0,this.mode===this.OBLIQ||this.mode===this.EQUIT){if(e/=this.dd,a*=this.dd,l=Math.sqrt(e*e+a*a),l<G)return t.x=this.long0,t.y=this.lat0,t;o=2*Math.asin(.5*l/this.rq),r=Math.cos(o),e*=o=Math.sin(o),this.mode===this.OBLIQ?(c=r*this.sinb1+a*o*this.cosb1/l,n=this.qp*c,a=l*this.cosb1*r-a*this.sinb1*o):(c=a*o/l,n=this.qp*c,a=l*r)}else if(this.mode===this.N_POLE||this.mode===this.S_POLE){if(this.mode===this.N_POLE&&(a=-a),n=e*e+a*a,!n)return t.x=this.long0,t.y=this.lat0,t;c=1-n/this.qp,this.mode===this.S_POLE&&(c=-c)}s=Math.atan2(e,a),i=fp(Math.asin(c),this.apa)}return t.x=B(this.long0+s,this.over),t.y=i,t}var op=.3333333333333333,lp=.17222222222222222,cp=.10257936507936508,dp=.06388888888888888,hp=.0664021164021164,up=.016415012942191543;function pp(t){var e,a=[];return a[0]=t*op,e=t*t,a[0]+=e*lp,a[1]=e*dp,e*=t,a[0]+=e*cp,a[1]+=e*hp,a[2]=e*up,a}function fp(t,e){var a=t+t;return t+e[0]*Math.sin(a)+e[1]*Math.sin(a+a)+e[2]*Math.sin(a+a+a)}var gp=["Lambert Azimuthal Equal Area","Lambert_Azimuthal_Equal_Area","laea"];const mp={init:ip,forward:rp,inverse:np,names:gp,S_POLE:Qs,N_POLE:ti,EQUIT:ei,OBLIQ:Xa};function he(t){return Math.abs(t)>1&&(t=t>1?1:-1),Math.asin(t)}function vp(){Math.abs(this.lat1+this.lat2)<G||(this.temp=this.b/this.a,this.es=1-Math.pow(this.temp,2),this.e3=Math.sqrt(this.es),this.sin_po=Math.sin(this.lat1),this.cos_po=Math.cos(this.lat1),this.t1=this.sin_po,this.con=this.sin_po,this.ms1=Wt(this.e3,this.sin_po,this.cos_po),this.qs1=oe(this.e3,this.sin_po),this.sin_po=Math.sin(this.lat2),this.cos_po=Math.cos(this.lat2),this.t2=this.sin_po,this.ms2=Wt(this.e3,this.sin_po,this.cos_po),this.qs2=oe(this.e3,this.sin_po),this.sin_po=Math.sin(this.lat0),this.cos_po=Math.cos(this.lat0),this.t3=this.sin_po,this.qs0=oe(this.e3,this.sin_po),Math.abs(this.lat1-this.lat2)>G?this.ns0=(this.ms1*this.ms1-this.ms2*this.ms2)/(this.qs2-this.qs1):this.ns0=this.con,this.c=this.ms1*this.ms1+this.ns0*this.qs1,this.rh=this.a*Math.sqrt(this.c-this.ns0*this.qs0)/this.ns0)}function yp(t){var e=t.x,a=t.y;this.sin_phi=Math.sin(a),this.cos_phi=Math.cos(a);var s=oe(this.e3,this.sin_phi),i=this.a*Math.sqrt(this.c-this.ns0*s)/this.ns0,r=this.ns0*B(e-this.long0,this.over),o=i*Math.sin(r)+this.x0,n=this.rh-i*Math.cos(r)+this.y0;return t.x=o,t.y=n,t}function bp(t){var e,a,s,i,r,o;return t.x-=this.x0,t.y=this.rh-t.y+this.y0,this.ns0>=0?(e=Math.sqrt(t.x*t.x+t.y*t.y),s=1):(e=-Math.sqrt(t.x*t.x+t.y*t.y),s=-1),i=0,e!==0&&(i=Math.atan2(s*t.x,s*t.y)),s=e*this.ns0/this.a,this.sphere?o=Math.asin((this.c-s*s)/(2*this.ns0)):(a=(this.c-s*s)/this.ns0,o=this.phi1z(this.e3,a)),r=B(i/this.ns0+this.long0,this.over),t.x=r,t.y=o,t}function xp(t,e){var a,s,i,r,o,n=he(.5*e);if(t<G)return n;for(var l=t*t,c=1;c<=25;c++)if(a=Math.sin(n),s=Math.cos(n),i=t*a,r=1-i*i,o=.5*r*r/s*(e/(1-l)-a/r+.5/t*Math.log((1-i)/(1+i))),n=n+o,Math.abs(o)<=1e-7)return n;return null}var _p=["Albers_Conic_Equal_Area","Albers_Equal_Area","Albers","aea"];const wp={init:vp,forward:yp,inverse:bp,names:_p,phi1z:xp};function Mp(){this.sin_p14=Math.sin(this.lat0),this.cos_p14=Math.cos(this.lat0),this.infinity_dist=1e3*this.a,this.rc=1}function Sp(t){var e,a,s,i,r,o,n,l,c=t.x,h=t.y;return s=B(c-this.long0,this.over),e=Math.sin(h),a=Math.cos(h),i=Math.cos(s),o=this.sin_p14*e+this.cos_p14*a*i,r=1,o>0||Math.abs(o)<=G?(n=this.x0+this.a*r*a*Math.sin(s)/o,l=this.y0+this.a*r*(this.cos_p14*e-this.sin_p14*a*i)/o):(n=this.x0+this.infinity_dist*a*Math.sin(s),l=this.y0+this.infinity_dist*(this.cos_p14*e-this.sin_p14*a*i)),t.x=n,t.y=l,t}function Ep(t){var e,a,s,i,r,o;return t.x=(t.x-this.x0)/this.a,t.y=(t.y-this.y0)/this.a,t.x/=this.k0,t.y/=this.k0,(e=Math.sqrt(t.x*t.x+t.y*t.y))?(i=Math.atan2(e,this.rc),a=Math.sin(i),s=Math.cos(i),o=he(s*this.sin_p14+t.y*a*this.cos_p14/e),r=Math.atan2(t.x*a,e*this.cos_p14*s-t.y*this.sin_p14*a),r=B(this.long0+r,this.over)):(o=this.phic0,r=0),t.x=r,t.y=o,t}var Ap=["gnom"];const kp={init:Mp,forward:Sp,inverse:Ep,names:Ap};function Pp(t,e){var a=1-(1-t*t)/(2*t)*Math.log((1-t)/(1+t));if(Math.abs(Math.abs(e)-a)<1e-6)return e<0?-1*L:L;for(var s=Math.asin(.5*e),i,r,o,n,l=0;l<30;l++)if(r=Math.sin(s),o=Math.cos(s),n=t*r,i=Math.pow(1-n*n,2)/(2*o)*(e/(1-t*t)-r/(1-n*n)+.5/t*Math.log((1-n)/(1+n))),s+=i,Math.abs(i)<=1e-10)return s;return NaN}function $p(){this.sphere||(this.k0=Wt(this.e,Math.sin(this.lat_ts),Math.cos(this.lat_ts)))}function Cp(t){var e=t.x,a=t.y,s,i,r=B(e-this.long0,this.over);if(this.sphere)s=this.x0+this.a*r*Math.cos(this.lat_ts),i=this.y0+this.a*Math.sin(a)/Math.cos(this.lat_ts);else{var o=oe(this.e,Math.sin(a));s=this.x0+this.a*this.k0*r,i=this.y0+this.a*o*.5/this.k0}return t.x=s,t.y=i,t}function Tp(t){t.x-=this.x0,t.y-=this.y0;var e,a;return this.sphere?(e=B(this.long0+t.x/this.a/Math.cos(this.lat_ts),this.over),a=Math.asin(t.y/this.a*Math.cos(this.lat_ts))):(a=Pp(this.e,2*t.y*this.k0/this.a),e=B(this.long0+t.x/(this.a*this.k0),this.over)),t.x=e,t.y=a,t}var Lp=["cea"];const Np={init:$p,forward:Cp,inverse:Tp,names:Lp};function Ip(){this.x0=this.x0||0,this.y0=this.y0||0,this.lat0=this.lat0||0,this.long0=this.long0||0,this.lat_ts=this.lat_ts||0,this.title=this.title||"Equidistant Cylindrical (Plate Carre)",this.rc=Math.cos(this.lat_ts)}function Gp(t){var e=t.x,a=t.y,s=B(e-this.long0,this.over),i=pe(a-this.lat0);return t.x=this.x0+this.a*s*this.rc,t.y=this.y0+this.a*i,t}function Rp(t){var e=t.x,a=t.y;return t.x=B(this.long0+(e-this.x0)/(this.a*this.rc),this.over),t.y=pe(this.lat0+(a-this.y0)/this.a),t}var Bp=["Equirectangular","Equidistant_Cylindrical","Equidistant_Cylindrical_Spherical","eqc"];const Dp={init:Ip,forward:Gp,inverse:Rp,names:Bp};var Hr=20;function Op(){this.temp=this.b/this.a,this.es=1-Math.pow(this.temp,2),this.e=Math.sqrt(this.es),this.e0=Na(this.es),this.e1=Ia(this.es),this.e2=Ga(this.es),this.e3=Ra(this.es),this.ml0=this.a*wt(this.e0,this.e1,this.e2,this.e3,this.lat0)}function Fp(t){var e=t.x,a=t.y,s,i,r,o=B(e-this.long0,this.over);if(r=o*Math.sin(a),this.sphere)Math.abs(a)<=G?(s=this.a*o,i=-1*this.a*this.lat0):(s=this.a*Math.sin(r)/Math.tan(a),i=this.a*(pe(a-this.lat0)+(1-Math.cos(r))/Math.tan(a)));else if(Math.abs(a)<=G)s=this.a*o,i=-1*this.ml0;else{var n=qi(this.a,this.e,Math.sin(a))/Math.tan(a);s=n*Math.sin(r),i=this.a*wt(this.e0,this.e1,this.e2,this.e3,a)-this.ml0+n*(1-Math.cos(r))}return t.x=s+this.x0,t.y=i+this.y0,t}function zp(t){var e,a,s,i,r,o,n,l,c;if(s=t.x-this.x0,i=t.y-this.y0,this.sphere)if(Math.abs(i+this.a*this.lat0)<=G)e=B(s/this.a+this.long0,this.over),a=0;else{o=this.lat0+i/this.a,n=s*s/this.a/this.a+o*o,l=o;var h;for(r=Hr;r;--r)if(h=Math.tan(l),c=-1*(o*(l*h+1)-l-.5*(l*l+n)*h)/((l-o)/h-1),l+=c,Math.abs(c)<=G){a=l;break}e=B(this.long0+Math.asin(s*Math.tan(l)/this.a)/Math.sin(a),this.over)}else if(Math.abs(i+this.ml0)<=G)a=0,e=B(this.long0+s/this.a,this.over);else{o=(this.ml0+i)/this.a,n=s*s/this.a/this.a+o*o,l=o;var d,u,f,p,m;for(r=Hr;r;--r)if(m=this.e*Math.sin(l),d=Math.sqrt(1-m*m)*Math.tan(l),u=this.a*wt(this.e0,this.e1,this.e2,this.e3,l),f=this.e0-2*this.e1*Math.cos(2*l)+4*this.e2*Math.cos(4*l)-6*this.e3*Math.cos(6*l),p=u/this.a,c=(o*(d*p+1)-p-.5*d*(p*p+n))/(this.es*Math.sin(2*l)*(p*p+n-2*o*p)/(4*d)+(o-p)*(d*f-2/Math.sin(2*l))-f),l-=c,Math.abs(c)<=G){a=l;break}d=Math.sqrt(1-this.es*Math.pow(Math.sin(a),2))*Math.tan(a),e=B(this.long0+Math.asin(s*d/this.a)/Math.sin(a),this.over)}return t.x=e,t.y=a,t}var jp=["Polyconic","American_Polyconic","poly"];const qp={init:Op,forward:Fp,inverse:zp,names:jp};function Hp(){this.A=[],this.A[1]=.6399175073,this.A[2]=-.1358797613,this.A[3]=.063294409,this.A[4]=-.02526853,this.A[5]=.0117879,this.A[6]=-.0055161,this.A[7]=.0026906,this.A[8]=-.001333,this.A[9]=67e-5,this.A[10]=-34e-5,this.B_re=[],this.B_im=[],this.B_re[1]=.7557853228,this.B_im[1]=0,this.B_re[2]=.249204646,this.B_im[2]=.003371507,this.B_re[3]=-.001541739,this.B_im[3]=.04105856,this.B_re[4]=-.10162907,this.B_im[4]=.01727609,this.B_re[5]=-.26623489,this.B_im[5]=-.36249218,this.B_re[6]=-.6870983,this.B_im[6]=-1.1651967,this.C_re=[],this.C_im=[],this.C_re[1]=1.3231270439,this.C_im[1]=0,this.C_re[2]=-.577245789,this.C_im[2]=-.007809598,this.C_re[3]=.508307513,this.C_im[3]=-.112208952,this.C_re[4]=-.15094762,this.C_im[4]=.18200602,this.C_re[5]=1.01418179,this.C_im[5]=1.64497696,this.C_re[6]=1.9660549,this.C_im[6]=2.5127645,this.D=[],this.D[1]=1.5627014243,this.D[2]=.5185406398,this.D[3]=-.03333098,this.D[4]=-.1052906,this.D[5]=-.0368594,this.D[6]=.007317,this.D[7]=.0122,this.D[8]=.00394,this.D[9]=-.0013}function Up(t){var e,a=t.x,s=t.y,i=s-this.lat0,r=a-this.long0,o=i/ga*1e-5,n=r,l=1,c=0;for(e=1;e<=10;e++)l=l*o,c=c+this.A[e]*l;var h=c,d=n,u=1,f=0,p,m,g=0,v=0;for(e=1;e<=6;e++)p=u*h-f*d,m=f*h+u*d,u=p,f=m,g=g+this.B_re[e]*u-this.B_im[e]*f,v=v+this.B_im[e]*u+this.B_re[e]*f;return t.x=v*this.a+this.x0,t.y=g*this.a+this.y0,t}function Vp(t){var e,a=t.x,s=t.y,i=a-this.x0,r=s-this.y0,o=r/this.a,n=i/this.a,l=1,c=0,h,d,u=0,f=0;for(e=1;e<=6;e++)h=l*o-c*n,d=c*o+l*n,l=h,c=d,u=u+this.C_re[e]*l-this.C_im[e]*c,f=f+this.C_im[e]*l+this.C_re[e]*c;for(var p=0;p<this.iterations;p++){var m=u,g=f,v,y,b=o,_=n;for(e=2;e<=6;e++)v=m*u-g*f,y=g*u+m*f,m=v,g=y,b=b+(e-1)*(this.B_re[e]*m-this.B_im[e]*g),_=_+(e-1)*(this.B_im[e]*m+this.B_re[e]*g);m=1,g=0;var x=this.B_re[1],w=this.B_im[1];for(e=2;e<=6;e++)v=m*u-g*f,y=g*u+m*f,m=v,g=y,x=x+e*(this.B_re[e]*m-this.B_im[e]*g),w=w+e*(this.B_im[e]*m+this.B_re[e]*g);var k=x*x+w*w;u=(b*x+_*w)/k,f=(_*x-b*w)/k}var P=u,C=f,M=1,E=0;for(e=1;e<=9;e++)M=M*P,E=E+this.D[e]*M;var S=this.lat0+E*ga*1e5,A=this.long0+C;return t.x=A,t.y=S,t}var Wp=["New_Zealand_Map_Grid","nzmg"];const Kp={init:Hp,forward:Up,inverse:Vp,names:Wp};function Yp(){}function Jp(t){var e=t.x,a=t.y,s=B(e-this.long0,this.over),i=this.x0+this.a*s,r=this.y0+this.a*Math.log(Math.tan(Math.PI/4+a/2.5))*1.25;return t.x=i,t.y=r,t}function Zp(t){t.x-=this.x0,t.y-=this.y0;var e=B(this.long0+t.x/this.a,this.over),a=2.5*(Math.atan(Math.exp(.8*t.y/this.a))-Math.PI/4);return t.x=e,t.y=a,t}var Xp=["Miller_Cylindrical","mill"];const Qp={init:Yp,forward:Jp,inverse:Zp,names:Xp};var t0=20;function e0(){this.sphere?(this.n=1,this.m=0,this.es=0,this.C_y=Math.sqrt((this.m+1)/this.n),this.C_x=this.C_y/(this.m+1)):this.en=Bi(this.es)}function a0(t){var e,a,s=t.x,i=t.y;if(s=B(s-this.long0,this.over),this.sphere){if(!this.m)i=this.n!==1?Math.asin(this.n*Math.sin(i)):i;else for(var r=this.n*Math.sin(i),o=t0;o;--o){var n=(this.m*i+Math.sin(i)-r)/(this.m+Math.cos(i));if(i-=n,Math.abs(n)<G)break}e=this.a*this.C_x*s*(this.m+Math.cos(i)),a=this.a*this.C_y*i}else{var l=Math.sin(i),c=Math.cos(i);a=this.a*aa(i,l,c,this.en),e=this.a*s*c/Math.sqrt(1-this.es*l*l)}return t.x=e,t.y=a,t}function s0(t){var e,a,s,i;return t.x-=this.x0,s=t.x/this.a,t.y-=this.y0,e=t.y/this.a,this.sphere?(e/=this.C_y,s=s/(this.C_x*(this.m+Math.cos(e))),this.m?e=he((this.m*e+Math.sin(e))/this.n):this.n!==1&&(e=he(Math.sin(e)/this.n)),s=B(s+this.long0,this.over),e=pe(e)):(e=Di(t.y/this.a,this.es,this.en),i=Math.abs(e),i<L?(i=Math.sin(e),a=this.long0+t.x*Math.sqrt(1-this.es*i*i)/(this.a*Math.cos(e)),s=B(a,this.over)):i-G<L&&(s=this.long0)),t.x=s,t.y=e,t}var i0=["Sinusoidal","sinu"];const r0={init:e0,forward:a0,inverse:s0,names:i0};function n0(){this.x0=this.x0!==void 0?this.x0:0,this.y0=this.y0!==void 0?this.y0:0,this.long0=this.long0!==void 0?this.long0:0}function o0(t){for(var e=t.x,a=t.y,s=B(e-this.long0,this.over),i=a,r=Math.PI*Math.sin(a);;){var o=-(i+Math.sin(i)-r)/(1+Math.cos(i));if(i+=o,Math.abs(o)<G)break}i/=2,Math.PI/2-Math.abs(a)<G&&(s=0);var n=.900316316158*this.a*s*Math.cos(i)+this.x0,l=1.4142135623731*this.a*Math.sin(i)+this.y0;return t.x=n,t.y=l,t}function l0(t){var e,a;t.x-=this.x0,t.y-=this.y0,a=t.y/(1.4142135623731*this.a),Math.abs(a)>.999999999999&&(a=.999999999999),e=Math.asin(a);var s=B(this.long0+t.x/(.900316316158*this.a*Math.cos(e)),this.over);s<-Math.PI&&(s=-Math.PI),s>Math.PI&&(s=Math.PI),a=(2*e+Math.sin(2*e))/Math.PI,Math.abs(a)>1&&(a=1);var i=Math.asin(a);return t.x=s,t.y=i,t}var c0=["Mollweide","moll"];const d0={init:n0,forward:o0,inverse:l0,names:c0};function h0(){Math.abs(this.lat1+this.lat2)<G||(this.lat2=this.lat2||this.lat1,this.temp=this.b/this.a,this.es=1-Math.pow(this.temp,2),this.e=Math.sqrt(this.es),this.e0=Na(this.es),this.e1=Ia(this.es),this.e2=Ga(this.es),this.e3=Ra(this.es),this.sin_phi=Math.sin(this.lat1),this.cos_phi=Math.cos(this.lat1),this.ms1=Wt(this.e,this.sin_phi,this.cos_phi),this.ml1=wt(this.e0,this.e1,this.e2,this.e3,this.lat1),Math.abs(this.lat1-this.lat2)<G?this.ns=this.sin_phi:(this.sin_phi=Math.sin(this.lat2),this.cos_phi=Math.cos(this.lat2),this.ms2=Wt(this.e,this.sin_phi,this.cos_phi),this.ml2=wt(this.e0,this.e1,this.e2,this.e3,this.lat2),this.ns=(this.ms1-this.ms2)/(this.ml2-this.ml1)),this.g=this.ml1+this.ms1/this.ns,this.ml0=wt(this.e0,this.e1,this.e2,this.e3,this.lat0),this.rh=this.a*(this.g-this.ml0))}function u0(t){var e=t.x,a=t.y,s;if(this.sphere)s=this.a*(this.g-a);else{var i=wt(this.e0,this.e1,this.e2,this.e3,a);s=this.a*(this.g-i)}var r=this.ns*B(e-this.long0,this.over),o=this.x0+s*Math.sin(r),n=this.y0+this.rh-s*Math.cos(r);return t.x=o,t.y=n,t}function p0(t){t.x-=this.x0,t.y=this.rh-t.y+this.y0;var e,a,s,i;this.ns>=0?(a=Math.sqrt(t.x*t.x+t.y*t.y),e=1):(a=-Math.sqrt(t.x*t.x+t.y*t.y),e=-1);var r=0;if(a!==0&&(r=Math.atan2(e*t.x,e*t.y)),this.sphere)return i=B(this.long0+r/this.ns,this.over),s=pe(this.g-a/this.a),t.x=i,t.y=s,t;var o=this.g-a/this.a;return s=ds(o,this.e0,this.e1,this.e2,this.e3),i=B(this.long0+r/this.ns,this.over),t.x=i,t.y=s,t}var f0=["Equidistant_Conic","eqdc"];const g0={init:h0,forward:u0,inverse:p0,names:f0};function m0(){this.R=this.a}function v0(t){var e=t.x,a=t.y,s=B(e-this.long0,this.over),i,r;Math.abs(a)<=G&&(i=this.x0+this.R*s,r=this.y0);var o=he(2*Math.abs(a/Math.PI));(Math.abs(s)<=G||Math.abs(Math.abs(a)-L)<=G)&&(i=this.x0,a>=0?r=this.y0+Math.PI*this.R*Math.tan(.5*o):r=this.y0+Math.PI*this.R*-Math.tan(.5*o));var n=.5*Math.abs(Math.PI/s-s/Math.PI),l=n*n,c=Math.sin(o),h=Math.cos(o),d=h/(c+h-1),u=d*d,f=d*(2/c-1),p=f*f,m=Math.PI*this.R*(n*(d-p)+Math.sqrt(l*(d-p)*(d-p)-(p+l)*(u-p)))/(p+l);s<0&&(m=-m),i=this.x0+m;var g=l+d;return m=Math.PI*this.R*(f*g-n*Math.sqrt((p+l)*(l+1)-g*g))/(p+l),a>=0?r=this.y0+m:r=this.y0-m,t.x=i,t.y=r,t}function y0(t){var e,a,s,i,r,o,n,l,c,h,d,u,f;return t.x-=this.x0,t.y-=this.y0,d=Math.PI*this.R,s=t.x/d,i=t.y/d,r=s*s+i*i,o=-Math.abs(i)*(1+r),n=o-2*i*i+s*s,l=-2*o+1+2*i*i+r*r,f=i*i/l+(2*n*n*n/l/l/l-9*o*n/l/l)/27,c=(o-n*n/3/l)/l,h=2*Math.sqrt(-c/3),d=3*f/c/h,Math.abs(d)>1&&(d>=0?d=1:d=-1),u=Math.acos(d)/3,t.y>=0?a=(-h*Math.cos(u+Math.PI/3)-n/3/l)*Math.PI:a=-(-h*Math.cos(u+Math.PI/3)-n/3/l)*Math.PI,Math.abs(s)<G?e=this.long0:e=B(this.long0+Math.PI*(r-1+Math.sqrt(1+2*(s*s-i*i)+r*r))/2/s,this.over),t.x=e,t.y=a,t}var b0=["Van_der_Grinten_I","VanDerGrinten","Van_der_Grinten","vandg"];const x0={init:m0,forward:v0,inverse:y0,names:b0};function _0(t,e,a,s,i,r){const o=s-e,n=Math.atan((1-r)*Math.tan(t)),l=Math.atan((1-r)*Math.tan(a)),c=Math.sin(n),h=Math.cos(n),d=Math.sin(l),u=Math.cos(l);let f=o,p,m=100,g,v,y,b,_,x,w,k,P,C,M,E,S,A;do{if(g=Math.sin(f),v=Math.cos(f),y=Math.sqrt(u*g*(u*g)+(h*d-c*u*v)*(h*d-c*u*v)),y===0)return{azi1:0,s12:0};b=c*d+h*u*v,_=Math.atan2(y,b),x=h*u*g/y,w=1-x*x,k=w!==0?b-2*c*d/w:0,P=r/16*w*(4+r*(4-3*w)),p=f,f=o+(1-P)*r*x*(_+P*y*(k+P*b*(-1+2*k*k)))}while(Math.abs(f-p)>1e-12&&--m>0);return m===0?{azi1:NaN,s12:NaN}:(C=w*(i*i-i*(1-r)*(i*(1-r)))/(i*(1-r)*(i*(1-r))),M=1+C/16384*(4096+C*(-768+C*(320-175*C))),E=C/1024*(256+C*(-128+C*(74-47*C))),S=E*y*(k+E/4*(b*(-1+2*k*k)-E/6*k*(-3+4*y*y)*(-3+4*k*k))),A=i*(1-r)*M*(_-S),{azi1:Math.atan2(u*g,h*d-c*u*v),s12:A})}function w0(t,e,a,s,i,r){const o=Math.atan((1-r)*Math.tan(t)),n=Math.sin(o),l=Math.cos(o),c=Math.sin(a),h=Math.cos(a),d=Math.atan2(n,l*h),u=l*c,f=1-u*u,p=f*(i*i-i*(1-r)*(i*(1-r)))/(i*(1-r)*(i*(1-r))),m=1+p/16384*(4096+p*(-768+p*(320-175*p))),g=p/1024*(256+p*(-128+p*(74-47*p)));let v=s/(i*(1-r)*m),y,b=100,_,x,w,k;do _=Math.cos(2*d+v),x=Math.sin(v),w=Math.cos(v),k=g*x*(_+g/4*(w*(-1+2*_*_)-g/6*_*(-3+4*x*x)*(-3+4*_*_))),y=v,v=s/(i*(1-r)*m)+k;while(Math.abs(v-y)>1e-12&&--b>0);if(b===0)return{lat2:NaN,lon2:NaN};const P=n*x-l*w*h,C=Math.atan2(n*w+l*x*h,(1-r)*Math.sqrt(u*u+P*P)),M=Math.atan2(x*c,l*w-n*x*h),E=r/16*f*(4+r*(4-3*f)),S=M-(1-E)*r*u*(v+E*x*(_+E*w*(-1+2*_*_))),A=e+S;return{lat2:C,lon2:A}}function M0(){this.sin_p12=Math.sin(this.lat0),this.cos_p12=Math.cos(this.lat0),this.f=this.es/(1+Math.sqrt(1-this.es))}function S0(t){var e=t.x,a=t.y,s=Math.sin(t.y),i=Math.cos(t.y),r=B(e-this.long0,this.over),o,n,l,c,h,d,u,f,p,m,g;return this.sphere?Math.abs(this.sin_p12-1)<=G?(t.x=this.x0+this.a*(L-a)*Math.sin(r),t.y=this.y0-this.a*(L-a)*Math.cos(r),t):Math.abs(this.sin_p12+1)<=G?(t.x=this.x0+this.a*(L+a)*Math.sin(r),t.y=this.y0+this.a*(L+a)*Math.cos(r),t):(p=this.sin_p12*s+this.cos_p12*i*Math.cos(r),u=Math.acos(p),f=u?u/Math.sin(u):1,t.x=this.x0+this.a*f*i*Math.sin(r),t.y=this.y0+this.a*f*(this.cos_p12*s-this.sin_p12*i*Math.cos(r)),t):(o=Na(this.es),n=Ia(this.es),l=Ga(this.es),c=Ra(this.es),Math.abs(this.sin_p12-1)<=G?(h=this.a*wt(o,n,l,c,L),d=this.a*wt(o,n,l,c,a),t.x=this.x0+(h-d)*Math.sin(r),t.y=this.y0-(h-d)*Math.cos(r),t):Math.abs(this.sin_p12+1)<=G?(h=this.a*wt(o,n,l,c,L),d=this.a*wt(o,n,l,c,a),t.x=this.x0+(h+d)*Math.sin(r),t.y=this.y0+(h+d)*Math.cos(r),t):Math.abs(e)<G&&Math.abs(a-this.lat0)<G?(t.x=t.y=0,t):(m=_0(this.lat0,this.long0,a,e,this.a,this.f),g=m.azi1,t.x=m.s12*Math.sin(g),t.y=m.s12*Math.cos(g),t))}function E0(t){t.x-=this.x0,t.y-=this.y0;var e,a,s,i,r,o,n,l,c,h,d,u,f,p,m,g;return this.sphere?(e=Math.sqrt(t.x*t.x+t.y*t.y),e>2*L*this.a?void 0:(a=e/this.a,s=Math.sin(a),i=Math.cos(a),r=this.long0,Math.abs(e)<=G?o=this.lat0:(o=he(i*this.sin_p12+t.y*s*this.cos_p12/e),n=Math.abs(this.lat0)-L,Math.abs(n)<=G?this.lat0>=0?r=B(this.long0+Math.atan2(t.x,-t.y),this.over):r=B(this.long0-Math.atan2(-t.x,t.y),this.over):r=B(this.long0+Math.atan2(t.x*s,e*this.cos_p12*i-t.y*this.sin_p12*s),this.over)),t.x=r,t.y=o,t)):(l=Na(this.es),c=Ia(this.es),h=Ga(this.es),d=Ra(this.es),Math.abs(this.sin_p12-1)<=G?(u=this.a*wt(l,c,h,d,L),e=Math.sqrt(t.x*t.x+t.y*t.y),f=u-e,o=ds(f/this.a,l,c,h,d),r=B(this.long0+Math.atan2(t.x,-1*t.y),this.over),t.x=r,t.y=o,t):Math.abs(this.sin_p12+1)<=G?(u=this.a*wt(l,c,h,d,L),e=Math.sqrt(t.x*t.x+t.y*t.y),f=e-u,o=ds(f/this.a,l,c,h,d),r=B(this.long0+Math.atan2(t.x,t.y),this.over),t.x=r,t.y=o,t):(p=Math.atan2(t.x,t.y),m=Math.sqrt(t.x*t.x+t.y*t.y),g=w0(this.lat0,this.long0,p,m,this.a,this.f),t.x=g.lon2,t.y=g.lat2,t))}var A0=["Azimuthal_Equidistant","aeqd"];const k0={init:M0,forward:S0,inverse:E0,names:A0};function P0(){this.sin_p14=Math.sin(this.lat0),this.cos_p14=Math.cos(this.lat0)}function $0(t){var e,a,s,i,r,o,n,l,c=t.x,h=t.y;return s=B(c-this.long0,this.over),e=Math.sin(h),a=Math.cos(h),i=Math.cos(s),o=this.sin_p14*e+this.cos_p14*a*i,r=1,(o>0||Math.abs(o)<=G)&&(n=this.a*r*a*Math.sin(s),l=this.y0+this.a*r*(this.cos_p14*e-this.sin_p14*a*i)),t.x=n,t.y=l,t}function C0(t){var e,a,s,i,r,o,n;return t.x-=this.x0,t.y-=this.y0,e=Math.sqrt(t.x*t.x+t.y*t.y),a=he(e/this.a),s=Math.sin(a),i=Math.cos(a),o=this.long0,Math.abs(e)<=G?(n=this.lat0,t.x=o,t.y=n,t):(n=he(i*this.sin_p14+t.y*s*this.cos_p14/e),r=Math.abs(this.lat0)-L,Math.abs(r)<=G?(this.lat0>=0?o=B(this.long0+Math.atan2(t.x,-t.y),this.over):o=B(this.long0-Math.atan2(-t.x,t.y),this.over),t.x=o,t.y=n,t):(o=B(this.long0+Math.atan2(t.x*s,e*this.cos_p14*i-t.y*this.sin_p14*s),this.over),t.x=o,t.y=n,t))}var T0=["ortho"];const L0={init:P0,forward:$0,inverse:C0,names:T0};var ct={FRONT:1,RIGHT:2,BACK:3,LEFT:4,TOP:5,BOTTOM:6},tt={AREA_0:1,AREA_1:2,AREA_2:3,AREA_3:4};function N0(){this.x0=this.x0||0,this.y0=this.y0||0,this.lat0=this.lat0||0,this.long0=this.long0||0,this.lat_ts=this.lat_ts||0,this.title=this.title||"Quadrilateralized Spherical Cube",this.lat0>=L-Q/2?this.face=ct.TOP:this.lat0<=-(L-Q/2)?this.face=ct.BOTTOM:Math.abs(this.long0)<=Q?this.face=ct.FRONT:Math.abs(this.long0)<=L+Q?this.face=this.long0>0?ct.RIGHT:ct.LEFT:this.face=ct.BACK,this.es!==0&&(this.one_minus_f=1-(this.a-this.b)/this.a,this.one_minus_f_squared=this.one_minus_f*this.one_minus_f)}function I0(t){var e={x:0,y:0},a,s,i,r,o,n,l={value:0};if(t.x-=this.long0,this.es!==0?a=Math.atan(this.one_minus_f_squared*Math.tan(t.y)):a=t.y,s=t.x,this.face===ct.TOP)r=L-a,s>=Q&&s<=L+Q?(l.value=tt.AREA_0,i=s-L):s>L+Q||s<=-(L+Q)?(l.value=tt.AREA_1,i=s>0?s-gt:s+gt):s>-(L+Q)&&s<=-Q?(l.value=tt.AREA_2,i=s+L):(l.value=tt.AREA_3,i=s);else if(this.face===ct.BOTTOM)r=L+a,s>=Q&&s<=L+Q?(l.value=tt.AREA_0,i=-s+L):s<Q&&s>=-Q?(l.value=tt.AREA_1,i=-s):s<-Q&&s>=-(L+Q)?(l.value=tt.AREA_2,i=-s-L):(l.value=tt.AREA_3,i=s>0?-s+gt:-s-gt);else{var c,h,d,u,f,p,m;this.face===ct.RIGHT?s=Ve(s,+L):this.face===ct.BACK?s=Ve(s,+gt):this.face===ct.LEFT&&(s=Ve(s,-L)),u=Math.sin(a),f=Math.cos(a),p=Math.sin(s),m=Math.cos(s),c=f*m,h=f*p,d=u,this.face===ct.FRONT?(r=Math.acos(c),i=Ha(r,d,h,l)):this.face===ct.RIGHT?(r=Math.acos(h),i=Ha(r,d,-c,l)):this.face===ct.BACK?(r=Math.acos(-c),i=Ha(r,d,-h,l)):this.face===ct.LEFT?(r=Math.acos(-h),i=Ha(r,d,c,l)):(r=i=0,l.value=tt.AREA_0)}return n=Math.atan(12/gt*(i+Math.acos(Math.sin(i)*Math.cos(Q))-L)),o=Math.sqrt((1-Math.cos(r))/(Math.cos(n)*Math.cos(n))/(1-Math.cos(Math.atan(1/Math.cos(i))))),l.value===tt.AREA_1?n+=L:l.value===tt.AREA_2?n+=gt:l.value===tt.AREA_3&&(n+=1.5*gt),e.x=o*Math.cos(n),e.y=o*Math.sin(n),e.x=e.x*this.a+this.x0,e.y=e.y*this.a+this.y0,t.x=e.x,t.y=e.y,t}function G0(t){var e={lam:0,phi:0},a,s,i,r,o,n,l,c,h,d={value:0};if(t.x=(t.x-this.x0)/this.a,t.y=(t.y-this.y0)/this.a,s=Math.atan(Math.sqrt(t.x*t.x+t.y*t.y)),a=Math.atan2(t.y,t.x),t.x>=0&&t.x>=Math.abs(t.y)?d.value=tt.AREA_0:t.y>=0&&t.y>=Math.abs(t.x)?(d.value=tt.AREA_1,a-=L):t.x<0&&-t.x>=Math.abs(t.y)?(d.value=tt.AREA_2,a=a<0?a+gt:a-gt):(d.value=tt.AREA_3,a+=L),h=gt/12*Math.tan(a),o=Math.sin(h)/(Math.cos(h)-1/Math.sqrt(2)),n=Math.atan(o),i=Math.cos(a),r=Math.tan(s),l=1-i*i*r*r*(1-Math.cos(Math.atan(1/Math.cos(n)))),l<-1?l=-1:l>1&&(l=1),this.face===ct.TOP)c=Math.acos(l),e.phi=L-c,d.value===tt.AREA_0?e.lam=n+L:d.value===tt.AREA_1?e.lam=n<0?n+gt:n-gt:d.value===tt.AREA_2?e.lam=n-L:e.lam=n;else if(this.face===ct.BOTTOM)c=Math.acos(l),e.phi=c-L,d.value===tt.AREA_0?e.lam=-n+L:d.value===tt.AREA_1?e.lam=-n:d.value===tt.AREA_2?e.lam=-n-L:e.lam=n<0?-n-gt:-n+gt;else{var u,f,p;u=l,h=u*u,h>=1?p=0:p=Math.sqrt(1-h)*Math.sin(n),h+=p*p,h>=1?f=0:f=Math.sqrt(1-h),d.value===tt.AREA_1?(h=f,f=-p,p=h):d.value===tt.AREA_2?(f=-f,p=-p):d.value===tt.AREA_3&&(h=f,f=p,p=-h),this.face===ct.RIGHT?(h=u,u=-f,f=h):this.face===ct.BACK?(u=-u,f=-f):this.face===ct.LEFT&&(h=u,u=f,f=-h),e.phi=Math.acos(-p)-L,e.lam=Math.atan2(f,u),this.face===ct.RIGHT?e.lam=Ve(e.lam,-L):this.face===ct.BACK?e.lam=Ve(e.lam,-gt):this.face===ct.LEFT&&(e.lam=Ve(e.lam,+L))}if(this.es!==0){var m,g,v;m=e.phi<0?1:0,g=Math.tan(e.phi),v=this.b/Math.sqrt(g*g+this.one_minus_f_squared),e.phi=Math.atan(Math.sqrt(this.a*this.a-v*v)/(this.one_minus_f*v)),m&&(e.phi=-e.phi)}return e.lam+=this.long0,t.x=e.lam,t.y=e.phi,t}function Ha(t,e,a,s){var i;return t<G?(s.value=tt.AREA_0,i=0):(i=Math.atan2(e,a),Math.abs(i)<=Q?s.value=tt.AREA_0:i>Q&&i<=L+Q?(s.value=tt.AREA_1,i-=L):i>L+Q||i<=-(L+Q)?(s.value=tt.AREA_2,i=i>=0?i-gt:i+gt):(s.value=tt.AREA_3,i+=L)),i}function Ve(t,e){var a=t+e;return a<-gt?a+=Ma:a>+gt&&(a-=Ma),a}var R0=["Quadrilateralized Spherical Cube","Quadrilateralized_Spherical_Cube","qsc"];const B0={init:N0,forward:I0,inverse:G0,names:R0};var ai=[[1,22199e-21,-715515e-10,31103e-10],[.9986,-482243e-9,-24897e-9,-13309e-10],[.9954,-83103e-8,-448605e-10,-986701e-12],[.99,-.00135364,-59661e-9,36777e-10],[.9822,-.00167442,-449547e-11,-572411e-11],[.973,-.00214868,-903571e-10,18736e-12],[.96,-.00305085,-900761e-10,164917e-11],[.9427,-.00382792,-653386e-10,-26154e-10],[.9216,-.00467746,-10457e-8,481243e-11],[.8962,-.00536223,-323831e-10,-543432e-11],[.8679,-.00609363,-113898e-9,332484e-11],[.835,-.00698325,-640253e-10,934959e-12],[.7986,-.00755338,-500009e-10,935324e-12],[.7597,-.00798324,-35971e-9,-227626e-11],[.7186,-.00851367,-701149e-10,-86303e-10],[.6732,-.00986209,-199569e-9,191974e-10],[.6213,-.010418,883923e-10,624051e-11],[.5722,-.00906601,182e-6,624051e-11],[.5322,-.00677797,275608e-9,624051e-11]],da=[[-520417e-23,.0124,121431e-23,-845284e-16],[.062,.0124,-126793e-14,422642e-15],[.124,.0124,507171e-14,-160604e-14],[.186,.0123999,-190189e-13,600152e-14],[.248,.0124002,710039e-13,-224e-10],[.31,.0123992,-264997e-12,835986e-13],[.372,.0124029,988983e-12,-311994e-12],[.434,.0123893,-369093e-11,-435621e-12],[.4958,.0123198,-102252e-10,-345523e-12],[.5571,.0121916,-154081e-10,-582288e-12],[.6176,.0119938,-241424e-10,-525327e-12],[.6769,.011713,-320223e-10,-516405e-12],[.7346,.0113541,-397684e-10,-609052e-12],[.7903,.0109107,-489042e-10,-104739e-11],[.8435,.0103431,-64615e-9,-140374e-14],[.8936,.00969686,-64636e-9,-8547e-9],[.9394,.00840947,-192841e-9,-42106e-10],[.9761,.00616527,-256e-6,-42106e-10],[1,.00328947,-319159e-9,-42106e-10]],Ao=.8487,ko=1.3523,Po=Et/5,D0=1/Po,Fe=18,hs=function(t,e){return t[0]+e*(t[1]+e*(t[2]+e*t[3]))},O0=function(t,e){return t[1]+e*(2*t[2]+e*3*t[3])};function F0(t,e,a,s){for(var i=e;s;--s){var r=t(i);if(i-=r,Math.abs(r)<a)break}return i}function z0(){this.x0=this.x0||0,this.y0=this.y0||0,this.long0=this.long0||0,this.es=0,this.title=this.title||"Robinson"}function j0(t){var e=B(t.x-this.long0,this.over),a=Math.abs(t.y),s=Math.floor(a*Po);s<0?s=0:s>=Fe&&(s=Fe-1),a=Et*(a-D0*s);var i={x:hs(ai[s],a)*e,y:hs(da[s],a)};return t.y<0&&(i.y=-i.y),i.x=i.x*this.a*Ao+this.x0,i.y=i.y*this.a*ko+this.y0,i}function q0(t){var e={x:(t.x-this.x0)/(this.a*Ao),y:Math.abs(t.y-this.y0)/(this.a*ko)};if(e.y>=1)e.x/=ai[Fe][0],e.y=t.y<0?-L:L;else{var a=Math.floor(e.y*Fe);for(a<0?a=0:a>=Fe&&(a=Fe-1);;)if(da[a][0]>e.y)--a;else if(da[a+1][0]<=e.y)++a;else break;var s=da[a],i=5*(e.y-s[0])/(da[a+1][0]-s[0]);i=F0(function(r){return(hs(s,r)-e.y)/O0(s,r)},i,G,100),e.x/=hs(ai[a],i),e.y=(5*a+i)*ut,t.y<0&&(e.y=-e.y)}return e.x=B(e.x+this.long0,this.over),e}var H0=["Robinson","robin"];const U0={init:z0,forward:j0,inverse:q0,names:H0};function V0(){this.name="geocent"}function W0(t){var e=go(t,this.es,this.a);return e}function K0(t){var e=mo(t,this.es,this.a,this.b);return e}var Y0=["Geocentric","geocentric","geocent","Geocent"];const J0={init:V0,forward:W0,inverse:K0,names:Y0};var _t={N_POLE:0,S_POLE:1,EQUIT:2,OBLIQ:3},na={h:{def:1e5,num:!0},azi:{def:0,num:!0,degrees:!0},tilt:{def:0,num:!0,degrees:!0},long0:{def:0,num:!0},lat0:{def:0,num:!0}};function Z0(){if(Object.keys(na).forEach((function(a){if(typeof this[a]>"u")this[a]=na[a].def;else{if(na[a].num&&isNaN(this[a]))throw new Error("Invalid parameter value, must be numeric "+a+" = "+this[a]);na[a].num&&(this[a]=parseFloat(this[a]))}na[a].degrees&&(this[a]=this[a]*ut)}).bind(this)),Math.abs(Math.abs(this.lat0)-L)<G?this.mode=this.lat0<0?_t.S_POLE:_t.N_POLE:Math.abs(this.lat0)<G?this.mode=_t.EQUIT:(this.mode=_t.OBLIQ,this.sinph0=Math.sin(this.lat0),this.cosph0=Math.cos(this.lat0)),this.pn1=this.h/this.a,this.pn1<=0||this.pn1>1e10)throw new Error("Invalid height");this.p=1+this.pn1,this.rp=1/this.p,this.h1=1/this.pn1,this.pfact=(this.p+1)*this.h1,this.es=0;var t=this.tilt,e=this.azi;this.cg=Math.cos(e),this.sg=Math.sin(e),this.cw=Math.cos(t),this.sw=Math.sin(t)}function X0(t){t.x-=this.long0;var e=Math.sin(t.y),a=Math.cos(t.y),s=Math.cos(t.x),i,r;switch(this.mode){case _t.OBLIQ:r=this.sinph0*e+this.cosph0*a*s;break;case _t.EQUIT:r=a*s;break;case _t.S_POLE:r=-e;break;case _t.N_POLE:r=e;break}switch(r=this.pn1/(this.p-r),i=r*a*Math.sin(t.x),this.mode){case _t.OBLIQ:r*=this.cosph0*e-this.sinph0*a*s;break;case _t.EQUIT:r*=e;break;case _t.N_POLE:r*=-(a*s);break;case _t.S_POLE:r*=a*s;break}var o,n;return o=r*this.cg+i*this.sg,n=1/(o*this.sw*this.h1+this.cw),i=(i*this.cg-r*this.sg)*this.cw*n,r=o*n,t.x=i*this.a,t.y=r*this.a,t}function Q0(t){t.x/=this.a,t.y/=this.a;var e={x:t.x,y:t.y},a,s,i;i=1/(this.pn1-t.y*this.sw),a=this.pn1*t.x*i,s=this.pn1*t.y*this.cw*i,t.x=a*this.cg+s*this.sg,t.y=s*this.cg-a*this.sg;var r=St(t.x,t.y);if(Math.abs(r)<G)e.x=0,e.y=t.y;else{var o,n;switch(n=1-r*r*this.pfact,n=(this.p-Math.sqrt(n))/(this.pn1/r+r/this.pn1),o=Math.sqrt(1-n*n),this.mode){case _t.OBLIQ:e.y=Math.asin(o*this.sinph0+t.y*n*this.cosph0/r),t.y=(o-this.sinph0*Math.sin(e.y))*r,t.x*=n*this.cosph0;break;case _t.EQUIT:e.y=Math.asin(t.y*n/r),t.y=o*r,t.x*=n;break;case _t.N_POLE:e.y=Math.asin(o),t.y=-t.y;break;case _t.S_POLE:e.y=-Math.asin(o);break}e.x=Math.atan2(t.x,t.y)}return t.x=e.x+this.long0,t.y=e.y,t}var tf=["Tilted_Perspective","tpers"];const ef={init:Z0,forward:X0,inverse:Q0,names:tf};function af(){if(this.flip_axis=this.sweep==="x"?1:0,this.h=Number(this.h),this.radius_g_1=this.h/this.a,this.radius_g_1<=0||this.radius_g_1>1e10)throw new Error;if(this.radius_g=1+this.radius_g_1,this.C=this.radius_g*this.radius_g-1,this.es!==0){var t=1-this.es,e=1/t;this.radius_p=Math.sqrt(t),this.radius_p2=t,this.radius_p_inv2=e,this.shape="ellipse"}else this.radius_p=1,this.radius_p2=1,this.radius_p_inv2=1,this.shape="sphere";this.title||(this.title="Geostationary Satellite View")}function sf(t){var e=t.x,a=t.y,s,i,r,o;if(e=e-this.long0,this.shape==="ellipse"){a=Math.atan(this.radius_p2*Math.tan(a));var n=this.radius_p/St(this.radius_p*Math.cos(a),Math.sin(a));if(i=n*Math.cos(e)*Math.cos(a),r=n*Math.sin(e)*Math.cos(a),o=n*Math.sin(a),(this.radius_g-i)*i-r*r-o*o*this.radius_p_inv2<0)return t.x=Number.NaN,t.y=Number.NaN,t;s=this.radius_g-i,this.flip_axis?(t.x=this.radius_g_1*Math.atan(r/St(o,s)),t.y=this.radius_g_1*Math.atan(o/s)):(t.x=this.radius_g_1*Math.atan(r/s),t.y=this.radius_g_1*Math.atan(o/St(r,s)))}else this.shape==="sphere"&&(s=Math.cos(a),i=Math.cos(e)*s,r=Math.sin(e)*s,o=Math.sin(a),s=this.radius_g-i,this.flip_axis?(t.x=this.radius_g_1*Math.atan(r/St(o,s)),t.y=this.radius_g_1*Math.atan(o/s)):(t.x=this.radius_g_1*Math.atan(r/s),t.y=this.radius_g_1*Math.atan(o/St(r,s))));return t.x=t.x*this.a,t.y=t.y*this.a,t}function rf(t){var e=-1,a=0,s=0,i,r,o,n;if(t.x=t.x/this.a,t.y=t.y/this.a,this.shape==="ellipse"){this.flip_axis?(s=Math.tan(t.y/this.radius_g_1),a=Math.tan(t.x/this.radius_g_1)*St(1,s)):(a=Math.tan(t.x/this.radius_g_1),s=Math.tan(t.y/this.radius_g_1)*St(1,a));var l=s/this.radius_p;if(i=a*a+l*l+e*e,r=2*this.radius_g*e,o=r*r-4*i*this.C,o<0)return t.x=Number.NaN,t.y=Number.NaN,t;n=(-r-Math.sqrt(o))/(2*i),e=this.radius_g+n*e,a*=n,s*=n,t.x=Math.atan2(a,e),t.y=Math.atan(s*Math.cos(t.x)/e),t.y=Math.atan(this.radius_p_inv2*Math.tan(t.y))}else if(this.shape==="sphere"){if(this.flip_axis?(s=Math.tan(t.y/this.radius_g_1),a=Math.tan(t.x/this.radius_g_1)*Math.sqrt(1+s*s)):(a=Math.tan(t.x/this.radius_g_1),s=Math.tan(t.y/this.radius_g_1)*Math.sqrt(1+a*a)),i=a*a+s*s+e*e,r=2*this.radius_g*e,o=r*r-4*i*this.C,o<0)return t.x=Number.NaN,t.y=Number.NaN,t;n=(-r-Math.sqrt(o))/(2*i),e=this.radius_g+n*e,a*=n,s*=n,t.x=Math.atan2(a,e),t.y=Math.atan(s*Math.cos(t.x)/e)}return t.x=t.x+this.long0,t}var nf=["Geostationary Satellite View","Geostationary_Satellite","geos"];const of={init:af,forward:sf,inverse:rf,names:nf};var ma=1.340264,va=-.081106,ya=893e-6,ba=.003796,us=Math.sqrt(3)/2;function lf(){this.es=0,this.long0=this.long0!==void 0?this.long0:0,this.x0=this.x0!==void 0?this.x0:0,this.y0=this.y0!==void 0?this.y0:0}function cf(t){var e=B(t.x-this.long0,this.over),a=t.y,s=Math.asin(us*Math.sin(a)),i=s*s,r=i*i*i;return t.x=e*Math.cos(s)/(us*(ma+3*va*i+r*(7*ya+9*ba*i))),t.y=s*(ma+va*i+r*(ya+ba*i)),t.x=this.a*t.x+this.x0,t.y=this.a*t.y+this.y0,t}function df(t){t.x=(t.x-this.x0)/this.a,t.y=(t.y-this.y0)/this.a;var e=1e-9,a=12,s=t.y,i,r,o,n,l,c;for(c=0;c<a&&(i=s*s,r=i*i*i,o=s*(ma+va*i+r*(ya+ba*i))-t.y,n=ma+3*va*i+r*(7*ya+9*ba*i),s-=l=o/n,!(Math.abs(l)<e));++c);return i=s*s,r=i*i*i,t.x=us*t.x*(ma+3*va*i+r*(7*ya+9*ba*i))/Math.cos(s),t.y=Math.asin(Math.sin(s)/us),t.x=B(t.x+this.long0,this.over),t}var hf=["eqearth","Equal Earth","Equal_Earth"];const uf={init:lf,forward:cf,inverse:df,names:hf};var Aa=1e-10;function pf(){var t;if(this.phi1=this.lat1,Math.abs(this.phi1)<Aa)throw new Error;this.es?(this.en=Bi(this.es),this.m1=aa(this.phi1,this.am1=Math.sin(this.phi1),t=Math.cos(this.phi1),this.en),this.am1=t/(Math.sqrt(1-this.es*this.am1*this.am1)*this.am1),this.inverse=gf,this.forward=ff):(Math.abs(this.phi1)+Aa>=L?this.cphi1=0:this.cphi1=1/Math.tan(this.phi1),this.inverse=vf,this.forward=mf)}function ff(t){var e=B(t.x-(this.long0||0),this.over),a=t.y,s,i,r;return s=this.am1+this.m1-aa(a,i=Math.sin(a),r=Math.cos(a),this.en),i=r*e/(s*Math.sqrt(1-this.es*i*i)),t.x=s*Math.sin(i),t.y=this.am1-s*Math.cos(i),t.x=this.a*t.x+(this.x0||0),t.y=this.a*t.y+(this.y0||0),t}function gf(t){t.x=(t.x-(this.x0||0))/this.a,t.y=(t.y-(this.y0||0))/this.a;var e,a,s,i;if(a=St(t.x,t.y=this.am1-t.y),i=Di(this.am1+this.m1-a,this.es,this.en),(e=Math.abs(i))<L)e=Math.sin(i),s=a*Math.atan2(t.x,t.y)*Math.sqrt(1-this.es*e*e)/Math.cos(i);else if(Math.abs(e-L)<=Aa)s=0;else throw new Error;return t.x=B(s+(this.long0||0),this.over),t.y=pe(i),t}function mf(t){var e=B(t.x-(this.long0||0),this.over),a=t.y,s,i;return i=this.cphi1+this.phi1-a,Math.abs(i)>Aa?(t.x=i*Math.sin(s=e*Math.cos(a)/i),t.y=this.cphi1-i*Math.cos(s)):t.x=t.y=0,t.x=this.a*t.x+(this.x0||0),t.y=this.a*t.y+(this.y0||0),t}function vf(t){t.x=(t.x-(this.x0||0))/this.a,t.y=(t.y-(this.y0||0))/this.a;var e,a,s=St(t.x,t.y=this.cphi1-t.y);if(a=this.cphi1+this.phi1-s,Math.abs(a)>L)throw new Error;return Math.abs(Math.abs(a)-L)<=Aa?e=0:e=s*Math.atan2(t.x,t.y)/Math.cos(a),t.x=B(e+(this.long0||0),this.over),t.y=pe(a),t}var yf=["bonne","Bonne (Werner lat_1=90)"];const bf={init:pf,names:yf},Ur={OBLIQUE:{forward:Sf,inverse:Af},TRANSVERSE:{forward:Ef,inverse:kf}},ps={ROTATE:{o_alpha:"oAlpha",o_lon_c:"oLongC",o_lat_c:"oLatC"},NEW_POLE:{o_lat_p:"oLatP",o_lon_p:"oLongP"},NEW_EQUATOR:{o_lon_1:"oLong1",o_lat_1:"oLat1",o_lon_2:"oLong2",o_lat_2:"oLat2"}};function xf(){if(this.x0=this.x0||0,this.y0=this.y0||0,this.long0=this.long0||0,this.title=this.title||"General Oblique Transformation",this.isIdentity=ho.includes(this.o_proj),!this.o_proj)throw new Error("Missing parameter: o_proj");if(this.o_proj==="ob_tran")throw new Error("Invalid value for o_proj: "+this.o_proj);const t=this.projStr.replace("+proj=ob_tran","").replace("+o_proj=","+proj=").trim(),e=Dt(t);if(!e)throw new Error("Invalid parameter: o_proj. Unknown projection "+this.o_proj);e.long0=0,this.obliqueProjection=e;let a;const s=Object.keys(ps),i=n=>{if(typeof this[n]>"u")return;const l=parseFloat(this[n])*ut;if(isNaN(l))throw new Error("Invalid value for "+n+": "+this[n]);return l};for(let n=0;n<s.length;n++){const l=s[n],c=ps[l],h=Object.entries(c);if(h.some(([u])=>typeof this[u]<"u")){a=c;for(let u=0;u<h.length;u++){const[f,p]=h[u],m=i(f);if(typeof m>"u")throw new Error("Missing parameter: "+f+".");this[p]=m}break}}if(!a)throw new Error("No valid parameters provided for ob_tran projection.");const{lamp:r,phip:o}=Mf(this,a);this.lamp=r,Math.abs(o)>G?(this.cphip=Math.cos(o),this.sphip=Math.sin(o),this.projectionType=Ur.OBLIQUE):this.projectionType=Ur.TRANSVERSE}function _f(t){return this.projectionType.forward(this,t)}function wf(t){return this.projectionType.inverse(this,t)}function Mf(t,e){let a,s;if(e===ps.ROTATE){let i=t.oLongC,r=t.oLatC,o=t.oAlpha;if(Math.abs(Math.abs(r)-L)<=G)throw new Error("Invalid value for o_lat_c: "+t.o_lat_c+" should be < 90°");s=i+Math.atan2(-1*Math.cos(o),-1*Math.sin(o)*Math.sin(r)),a=Math.asin(Math.cos(r)*Math.sin(o))}else if(e===ps.NEW_POLE)s=t.oLongP,a=t.oLatP;else{let i=t.oLong1,r=t.oLat1,o=t.oLong2,n=t.oLat2,l=Math.abs(r);if(Math.abs(r)>L-G)throw new Error("Invalid value for o_lat_1: "+t.o_lat_1+" should be < 90°");if(Math.abs(n)>L-G)throw new Error("Invalid value for o_lat_2: "+t.o_lat_2+" should be < 90°");if(Math.abs(r-n)<G)throw new Error("Invalid value for o_lat_1 and o_lat_2: o_lat_1 should be different from o_lat_2");if(l<G)throw new Error("Invalid value for o_lat_1: o_lat_1 should be different from zero");s=Math.atan2(Math.cos(r)*Math.sin(n)*Math.cos(i)-Math.sin(r)*Math.cos(n)*Math.cos(o),Math.sin(r)*Math.cos(n)*Math.sin(o)-Math.cos(r)*Math.sin(n)*Math.sin(i)),a=Math.atan(-1*Math.cos(s-i)/Math.tan(r))}return{lamp:s,phip:a}}function Sf(t,e){let{x:a,y:s}=e;a+=t.long0;const i=Math.cos(a),r=Math.sin(s),o=Math.cos(s);e.x=B(Math.atan2(o*Math.sin(a),t.sphip*o*i+t.cphip*r)+t.lamp),e.y=Math.asin(t.sphip*r-t.cphip*o*i);const n=t.obliqueProjection.forward(e);return t.isIdentity&&(n.x*=Et,n.y*=Et),n}function Ef(t,e){let{x:a,y:s}=e;a+=t.long0;const i=Math.cos(s),r=Math.cos(a);e.x=B(Math.atan2(i*Math.sin(a),Math.sin(s))+t.lamp),e.y=Math.asin(-1*i*r);const o=t.obliqueProjection.forward(e);return t.isIdentity&&(o.x*=Et,o.y*=Et),o}function Af(t,e){t.isIdentity&&(e.x*=ut,e.y*=ut);const a=t.obliqueProjection.inverse(e);let{x:s,y:i}=a;if(s<Number.MAX_VALUE){s-=t.lamp;const r=Math.cos(s),o=Math.sin(i),n=Math.cos(i);e.x=Math.atan2(n*Math.sin(s),t.sphip*n*r-t.cphip*o),e.y=Math.asin(t.sphip*o+t.cphip*n*r)}return e.x=B(e.x+t.long0),e}function kf(t,e){t.isIdentity&&(e.x*=ut,e.y*=ut);const a=t.obliqueProjection.inverse(e);let{x:s,y:i}=a;if(s<Number.MAX_VALUE){const r=Math.cos(i);s-=t.lamp,e.x=Math.atan2(r*Math.sin(s),-1*Math.sin(i)),e.y=Math.asin(r*Math.cos(s))}return e.x=B(e.x+t.long0),e}var Pf=["General Oblique Transformation","General_Oblique_Transformation","ob_tran"];const $f={init:xf,forward:_f,inverse:wf,names:Pf};function Cf(t){t.Proj.projections.add(Ja),t.Proj.projections.add(Za),t.Proj.projections.add(vu),t.Proj.projections.add(Au),t.Proj.projections.add(Tu),t.Proj.projections.add(Ru),t.Proj.projections.add(ju),t.Proj.projections.add(Wu),t.Proj.projections.add(Xu),t.Proj.projections.add(sp),t.Proj.projections.add(mp),t.Proj.projections.add(wp),t.Proj.projections.add(kp),t.Proj.projections.add(Np),t.Proj.projections.add(Dp),t.Proj.projections.add(qp),t.Proj.projections.add(Kp),t.Proj.projections.add(Qp),t.Proj.projections.add(r0),t.Proj.projections.add(d0),t.Proj.projections.add(g0),t.Proj.projections.add(x0),t.Proj.projections.add(k0),t.Proj.projections.add(L0),t.Proj.projections.add(B0),t.Proj.projections.add(U0),t.Proj.projections.add(J0),t.Proj.projections.add(ef),t.Proj.projections.add(of),t.Proj.projections.add(uf),t.Proj.projections.add(bf),t.Proj.projections.add($f)}const Hi=Object.assign(Ih,{defaultDatum:"WGS84",Proj:Dt,WGS84:new Dt("WGS84"),Point:Xe,toPoint:vo,defs:xt,nadgrid:mh,transform:cs,mgrs:Gh,version:"__VERSION__"});Cf(Hi);const kg=Object.freeze(Object.defineProperty({__proto__:null,default:Hi},Symbol.toStringTag,{value:"Module"}));function Tf(t){if(!t)return"EPSG:4326";const e=t.trim();if(/WGS.?84/i.test(e)&&/GEOGCS/i.test(e)&&!/UTM/i.test(e))return"EPSG:4326";const a=e.match(/UTM[_ ]?[Zz]one[_ ]?(\d+)([NS]?)/i);if(a){const s=parseInt(a[1],10);return/S/i.test(a[2])||/south/i.test(e)?`EPSG:${32700+s}`:`EPSG:${32600+s}`}return e.length>10?e:"EPSG:4326"}function Lf(t,e){if(!e||e==="EPSG:4326")return{geojson:t,reprojected:!1,error:null};try{const a=Hi(e,"EPSG:4326");return{geojson:{type:"FeatureCollection",features:t.features.map(i=>i.geometry?{...i,geometry:Nf(i.geometry,a)}:i)},reprojected:!0,error:null}}catch(a){return{geojson:t,reprojected:!1,error:`Reprojection failed: ${a.message}`}}}function Nf(t,e){const a=t.type;return a==="Point"?{type:a,coordinates:e.forward(t.coordinates)}:a==="MultiPoint"||a==="LineString"?{type:a,coordinates:t.coordinates.map(s=>e.forward(s))}:a==="MultiLineString"||a==="Polygon"?{type:a,coordinates:t.coordinates.map(s=>s.map(i=>e.forward(i)))}:a==="MultiPolygon"?{type:a,coordinates:t.coordinates.map(s=>s.map(i=>i.map(r=>e.forward(r))))}:t}function If(t){const e=[],a={},s=[];let i=0;for(const r of t.features||[]){if(!r.geometry||!r.geometry.type||!r.geometry.coordinates){i++;continue}const o=r.geometry.type;a[o]=(a[o]||0)+1,s.push(r)}return i>0&&e.push(`Removed ${i} feature(s) with null/empty geometry`),{cleaned:{type:"FeatureCollection",features:s},stats:{typeCounts:a,originalCount:(t.features||[]).length,validCount:s.length},warnings:e}}function Gf(t){var r,o;const e=[];let a=0,s=0;const i=[];for(const n of t.features){if(!n.geometry.type.includes("Polygon")){i.push(n);continue}try{let c=Ki(n,0,{units:"meters"});if(!c||!c.geometry){const u=Oo(n,{tolerance:lt.simplifyTolerance,highQuality:!0});c=Ki(u,0,{units:"meters"})}if(!c||!c.geometry){s++,e.push(`Dropped feature "${((r=n.properties)==null?void 0:r.name)||"unknown"}" — unfixable geometry`);continue}const h=ts(c);if(h<lt.sliverThresholdM2){s++,e.push(`Removed sliver polygon (${h.toFixed(1)} m²)`);continue}const d=ts(n);Math.abs(d-h)>.01&&a++,i.push({type:"Feature",geometry:c.geometry,properties:n.properties})}catch(c){i.push(n),e.push(`Could not validate geometry for "${((o=n.properties)==null?void 0:o.name)||"unknown"}": ${c.message}`)}}return a>0&&e.push(`Fixed ${a} geometry issue(s) via buffer(0)`),{cleaned:{type:"FeatureCollection",features:i},fixedCount:a,droppedCount:s,warnings:e}}const Vr={global:{name:["name","site_name","area_name","site_nm","NAME","Name","SITE_NAME","AREA_NAME","label","LABEL","title","TITLE"],type:["type","TYPE","Type","category","CATEGORY","designation","DESIGNATION","desig","DESIG","class","CLASS"],realm:["realm","REALM","Realm","domain","DOMAIN","environment","ENVIRONMENT"],province:["province","PROVINCE","Province","state","STATE","region","REGION","island","ISLAND","prov","PROV"],year:["year","YEAR","Year","est_year","EST_YEAR","date","DATE","year_est","YEAR_EST","established"],status:["status","STATUS","Status","condition","CONDITION","state","mgmt_status"],source:["source","SOURCE","Source","data_src","DATA_SRC","origin","ORIGIN","provider"],notes:["notes","NOTES","Notes","comments","COMMENTS","description","DESCRIPTION","desc","DESC","remarks","REMARKS"],presence:["presence","PRESENCE","Presence","seasonal","SEASONAL"]},CCA:{name:["cca_name","CCA_NAME","community_area","COMMUNITY_AREA","tabu_name"],type:["cca_type","CCA_TYPE","tabu_type"]},MPA:{name:["mpa_name","MPA_NAME","marine_area","MARINE_AREA"],type:["mpa_type","MPA_TYPE","protection_level"]},PA:{name:["pa_name","PA_NAME","park_name","PARK_NAME","protected_area"],type:["pa_type","PA_TYPE","iucn_cat","IUCN_CAT"]},OECM:{name:["oecm_name","OECM_NAME"],type:["oecm_type","OECM_TYPE"]},KBA:{name:["kba_name","KBA_NAME","iba_name"],type:["kba_type","KBA_TYPE","trigger"]},LMMA:{name:["lmma_name","LMMA_NAME","managed_area"],type:["lmma_type","LMMA_TYPE","management_type"]},SPATIAL_PLAN:{name:["plan_name","PLAN_NAME","spatial_plan"],type:["plan_type","PLAN_TYPE","planning_zone"]},DEGRADED:{name:["degraded_name","site_name","SITE_NAME"],type:["degradation_type","DEGRADATION_TYPE","deg_type","cause"]},RESTORATION:{name:["restoration_name","project_name","PROJECT_NAME"],type:["restoration_type","activity"]},SPECIES_DIST:{name:["species_name","SPECIES_NAME","common_name","sci_name"],type:["species_type","taxa","TAXA","group"]},MEGAPODE:{name:["site_name","SITE_NAME","nesting_site","location","name"],type:["obs_type","record_type","method","status"],presence:["presence","PRESENCE","Presence","seasonal","SEASONAL","origin","ORIGIN"]},STARLING:{name:["site_name","SITE_NAME","location","name"],type:["obs_type","record_type","method","status"],presence:["presence","PRESENCE","Presence","seasonal","SEASONAL","origin","ORIGIN"]},FANTAIL:{name:["site_name","SITE_NAME","location","name"],type:["obs_type","record_type","method","status"],presence:["presence","PRESENCE","Presence","seasonal","SEASONAL","origin","ORIGIN"]},KINGFISHER:{name:["site_name","SITE_NAME","location","name"],type:["obs_type","record_type","method","status"],presence:["presence","PRESENCE","Presence","seasonal","SEASONAL","origin","ORIGIN"]},FLYING_FOX:{name:["site_name","SITE_NAME","roost_name","colony","location","name"],type:["obs_type","record_type","colony_type","method","status"],presence:["presence","PRESENCE","Presence","seasonal","SEASONAL","origin","ORIGIN"]},PLERANDRA:{name:["site_name","SITE_NAME","population","location","name"],type:["obs_type","record_type","habitat_type","method","status"],presence:["presence","PRESENCE","Presence","seasonal","SEASONAL","origin","ORIGIN"]},INVASIVE:{name:["species_name","SPECIES","invasive_name","ias_name"],type:["invasive_type","threat_type","species_type","ias_type"]},MERREMIA:{name:["site_name","detection_id","SITE_NAME","patch_id"],type:["detection_method","confidence","CONFIDENCE","source_type"]},PESTICIDE:{name:["farm_name","FARM_NAME","site_name","operator"],type:["chemical_type","pesticide_type","PESTICIDE_TYPE","product"]},EUTROPHICATION:{name:["zone_name","ZONE_NAME","site_name","station"],type:["severity","SEVERITY","nutrient_level","trophic_state"]},LAND_COVER:{name:["class_name","CLASS_NAME","cover_type","land_use","Land_Use_P","LAND_USE_P"],type:["lc_class","LC_CLASS","land_cover","LAND_COVER","use_type","Land_Use_P","LAND_USE_P","land_use_p"]},GREEN_SPACE:{name:["park_name","PARK_NAME","space_name","garden_name"],type:["space_type","SPACE_TYPE","park_type","green_type"]}};function Yt(t,e,a){const s=Object.keys(t),i=s.map(n=>n.toLowerCase()),r=Vr[a];if(r&&r[e])for(const n of r[e]){const l=i.indexOf(n.toLowerCase());if(l!==-1)return t[s[l]]}const o=Vr.global;if(o&&o[e])for(const n of o[e]){const l=i.indexOf(n.toLowerCase());if(l!==-1)return t[s[l]]}}function se(t){return typeof t!="string"?t:t.trim().normalize("NFC").replace(/\s+/g," ")}function Rf(t,e){const a=e.category||"OTHER",s=se(Yt(t,"name",a))||"Unnamed",i=se(Yt(t,"type",a))||a,r=se(Yt(t,"realm",a))||e.realm||"terrestrial",o=se(Yt(t,"province",a))||"",n=Yt(t,"year",a),l=n&&parseInt(n,10)||null,c=se(Yt(t,"status",a))||"Unknown",h=se(Yt(t,"source",a))||"",d=se(Yt(t,"notes",a))||"",u=se(Yt(t,"presence",a))||"",f={name:s,type:i,realm:r,province:o,year:l,status:c,source:h,notes:d,targets:[...e.targets||[]],upload_timestamp:e.uploadTimestamp||new Date().toISOString(),layer_id:e.layerId||"",original_filename:e.originalFilename||"",uploaded_by:e.uploadedBy||"admin"};return u&&(f.presence=u),f}function Bf(t,e){return{type:"FeatureCollection",features:(t.features||[]).map(a=>({type:"Feature",geometry:a.geometry,properties:Rf(a.properties||{},e)}))}}function Df(t){if(!t.geometry)return null;const e=t.geometry.type;if(e==="Point")return t;if(e==="MultiPolygon"){const a=t.geometry.coordinates;let s=0,i=null;for(const r of a){const o=qo(r),n=ts(o);n>s&&(s=n,i=o)}return i?As(i):As(t)}try{return As(t)}catch{return null}}const Of=()=>new Promise(t=>setTimeout(t,0)),Ff=2e3;function zf(t){return jo(t)}function jf(t,e){return t[0]>=e[0]&&t[0]<=e[2]&&t[1]>=e[1]&&t[1]<=e[3]}async function qf(t,e){const a=e.features||[],s=t.features,i=new Array(s.length),r=a.map(o=>({feature:o,name:o.properties.name||o.properties.province||o.properties.NAME||o.properties.PROVINCE||"",bbox:zf(o)}));for(let o=0;o<s.length;o++){const n=s[o],l=Df(n);if(l){const c=Fo(l);let h=!1;for(const d of r)if(jf(c,d.bbox))try{if(zo(l,d.feature)){i[o]={...n,properties:{...n.properties,province:d.name}},h=!0;break}}catch{continue}h||(i[o]=n)}else i[o]=n;o>0&&o%Ff===0&&await Of()}return{type:"FeatureCollection",features:i}}async function Hf(t,e,a,s){const i={steps:[],warnings:[],errors:[]},r=(P,C)=>{i.steps.push({step:P,message:C,timestamp:new Date().toISOString()}),s&&s(P,C)},o=()=>new Promise(P=>setTimeout(P,0));r(1,"Validating geometries...");const{cleaned:n,stats:l,warnings:c}=If(t);if(i.warnings.push(...c),r(1,`Valid: ${l.validCount}/${l.originalCount} features. Types: ${JSON.stringify(l.typeCounts)}`),n.features.length===0)return i.errors.push("No valid features found after basic validation"),{geojson:n,metadata:qs({name:e.name,status:"Failed"}),report:i};await o(),r(2,"Checking CRS...");const h=Tf(e.prjText);r(2,`Detected CRS: ${h}`);let d=n;if(h!=="EPSG:4326"){r(2,"Reprojecting to WGS84...");const{geojson:P,reprojected:C,error:M}=Lf(n,h);M&&(i.warnings.push(M),i.warnings.push("Unverified CRS — layer loaded but coordinates may be incorrect")),d=P,C&&r(2,"Reprojection successful")}await o(),r(3,"Fixing geometry issues...");const{cleaned:u,fixedCount:f,droppedCount:p,warnings:m}=Gf(d);i.warnings.push(...m),r(3,`Fixed: ${f}, Dropped: ${p}`),await o(),r(4,"Standardizing attributes...");const g=qs({name:e.name||e.originalFilename,originalFilename:e.originalFilename,category:e.category,targets:e.targets,realm:e.realm,countsToward30x30:e.countsToward30x30,isReference:e.isReference,detectedCRS:h,uploadedBy:e.uploadedBy||"admin"}),v=Bf(u,{category:e.category,targets:e.targets,realm:e.realm,layerId:g.id,originalFilename:e.originalFilename,uploadTimestamp:g.uploadTimestamp,uploadedBy:e.uploadedBy||"admin"});r(4,`Mapped ${v.features.length} features to standard schema`),await o(),r(5,"Assigning provinces...");let y=v;if(a&&a.features&&a.features.length>0){y=await qf(v,a);const P=y.features.filter(C=>C.properties.province).length;r(5,`Province assigned to ${P}/${y.features.length} features`)}else i.warnings.push("No provinces boundary data — province assignment skipped"),r(5,"Skipped — no provinces data");await o(),r(6,"Computing areas...");const b=cn(y),_=b.features.reduce((P,C)=>P+(C.properties.area_ha||0),0);r(6,`Total area: ${_.toFixed(2)} ha`),g.featureCount=b.features.length,g.validGeometryCount=b.features.filter(P=>P.geometry).length,g.fixedCount=f,g.droppedCount=p,g.totalAreaHa=_;const x=i.errors.length>0,w=i.warnings.length>0;g.status=x?"Failed":w?"Warnings":"Clean",g.warnings=i.warnings;const k=Un(g,b);return i.torCompliance=k,r(7,`Pipeline complete. Status: ${g.status}`),{geojson:b,metadata:g,report:i}}let Z={step:1,file:null,geojson:null,prjText:null,opts:{},expectedLayer:null},Ui=!1;function $o(){return Ui}function Co(t){t.preventDefault(),t.returnValue=""}function Wr(t={}){Z={step:1,file:null,geojson:null,prjText:null,opts:{},expectedLayer:t.expectedLayer||null},Ui=!0,window.addEventListener("beforeunload",Co),document.getElementById("upload-wizard-modal").classList.add("active");const a=document.getElementById("wizard-modal-close-btn");a&&(a.onclick=()=>Es()),ka()}function Es(){Ui=!1,window.removeEventListener("beforeunload",Co),document.getElementById("upload-wizard-modal").classList.remove("active")}function ka(){const t=document.getElementById("wizard-body"),e=document.getElementById("wizard-steps"),a=["File","Configure","Processing","Results"];switch(e.innerHTML=a.map((s,i)=>{const r=i+1;let o="";return r<Z.step&&(o="done"),r===Z.step&&(o="active"),`<div class="wizard-step ${o}">${r}. ${s}</div>`}).join(""),Z.step){case 1:Zf(t);break;case 2:Xf(t);break;case 3:Qf(t);break;case 4:tg(t);break}}function Uf(t){const e=t.toLowerCase().split(".").pop();return e==="zip"?"shapefile":e==="kml"?"kml":e==="csv"?"csv":e==="geojson"||e==="json"?"geojson":null}async function Vf(t){if(typeof globalThis.Buffer>"u"){const s=await Sr(()=>import("./index-B2WcC-RY.js").then(i=>i.i),__vite__mapDeps([0,1]),import.meta.url);globalThis.Buffer=s.Buffer}const{default:e}=await Sr(async()=>{const{default:s}=await import("./index-CRXLxDts.js").then(i=>i.i);return{default:s}},__vite__mapDeps([2,1,0]),import.meta.url),a=await e(t);return Array.isArray(a)?a[0]:a}function Wf(t){const a=new DOMParser().parseFromString(t,"text/xml");if(a.querySelector("parsererror"))throw new Error("Invalid KML: XML parsing failed");const i=[],r=a.querySelectorAll("Placemark");for(const o of r){const n={},l=o.querySelector("name");l&&(n.name=l.textContent.trim());const c=o.querySelector("description");c&&(n.notes=c.textContent.trim());const h=o.querySelectorAll("SimpleData");for(const f of h){const p=f.getAttribute("name");p&&(n[p]=f.textContent.trim())}const d=o.querySelectorAll("Data");for(const f of d){const p=f.getAttribute("name"),m=f.querySelector("value");p&&m&&(n[p]=m.textContent.trim())}const u=Kf(o);u&&i.push({type:"Feature",properties:n,geometry:u})}return{type:"FeatureCollection",features:i}}function Kf(t){const e=t.querySelector("Point");if(e){const r=ze(e.querySelector("coordinates"));if(r.length>0)return{type:"Point",coordinates:r[0]}}const a=t.querySelector("LineString");if(a){const r=ze(a.querySelector("coordinates"));if(r.length>0)return{type:"LineString",coordinates:r}}const s=t.querySelector("Polygon");if(s)return Kr(s);const i=t.querySelector("MultiGeometry");if(i){const r=[];for(const o of i.children){const n=o.tagName;if(n==="Point"){const l=ze(o.querySelector("coordinates"));l.length>0&&r.push({type:"Point",coordinates:l[0]})}else if(n==="LineString"){const l=ze(o.querySelector("coordinates"));l.length>0&&r.push({type:"LineString",coordinates:l})}else if(n==="Polygon"){const l=Kr(o);l&&r.push(l)}}return r.length===0?null:r.length===1?r[0]:{type:"GeometryCollection",geometries:r}}return null}function Kr(t){const e=[],a=t.querySelector("outerBoundaryIs");if(a){const i=ze(a.querySelector("coordinates"));i.length>0&&e.push(i)}const s=t.querySelectorAll("innerBoundaryIs");for(const i of s){const r=ze(i.querySelector("coordinates"));r.length>0&&e.push(r)}return e.length===0?null:{type:"Polygon",coordinates:e}}function ze(t){if(!t)return[];const e=t.textContent.trim();return e?e.split(/\s+/).map(a=>{const s=a.split(",").map(Number);return s.length>=2&&!isNaN(s[0])&&!isNaN(s[1])?s.length>=3?[s[0],s[1],s[2]]:[s[0],s[1]]:null}).filter(Boolean):[]}function Yf(t){var c;const e=t.trim().split(/\r?\n/);if(e.length<2)throw new Error("CSV must have a header row and at least one data row");const a=Yr(e[0]),s=a.map(h=>h.toLowerCase().trim()),i=["latitude","lat","y","lat_dd","latitude_dd","decimallatitude"],r=["longitude","lon","lng","long","x","lon_dd","longitude_dd","decimallongitude"],o=s.findIndex(h=>i.includes(h)),n=s.findIndex(h=>r.includes(h));if(o===-1||n===-1)throw new Error(`Could not detect latitude/longitude columns. Found headers: ${a.join(", ")}. Expected column names like: latitude/lat/y and longitude/lon/lng/x`);const l=[];for(let h=1;h<e.length;h++){if(!e[h].trim())continue;const d=Yr(e[h]),u=parseFloat(d[o]),f=parseFloat(d[n]);if(isNaN(u)||isNaN(f))continue;const p={};for(let m=0;m<a.length;m++)m===o||m===n||(p[a[m].trim()]=((c=d[m])==null?void 0:c.trim())||"");l.push({type:"Feature",properties:p,geometry:{type:"Point",coordinates:[f,u]}})}if(l.length===0)throw new Error("No valid features found in CSV (no rows with valid lat/lon)");return{type:"FeatureCollection",features:l}}function Yr(t){const e=[];let a="",s=!1;for(let i=0;i<t.length;i++){const r=t[i];s?r==='"'?i+1<t.length&&t[i+1]==='"'?(a+='"',i++):s=!1:a+=r:r==='"'?s=!0:r===","?(e.push(a),a=""):a+=r}return e.push(a),e}function Jf(t){const e=JSON.parse(t);if(e.type==="FeatureCollection"&&Array.isArray(e.features))return e;if(e.type==="Feature"&&e.geometry)return{type:"FeatureCollection",features:[e]};if(e.type&&e.coordinates)return{type:"FeatureCollection",features:[{type:"Feature",properties:{},geometry:e}]};throw new Error("Invalid GeoJSON: must be a FeatureCollection, Feature, or Geometry object")}function Zf(t){const e=Z.expectedLayer,a=e?`<div style="padding:10px 14px;background:var(--primary-lighter);border:1px solid var(--primary);border-radius:var(--radius-sm);margin-bottom:14px;font-size:13px">
  ...
  `;const s=t.querySelector("#wizard-file-input"),i=t.querySelector("#wizard-next-1"),r=t.querySelector("#wizard-file-status");t.querySelector("#wizard-cancel-btn").addEventListener("click",()=>Es()),s.addEventListener("change",async o=>{const n=o.target.files[0];if(!n)return;const l=Uf(n.name);if(!l){r.innerHTML='<p style="color:var(--danger)">Unsupported file format. Please upload .zip, .kml, .csv, .geojson, or .json</p>';return}r.innerHTML=`<p>Parsing ${l} file...</p>`,i.disabled=!0;try{let c;if(l==="shapefile"){const d=await n.arrayBuffer();c=await Vf(d)}else{const d=await n.text();l==="kml"?c=Wf(d):l==="csv"?c=Yf(d):l==="geojson"&&(c=Jf(d))}if(!c||!c.features||c.features.length===0){r.innerHTML='<p style="color:var(--danger)">No features found in file</p>';return}Z.file=n,Z.geojson=c,Z.opts.originalFilename=n.name,Z.prjText=null;const h=[...new Set(c.features.map(d=>{var u;return(u=d.geometry)==null?void 0:u.type}).filter(Boolean))];r.innerHTML=`
    ...
    <div class="form-group">
      ...
      <select id="wizard-category">
        ${Xi.map(h=>`<option value="${h}" ${h===s?"selected":""}>${Y[h].label}</option>`).join("")}
      </select>
    </div>
  ...
  `;const n=t.querySelector("#wizard-category"),l=t.querySelector("#wizard-realm");n.addEventListener("change",()=>{const h=Y[n.value];h&&(l.value=h.defaultRealm)}),t.querySelectorAll("#wizard-targets .target-checkbox").forEach(h=>{h.addEventListener("click",d=>{d.preventDefault(),h.classList.toggle("selected");const u=h.querySelector("input");u.checked=!u.checked})}),t.querySelector("#wizard-back-2").addEventListener("click",()=>{Z.step=1,ka()}),t.querySelector("#wizard-next-2").addEventListener("click",async()=>{var u;const h=[...t.querySelectorAll("#wizard-targets input:checked")].map(f=>f.value);Z.opts.name=t.querySelector("#wizard-name").value||"Untitled",Z.opts.category=n.value,Z.opts.targets=h,Z.opts.realm=l.value,Z.opts.countsToward30x30=t.querySelector("#wizard-30x30").checked,Z.opts.isReference=t.querySelector("#wizard-reference").checked,Z.opts.prjText=Z.prjText;const d=bl(((u=Z.file)==null?void 0:u.name)||"",Z.opts.name,Z.opts.category);if(d.length>0){const f=d.map(m=>`  - "${m.metadata.name}" (${m.metadata.category}, uploaded ${new Date(m.metadata.uploadTimestamp).toLocaleDateString()})`).join(`
`);if(!await Je(`A dataset with the same name or file already exists:

${f}

Uploading will replace the existing dataset.
Do you want to continue?`,{title:"Duplicate Dataset",okLabel:"Replace"}))return}Z.step=3,ka()})}function Qf(t){t.innerHTML=`
  ...
  `;const e=t.querySelector("#pipeline-log"),a=t.querySelector("#pipeline-status");function s(r,o=""){const n=document.createElement("div");n.className=`log-entry ${o}`,n.textContent=`[${new Date().toLocaleTimeString()}] ${r}`,e.appendChild(n),e.scrollTop=e.scrollHeight}const i=V();Hf(Z.geojson,Z.opts,i.provincesGeojson,(r,o)=>s(`Step ${r}: ${o}`)).then(async r=>{Z.result=r;for(const l of r.report.warnings)s(`WARNING: ${l}`,"log-warn");for(const l of r.report.errors)s(`ERROR: ${l}`,"log-error");const o=yl(r.metadata.originalFilename,r.metadata.category);if(o){s(`Replacing existing layer "${o.metadata.name}" (same file + category)`,"log-warn");try{await ms(o.id),mi(o.id)}catch(l){s(`Warning: could not remove old layer: ${l.message}`,"log-warn")}}const n={id:r.metadata.id,metadata:r.metadata,geojson:r.geojson};await nn(n),gi(n),await je({action:o?"replace":"upload",layer_id:r.metadata.id,replaced_layer_id:(o==null?void 0:o.id)||null,filename:r.metadata.originalFilename,targets:r.metadata.targets,category:r.metadata.category,result:r.metadata.status}),Z.expectedLayer&&(wl(Z.expectedLayer.id,r.metadata.id),await xe("layerTracker",V().layerTracker),s(`Tracked as: ${Me(Z.expectedLayer)}`)),a.innerHTML=`
    ...
    `,t.querySelector("#wizard-next-3").addEventListener("click",()=>{Z.step=4,ka()})}).catch(r=>{s(`FATAL: ${r.message}`,"log-error"),a.innerHTML=`
      <p style="color:var(--danger)">Pipeline failed: ${r.message}</p>
      <button class="btn btn-outline" id="wizard-error-close-btn">Close</button>
    `,t.querySelector("#wizard-error-close-btn").addEventListener("click",()=>Es())})}function tg(t){const e=Z.result;if(!e){t.innerHTML="<p>No results</p>";return}const a=e.metadata,s=e.report.torCompliance||{compliant:!1,issues:[]};t.innerHTML=`
  ...
  `,t.querySelector("#wizard-download-geojson").addEventListener("click",()=>{const i=JSON.stringify(e.geojson,null,2),r=new Blob([i],{type:"application/json"}),o=URL.createObjectURL(r),n=document.createElement("a");n.href=o,n.download=`${a.name.replace(/\s+/g,"_")}_cleaned.geojson`,n.click(),URL.revokeObjectURL(o)}),t.querySelector("#wizard-done").addEventListener("click",()=>{Es(),window.dispatchEvent(new CustomEvent("nbsap:refresh"))})}const eg={BASE_URL:"./",DEV:!1,MODE:"production",PROD:!0,SSR:!1};function ag(){try{return eg&&"./"||"./"}catch{return"./"}}function sg(){At()&&vi(!0),ne()}function ne(){const t=document.getElementById("page-admin");Bl().isAuthenticated?rg(t):ig(t)}function ig(t){const e=ag();t.innerHTML=`
    <div class="lcp-outer">
      <div class="lcp-card">
  ...
  `;const n=t.querySelector("#admin-session-time");if(n){const d=new Date;n.textContent=d.toLocaleString([],{dateStyle:"medium",timeStyle:"short"})}const l=Date.now(),c=t.querySelector("#session-elapsed-text"),h=t.querySelector("#admin-session-elapsed");if(c){const d=()=>{if(!document.getElementById("session-elapsed-text"))return;const u=Math.floor((Date.now()-l)/1e3),f=Math.floor(u/60),p=u%60;c.textContent=`${f}:${String(p).padStart(2,"0")}`,u>14400&&h&&h.classList.add("warning"),setTimeout(d,1e3)};d()}t.querySelector("#btn-admin-logout").addEventListener("click",()=>{Rl(),vi(!1),ne(),To(!1)}),t.querySelector("#btn-admin-upload").addEventListener("click",()=>Wr()),t.querySelectorAll(".tracker-upload").forEach(d=>{d.addEventListener("click",()=>{const u=d.dataset.expectedId,f=Ne.find(p=>p.id===u);f&&Wr({expectedLayer:f})})}),t.querySelectorAll(".tracker-remove-one").forEach(d=>{d.addEventListener("click",async()=>{const u=d.dataset.expectedId,f=d.dataset.layerId;er(u,f),await xe("layerTracker",V().layerTracker),ne()})}),t.querySelectorAll(".layer-name-editable").forEach(d=>{d.addEventListener("click",u=>{u.stopPropagation();const f=d.dataset.expectedId,p=Ne.find(b=>b.id===f);if(!p)return;const m=Me(p),g=document.createElement("input");g.type="text",g.value=m,g.style.cssText="font-size:13px;font-weight:600;padding:2px 6px;border:2px solid var(--primary);border-radius:4px;outline:none;width:100%;box-sizing:border-box",d.parentNode.replaceChild(g,d),g.focus(),g.select();const y=async()=>{const b=g.value.trim();if(b&&b!==p.name)_l(f,b),await xe("customLayerNames",V().customLayerNames);else if(b===p.name){const _=V();delete _.customLayerNames[f],await xe("customLayerNames",_.customLayerNames)}ne()};g.addEventListener("blur",y),g.addEventListener("keydown",b=>{b.key==="Enter"&&(b.preventDefault(),g.blur()),b.key==="Escape"&&(g.value=m,g.blur())})})}),t.querySelectorAll(".tracker-remove-all").forEach(d=>{d.addEventListener("click",async()=>{const u=d.dataset.expectedId,f=Ne.find(m=>m.id===u),p=f?Me(f):u;await Je(`Remove all uploaded files for "${p}"? The files remain in storage but won't appear on the dashboard.`,{title:"Remove Files",okLabel:"Remove",danger:!0})&&(er(u,null),await xe("layerTracker",V().layerTracker),ne())})}),t.querySelector("#btn-export-backup").addEventListener("click",async()=>{const d=t.querySelector("#backup-status");d.textContent="Exporting...";try{const u=await dl(),f=JSON.stringify(u,null,2),p=new Blob([f],{type:"application/json"}),m=URL.createObjectURL(p),g=document.createElement("a");g.href=m,g.download=`nbsap-backup-${new Date().toISOString().slice(0,10)}.json`,g.click(),URL.revokeObjectURL(m),await je({action:"export_backup",result:"success"}),d.textContent="Backup exported successfully"}catch(u){d.textContent=`Error: ${u.message}`}}),t.querySelector("#btn-sync-import").addEventListener("change",async d=>{const u=d.target.files[0];if(!u)return;const f=t.querySelector("#backup-status");f.textContent="Syncing...";try{const p=await u.text(),m=JSON.parse(p),g=await ul(m);await je({action:"sync_import",result:"success",notes:`${g.added} added, ${g.updated} updated, ${g.skippedAudit} audit entries skipped`}),f.textContent=`Sync complete: ${g.added} new layers, ${g.updated} updated.`,window.dispatchEvent(new CustomEvent("nbsap:refresh"))}catch(p){f.textContent=`Sync failed: ${p.message}`}d.target.value=""}),t.querySelector("#btn-import-backup").addEventListener("change",async d=>{const u=d.target.files[0];if(!u)return;if(!await Je("Full Restore will clear ALL existing data and replace it with the backup. Continue?",{title:"Full Restore",okLabel:"Restore",danger:!0})){d.target.value="";return}const f=t.querySelector("#backup-status");f.textContent="Restoring...";try{const p=await u.text(),m=JSON.parse(p),g=await hl(m);await je({action:"import_backup",result:"success",notes:`${g.layersImported} layers imported`}),f.textContent=`Restored ${g.layersImported} layers.`,window.dispatchEvent(new CustomEvent("nbsap:refresh"))}catch(p){f.textContent=`Restore failed: ${p.message}`}d.target.value=""}),t.querySelector("#btn-export-audit").addEventListener("click",async()=>{const d=await Ji(),u=[["Timestamp","Action","Layer ID","Filename","Category","Targets","Result"]];for(const v of d)u.push([v.timestamp||"",v.action||"",v.layer_id||"",v.filename||"",v.category||"",(v.targets||[]).join(";"),v.result||""]);const f=u.map(v=>v.map(y=>`"${String(y).replace(/"/g,'""')}"`).join(",")).join(`
`),p=new Blob([f],{type:"text/csv"}),m=URL.createObjectURL(p),g=document.createElement("a");g.href=m,g.download="audit-log.csv",g.click(),URL.revokeObjectURL(m)})}function To(t){const e=document.getElementById("auth-badge");if(e){const a=e.querySelector("span");t?(a&&(a.textContent="Admin"),e.classList.add("admin")):(a&&(a.textContent="Public"),e.classList.remove("admin"))}}const ng={BASE_URL:"./",DEV:!1,MODE:"production",PROD:!0,SSR:!1};function og(){try{return ng&&"./"||"./"}catch{return"./"}}function lg(){const t=document.getElementById("page-about"),e=og();t.innerHTML=`
  ...
  `}const cg=`You are **Smol Tamtan**, a cheerful, enthusiastic AI assistant built into the Vanuatu NBSAP GIS Portal — the National Biodiversity Strategy & Action Plan data portal. You are depicted as a friendly animated globe with a colourful face and playful personality.
...
---
Always end your answers with enthusiasm for Vanuatu's conservation when it feels natural!`,dg=`Halo! I'm Smol Tamtan! 🌏
...
What would you like to explore today?`,hg=["What GIS layers are in the portal?","How many hectares is the Vatthe Conservation Area?","What is the 30x30 target?","What NBSAP targets are tracked here?"],ug=120;async function pg(){const t=[];try{const e=await rn();if(e.length>0){t.push(`### GIS Layers (${e.length} total)
Format per feature: name | area_ha`);let a=ug;e.forEach(s=>{var l;const i=s.metadata??{},r=((l=s.geojson)==null?void 0:l.features)??[],o=i.totalAreaHa!=null?Number(i.totalAreaHa):r.reduce((c,h)=>{var d;return c+(Number((d=h.properties)==null?void 0:d.area_ha)||0)},0);t.push(`
...
`)}function me(t="lg",e=!1,a=!1){return`<div class="${["st-globe-wrap",`st-globe-wrap--${t}`,e?"st-globe-wrap--floating":"",a?"st-globe-wrap--thinking":""].filter(Boolean).join(" ")}">
  ...
  `;const o=document.createElement("button");o.className="st-launcher",o.setAttribute("aria-label","Open Smol Tamtan NBSAP portal assistant"),o.setAttribute("aria-expanded","false"),o.innerHTML=me("lg",!0)+'<span class="st-launcher-label">Smol Tamtan</span>',i.appendChild(r),i.appendChild(o),document.body.appendChild(i);const n=r.querySelector(".st-messages"),l=r.querySelector(".st-input"),c=r.querySelector(".st-send-btn"),h=r.querySelector(".st-close-btn");function d(){n.scrollTop=n.scrollHeight}function u(){if(n.innerHTML="",s.forEach(({role:b,content:_})=>{const x=document.createElement("div");x.className=`st-msg st-msg--${b==="user"?"user":"bot"}`,b==="assistant"&&(x.innerHTML=me("xs"));const w=document.createElement("div");w.className="st-bubble",w.textContent=_,x.appendChild(w),n.appendChild(x)}),a&&!e){const b=document.createElement("div");b.className="st-suggestions",b.innerHTML='<p class="st-suggest-label">Try asking:</p>',hg.forEach(_=>{const x=document.createElement("button");x.className="st-chip",x.textContent=_,x.addEventListener("click",()=>g(_)),b.appendChild(x)}),n.appendChild(b)}d()}function f(){const b=document.createElement("div");b.className="st-msg st-msg--bot",b.id="st-thinking-row",b.innerHTML=me("xs",!1,!0)+`<div class="st-bubble st-bubble--loading">
        <span class="st-type-dot"></span>
        <span class="st-type-dot"></span>
        <span class="st-type-dot"></span>
      </div>`,n.appendChild(b),d()}function p(b){let _=n.querySelector("#st-thinking-row");_&&(_.innerHTML=me("xs",!1,!0)+`<div class="st-bubble">${b.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}</div>`,d())}function m(){const b=n.querySelector("#st-thinking-row");b&&b.remove()}async function g(b){var w;const _=b.trim();if(!_||e)return;a=!1,s.push({role:"user",content:_,id:`u-${Date.now()}`}),l.value="",e=!0,c.disabled=!0,u(),f();let x;try{x=void 0}catch{x=void 0}if(!x){m(),s.push({role:"assistant",content:"Halo! I'm Smol Tamtan, but I can't connect to my brain right now. 🌏\n\nPlease ask your portal administrator to add `VITE_ANTHROPIC_API_KEY` to the environment configuration.",id:`e-${Date.now()}`}),e=!1,c.disabled=!1,u();return}try{const k=await pg(),P=cg.replace("{CONTEXT}",k),C=s.filter($=>$.id!=="welcome").slice(-10).map(({role:$,content:R})=>({role:$,content:R})),M=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":x,"anthropic-version":"2023-06-01","anthropic-dangerous-direct-browser-access":"true"},body:JSON.stringify({model:"claude-haiku-4-5-20251001",max_tokens:512,stream:!0,system:P,messages:C})});if(!M.ok){const $=await M.text();throw new Error(`API error ${M.status}: ${$}`)}const E=M.body.getReader(),S=new TextDecoder;let A="";for(;;){const{done:$,value:R}=await E.read();if($)break;const T=S.decode(R,{stream:!0});for(const N of T.split(`
`)){if(!N.startsWith("data: "))continue;const I=N.slice(6).trim();if(I!=="[DONE]")try{const O=JSON.parse(I);O.type==="content_block_delta"&&((w=O.delta)!=null&&w.text)&&(A+=O.delta.text,p(A))}catch{}}}m(),s.push({role:"assistant",content:A,id:`b-${Date.now()}`})}catch(k){m(),s.push({role:"assistant",content:`Oops! Something went wrong. Please try again!

(${k instanceof Error?k.message:String(k)})`,id:`e-${Date.now()}`})}finally{e=!1,c.disabled=!l.value.trim(),u()}}function v(){t=!0,r.style.display="flex",r.style.flexDirection="column",o.innerHTML=me("lg",!1),o.setAttribute("aria-label","Close Smol Tamtan"),o.setAttribute("aria-expanded","true"),u(),setTimeout(()=>l.focus(),280)}function y(){t=!1,r.style.display="none",o.innerHTML=me("lg",!0)+'<span class="st-launcher-label">Smol Tamtan</span>',o.setAttribute("aria-label","Open Smol Tamtan NBSAP portal assistant"),o.setAttribute("aria-expanded","false")}o.addEventListener("click",()=>t?y():v()),h.addEventListener("click",y),l.addEventListener("input",()=>{c.disabled=!l.value.trim()||e}),l.addEventListener("keydown",b=>{b.key==="Enter"&&!b.shiftKey&&(b.preventDefault(),g(l.value))}),c.addEventListener("click",()=>g(l.value)),document.addEventListener("mousedown",b=>{t&&!i.contains(b.target)&&y()})}const gg={BASE_URL:"./",DEV:!1,MODE:"production",PROD:!0,SSR:!1};delete D.Icon.Default.prototype._getIconUrl;D.Icon.Default.mergeOptions({iconUrl:"https://unpkg.com/leaflet@1.9.4/dist/images/marker-icon.png",iconRetinaUrl:"https://unpkg.com/leaflet@1.9.4/dist/images/marker-icon-2x.png",shadowUrl:"https://unpkg.com/leaflet@1.9.4/dist/images/marker-shadow.png"});let Qa="dashboard",fs=!1;function Lo(){try{return gg&&"./"||"./"}catch{return"./"}}async function mg(){od(),vd(),sg(),lg(),fg(),window.__nbsapLoaded=!0,wg();let t=null;window.addEventListener("nbsap:refresh",()=>{t&&clearTimeout(t),t=setTimeout(async()=>{if(t=null,fs){const a=V().filters.targets;a.length>0&&vn(a)&&(si(`Loading data for ${a.join(", ")}...`),await Qe(a),ii())}Qa==="dashboard"?ws():hd(),Qa==="portal"&&ao(),Qa==="admin"&&!$o()&&ne(),Mg()},150)}),No("dashboard"),await vg(),yg()}function si(t){let e=document.getElementById("nbsap-loading-status");e||(e=document.createElement("div"),e.id="nbsap-loading-status",e.style.cssText=`
    ...
    ${t}
  `,e.style.display="flex"}function ii(){const t=document.getElementById("nbsap-loading-status");t&&(t.style.display="none")}async function vg(){const t=Lo();si("Loading data from Firestore...");try{const s=await fetch(`${t}data/provinces.geojson`);if(s.ok){const i=await s.json();xl(i)}}catch(s){console.warn("Failed to load provinces data:",s)}try{const s=await oa(Zi("layerTracker"),1e4);s&&pn(s)}catch(s){console.warn("Failed to load layer tracker:",s)}try{const s=await oa(Zi("customLayerNames"),1e4);s&&un(s)}catch(s){console.warn("Failed to load custom layer names:",s)}try{const s=await oa(ll(),15e3),i=s.filter(o=>!Os(o)),r=s.filter(o=>Os(o));if(i.length>0){const o=tr(i);console.log(`Loaded metadata for ${i.length} layers from Firestore (excluded ${r.length} demo layers)`),o.length>0&&(console.warn(`Removing ${o.length} duplicate layer(s) from Firestore`),_g(o)),r.length>0&&xg(r)}else if(s.length>0){const o=await oa(rn(),6e4);tr(o.filter(n=>Os(n)))}else try{const o=await oa(cl(),1e4);o>0?console.warn(`Firestore has ${o} layer docs but metadata failed to load. Real-time listener will retry.`):await Fs(t)}catch{await Fs(t)}}catch(s){console.warn("Failed to load stored layers:",s);try{await Fs(t)}catch(i){console.warn("Failed to load demo data:",i)}}Ml()&&(console.log("Cleaned stale tracker entries for previously deleted layers"),xe("layerTracker",V().layerTracker).catch(s=>console.warn("Failed to persist cleaned tracker:",s))),ii(),fs=!0;const a=V().filters.targets;a.length>0&&vn(a)&&(si(`Loading GeoJSON for ${a.join(", ")}...`),await Qe(a),ii()),ws()}function yg(){let t=!0;pl(async e=>{if(!fs||!(e.added.length>0||e.modified.length>0||e.removed.length>0))return;const s=V(),i=new Set(s.layers.map(o=>o.id)),r=[];for(const o of[...e.added,...e.modified])t&&i.has(o)||r.push(o);if(t=!1,!(r.length===0&&e.removed.length===0)){if(r.length>0){const o=await Promise.allSettled(r.map(async n=>{const l=await hi(n);return l&&gi(l),n}));for(const n of o)n.status==="rejected"&&console.warn("Failed to load layer via real-time sync:",n.reason)}for(const o of e.removed)mi(o);(r.length>0||e.removed.length>0)&&bg({added:r.filter(o=>e.added.includes(o)),modified:r.filter(o=>e.modified.includes(o)),removed:e.removed})}}),fl(e=>{if(!fs)return;let a=!1;e.layerTracker&&(pn(e.layerTracker),a=!0),e.customLayerNames&&(un(e.customLayerNames),a=!0),a&&window.dispatchEvent(new CustomEvent("nbsap:refresh"))})}function bg(t){if(t.added.length+t.modified.length+t.removed.length===0)return;const a=[];t.added.length>0&&a.push(`${t.added.length} added`),t.modified.length>0&&a.push(`${t.modified.length} updated`),t.removed.length>0&&a.push(`${t.removed.length} removed`);const s=`Synced: ${a.join(", ")}`;let i=document.getElementById("sync-toast");i||(i=document.createElement("div"),i.id="sync-toast",i.style.cssText=`
    ...
    ${s}
  `,requestAnimationFrame(()=>{i.style.opacity="1",i.style.transform="translateY(0)"}),setTimeout(()=>{i.style.opacity="0",i.style.transform="translateY(10px)"},3e3)}function oa(t,e){return Promise.race([t,new Promise((a,s)=>setTimeout(()=>s(new Error("Operation timed out")),e))])}function Os(t){const e=t.metadata;return e?e.uploadedBy==="system"||e._isDemo?!0:(e.name||"").toLowerCase().startsWith("demo "):!1}function xg(t){for(const e of t)ms(e.id).then(()=>{var a;console.log(`Cleaned up demo layer from Firestore: ${((a=e.metadata)==null?void 0:a.name)||e.id}`)}).catch(a=>{console.warn(`Failed to clean up demo layer ${e.id}:`,a)})}function _g(t){for(const e of t)ms(e).then(()=>{console.log(`Removed duplicate layer from Firestore: ${e}`)}).catch(a=>{console.warn(`Failed to remove duplicate layer ${e}:`,a)})}async function Fs(t){t||(t=Lo());const e=[{file:"demo_cca.geojson",name:"Demo CCAs",category:"CCA",realm:"terrestrial"},{file:"demo_mpa.geojson",name:"Demo MPAs",category:"MPA",realm:"marine"}];for(const a of e)try{const s=await fetch(`${t}data/${a.file}`);if(!s.ok)continue;const i=await s.json(),r=cn(i),o=qs({name:a.name,originalFilename:a.file,category:a.category,targets:["T3"],realm:a.realm,countsToward30x30:!0,detectedCRS:"EPSG:4326",featureCount:r.features.length,validGeometryCount:r.features.length,totalAreaHa:r.features.reduce((l,c)=>l+(c.properties.area_ha||0),0),status:"Clean",uploadedBy:"system",_isDemo:!0}),n={id:o.id,metadata:o,geojson:r};gi(n)}catch(s){console.warn(`Failed to load demo data ${a.name}:`,s)}}function wg(){document.querySelectorAll(".nav-tab").forEach(t=>{t.addEventListener("click",()=>{No(t.dataset.tab)})})}function No(t){Qa=t,document.querySelectorAll(".nav-tab").forEach(e=>{e.classList.toggle("active",e.dataset.tab===t)}),document.querySelectorAll(".page").forEach(e=>{e.classList.toggle("active",e.id===`page-${t}`)}),t==="dashboard"&&ud(),t==="portal"&&ao(),t==="admin"&&!$o()&&ne()}function Mg(){const t=document.getElementById("auth-badge");if(t){const e=t.querySelector("span");At()?(e&&(e.textContent="Admin"),t.classList.add("admin")):(e&&(e.textContent="Public"),t.classList.remove("admin"))}}document.body.addEventListener("click",t=>{const e=t.target.closest(".btn");if(!e||e.disabled)return;const a=e.getBoundingClientRect(),s=Math.max(a.width,a.height),i=document.createElement("span");i.className="btn-ripple-wave",i.style.cssText=`width:${s}px;height:${s}px;left:${t.clientX-a.left-s/2}px;top:${t.clientY-a.top-s/2}px`,e.appendChild(i),i.addEventListener("animationend",()=>i.remove(),{once:!0})},!0);mg().catch(t=>{console.error("App initialization failed:",t);const e=document.getElementById("page-dashboard");e&&(e.innerHTML=`<div style="padding:40px;max-width:600px;margin:0 auto">
