        ...
        <div className="dashboard-content">
          ...
          {activeSection === 'about' && (
            <div className="placeholder-section">
              <h3>Merremia Vanuatu Public Data Portal</h3>
              <p style={{ marginTop: '0.75rem' }}>
                This public portal provides read-only access to geospatial datasets
                published by the Department of Environmental Protection &amp; Conservation (DEPC)
                for monitoring invasive Merremia vine species across Vanuatu.
              </p>
              <p style={{ marginTop: '0.5rem', fontSize: '0.85rem' }}>
                Datasets are uploaded and managed by authorized DEPC staff via the In-House Portal.
